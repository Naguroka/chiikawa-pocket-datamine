...
public class InitializeStateReset extends com.unity3d.services.core.domain.task.MetricTask<com.unity3d.services.core.domain.task.InitializeStateReset.Params, com.unity3d.services.core.configuration.Configuration> {
    ...
    public java.lang.Object m1235doWorkgIAlus(com.unity3d.services.core.domain.task.InitializeStateReset.Params params, kotlin.coroutines.Continuation<? super kotlin.Result<? extends com.unity3d.services.core.configuration.Configuration>> continuation) {
        return m1234doWorkgIAlus$suspendImpl(this, params, continuation);
    }
    ...
    public /* bridge */ /* synthetic */ java.lang.Object mo1218doWorkgIAlus(com.unity3d.services.core.domain.task.BaseParams baseParams, kotlin.coroutines.Continuation continuation) {
        return m1235doWorkgIAlus((com.unity3d.services.core.domain.task.InitializeStateReset.Params) baseParams, (kotlin.coroutines.Continuation<? super kotlin.Result<? extends com.unity3d.services.core.configuration.Configuration>>) continuation);
    }
    ...
    static /* synthetic */ java.lang.Object m1234doWorkgIAlus$suspendImpl(com.unity3d.services.core.domain.task.InitializeStateReset initializeStateReset, com.unity3d.services.core.domain.task.InitializeStateReset.Params params, kotlin.coroutines.Continuation<? super kotlin.Result<? extends com.unity3d.services.core.configuration.Configuration>> continuation) throws java.lang.Throwable {
        ...
        java.lang.Object objWithContext = initializeStateReset$doWork$1.result;
        ...
        if (i == 0) {
            ...
            objWithContext = kotlinx.coroutines.BuildersKt.withContext(coroutineDispatcher, initializeStateReset$doWork$2, initializeStateReset$doWork$1);
