...
public interface PurchaseUpdatedResponseListener {
    void onPurchaseUpdated(com.unity3d.services.store.gpbl.bridges.BillingResultBridge billingResult, java.util.List<? extends com.unity3d.services.store.gpbl.bridges.PurchaseBridge> purchases);
}
