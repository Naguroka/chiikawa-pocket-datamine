...
public class ScarBannerAd extends com.unity3d.scar.adapter.v2000.scarads.ScarAdBase<com.google.android.gms.ads.AdView> {
    private com.google.android.gms.ads.AdView _adView;
    private android.widget.RelativeLayout _bannerView;
    private int _height;
    private int _width;

    public ScarBannerAd(android.content.Context context, com.google.android.gms.ads.query.QueryInfo queryInfo, android.widget.RelativeLayout relativeLayout, com.unity3d.scar.adapter.common.scarads.ScarAdMetadata scarAdMetadata, int i, int i2, com.unity3d.scar.adapter.common.IAdsErrorHandler iAdsErrorHandler, com.unity3d.scar.adapter.common.IScarBannerAdListenerWrapper iScarBannerAdListenerWrapper) {
        ...
        this._scarAdListener = new com.unity3d.scar.adapter.v2000.scarads.ScarBannerAdListener(iScarBannerAdListenerWrapper, this);
    }
    ...
    protected void loadAdInternal(com.google.android.gms.ads.AdRequest adRequest, com.unity3d.scar.adapter.common.scarads.IScarLoadListener iScarLoadListener) {
        ...
        this._adView.setAdListener(((com.unity3d.scar.adapter.v2000.scarads.ScarBannerAdListener) this._scarAdListener).getAdListener());
