...
public final class RewardedAdLoader {
    ...
    public static final void loadAd(com.unity3d.ironsourceads.rewarded.RewardedAdRequest adRequest, com.unity3d.ironsourceads.rewarded.RewardedAdLoaderListener listener) {
        ...
        INSTANCE.internalLoadAd$mediationsdk_release(executor, new com.json.nq(adRequest, listener, com.json.gn.INSTANCE.a(com.ironsource.mediationsdk.IronSource.AD_UNIT.REWARDED_VIDEO), null, 8, null));
    }
    ...
    public final void internalLoadAd$mediationsdk_release(java.util.concurrent.Executor executor2, com.json.am loadTaskProvider) {
        ...
        executor2.execute(new java.lang.Runnable() { // from class: com.unity3d.ironsourceads.rewarded.RewardedAdLoader$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                com.unity3d.ironsourceads.rewarded.RewardedAdLoader.a(xlVarA);
            }
        });
    }
}
