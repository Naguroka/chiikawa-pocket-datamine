...
public final class InterstitialAdLoader {
    ...
    public static final void loadAd(com.unity3d.ironsourceads.interstitial.InterstitialAdRequest adRequest, com.unity3d.ironsourceads.interstitial.InterstitialAdLoaderListener listener) {
        ...
        INSTANCE.internalLoadAd$mediationsdk_release(executor, new com.json.bj(adRequest, listener, com.json.gn.INSTANCE.a(com.ironsource.mediationsdk.IronSource.AD_UNIT.INTERSTITIAL), null, 8, null));
    }
    ...
    public final void internalLoadAd$mediationsdk_release(java.util.concurrent.Executor executor2, com.json.am loadTaskProvider) {
        ...
        executor2.execute(new java.lang.Runnable() { // from class: com.unity3d.ironsourceads.interstitial.InterstitialAdLoader$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                com.unity3d.ironsourceads.interstitial.InterstitialAdLoader.a(xlVarA);
            }
        });
    }
}
