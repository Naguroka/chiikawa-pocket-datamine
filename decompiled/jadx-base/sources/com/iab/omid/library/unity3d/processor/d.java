...
public class d implements com.iab.omid.library.unity3d.processor.a {
    ...
    private final int[] f2467a = new int[2];

    private void a(android.view.ViewGroup viewGroup, org.json.JSONObject jSONObject, com.iab.omid.library.unity3d.processor.a.InterfaceC0225a interfaceC0225a, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            interfaceC0225a.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    private void b(android.view.ViewGroup viewGroup, org.json.JSONObject jSONObject, com.iab.omid.library.unity3d.processor.a.InterfaceC0225a interfaceC0225a, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                interfaceC0225a.a((android.view.View) it2.next(), this, jSONObject, z);
            }
        }
    }
    ...
    public org.json.JSONObject a(android.view.View view) {
        ...
        view.getLocationOnScreen(this.f2467a);
