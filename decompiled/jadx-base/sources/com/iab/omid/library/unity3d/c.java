...
class c {
    ...
    private static final java.util.regex.Pattern f2455a = java.util.regex.Pattern.compile("<(head)( [^>]*)?>", 2);
    ...
    static java.lang.String a(java.lang.String str, java.lang.String str2) {
        com.iab.omid.library.unity3d.utils.g.a(str, "HTML is null or empty");
        int[][] iArrA = a(str);
        java.lang.StringBuilder sb = new java.lang.StringBuilder(str.length() + str2.length() + 16);
        if (!b(str, sb, b, str2, iArrA) && !a(str, sb, f2455a, str2, iArrA) && !b(str, sb, d, str2, iArrA) && !a(str, sb, c, str2, iArrA) && !b(str, sb, f, str2, iArrA) && !a(str, sb, e, str2, iArrA) && !a(str, sb, g, str2, iArrA)) {
            return str2 + str;
        }
        return sb.toString();
    }
