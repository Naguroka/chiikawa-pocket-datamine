...
public class b extends com.iab.omid.library.unity3d.publisher.AdSessionStatePublisher {
    ...
    class RunnableC0226b implements java.lang.Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final android.webkit.WebView f2471a;

        RunnableC0226b() {
            this.f2471a = com.iab.omid.library.unity3d.publisher.b.this.g;
        }
    ...
    public void b() {
        super.b();
        new android.os.Handler().postDelayed(new com.iab.omid.library.unity3d.publisher.b.RunnableC0226b(), java.lang.Math.max(4000 - (this.h == null ? 4000L : java.util.concurrent.TimeUnit.MILLISECONDS.convert(com.iab.omid.library.unity3d.utils.f.b() - this.h.longValue(), java.util.concurrent.TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
