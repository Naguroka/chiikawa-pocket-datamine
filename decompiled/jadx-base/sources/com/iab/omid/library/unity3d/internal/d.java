...
public class d implements android.app.Application.ActivityLifecycleCallbacks {
    ...
    protected boolean b;
    private com.iab.omid.library.unity3d.internal.d.a c;
    ...
    private void a(boolean z) {
        if (this.b != z) {
            ...
            if (this.f2459a) {
                b(z);
                com.iab.omid.library.unity3d.internal.d.a aVar = this.c;
                if (aVar != null) {
                    aVar.a(z);
                }
            }
    ...
    public void a(com.iab.omid.library.unity3d.internal.d.a aVar) {
        this.c = aVar;
    }
