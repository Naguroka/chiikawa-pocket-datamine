...
public class c {
    ...
    private static android.view.WindowManager f2371a;
    ...
    static /* synthetic */ class a {
        ...
        static {
            int[] iArr = new int[com.iab.omid.library.applovin.adsession.OutputDeviceStatus.values().length];
            f2372a = iArr;
            try {
                iArr[com.iab.omid.library.applovin.adsession.OutputDeviceStatus.NOT_DETECTED.ordinal()] = 1;
    ...
    public static void b(org.json.JSONObject jSONObject) {
        com.iab.omid.library.applovin.utils.c.b bVarA = a(jSONObject);
        try {
            jSONObject.put("width", bVarA.f2373a);
    ...
    private static com.iab.omid.library.applovin.utils.c.b a(org.json.JSONObject jSONObject) {
        float fA;
        float fA2;
        if (f2371a != null) {
            android.graphics.Point point = new android.graphics.Point(0, 0);
            f2371a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
        ...
        return new com.iab.omid.library.applovin.utils.c.b(fA, fA2);
    }
    ...
    public static void b(org.json.JSONObject jSONObject, java.lang.String str) {
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("Error with setting not visible reason", e);
        }
    }
    ...
    public static org.json.JSONObject a(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("Error with creating viewStateObject", e);
        }
        return jSONObject;
    }
    ...
    public static void a(android.content.Context context) {
        if (context != null) {
            ...
            f2371a = (android.view.WindowManager) context.getSystemService("window");
        }
    }

    public static void a(org.json.JSONObject jSONObject, com.iab.omid.library.applovin.adsession.OutputDeviceStatus outputDeviceStatus) {
        try {
            jSONObject.put("noOutputDevice", a(outputDeviceStatus));
        } catch (org.json.JSONException e) {
            com.iab.omid.library.applovin.utils.d.a("Error with setting output device status", e);
        }
    }

    public static void a(org.json.JSONObject jSONObject, com.iab.omid.library.applovin.walking.a.C0216a c0216a) {
        com.iab.omid.library.applovin.internal.e eVarA = c0216a.a();
        org.json.JSONArray jSONArray = new org.json.JSONArray();
        java.util.Iterator<java.lang.String> it = c0216a.b().iterator();
        while (it.hasNext()) {
        ...
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("Error with setting friendly obstruction", e);
        }
    }
    ...
    public static void a(org.json.JSONObject jSONObject, java.lang.Boolean bool) {
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("Error with setting has window focus", e);
        }
    }
    ...
    public static void a(org.json.JSONObject jSONObject, java.lang.String str) {
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("Error with setting ad session id", e);
        }
    }
    ...
    public static void a(org.json.JSONObject jSONObject, java.lang.String str, java.lang.Object obj) {
        try {
            ...
            com.iab.omid.library.applovin.utils.d.a("JSONException during JSONObject.put for name [" + str + com.ironsource.y8.i.e, e);
        }
    }
    ...
    private static boolean a(com.iab.omid.library.applovin.adsession.OutputDeviceStatus outputDeviceStatus) {
        return com.iab.omid.library.applovin.utils.c.a.f2372a[outputDeviceStatus.ordinal()] == 1;
    }
