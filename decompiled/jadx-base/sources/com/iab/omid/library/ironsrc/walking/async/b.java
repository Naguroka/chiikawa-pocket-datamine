...
public abstract class b extends android.os.AsyncTask<java.lang.Object, java.lang.Void, java.lang.String> {
    ...
    private com.iab.omid.library.ironsrc.walking.async.b.a f2447a;
    protected final com.iab.omid.library.ironsrc.walking.async.b.InterfaceC0224b b;
    ...
    public b(com.iab.omid.library.ironsrc.walking.async.b.InterfaceC0224b interfaceC0224b) {
    ...
    public void onPostExecute(java.lang.String str) {
        com.iab.omid.library.ironsrc.walking.async.b.a aVar = this.f2447a;
        if (aVar != null) {
            aVar.a(this);
        }
    }
