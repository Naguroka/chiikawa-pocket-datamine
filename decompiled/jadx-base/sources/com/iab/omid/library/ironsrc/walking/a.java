...
public class a {
    ...
    private final java.util.HashMap<android.view.View, java.lang.String> f2445a = new java.util.HashMap<>();
    private final java.util.HashMap<android.view.View, com.iab.omid.library.ironsrc.walking.a.C0223a> b = new java.util.HashMap<>();
    ...
    public static class C0223a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final com.iab.omid.library.ironsrc.internal.e f2446a;
        private final java.util.ArrayList<java.lang.String> b = new java.util.ArrayList<>();

        public C0223a(com.iab.omid.library.ironsrc.internal.e eVar, java.lang.String str) {
            this.f2446a = eVar;
            a(str);
        }
    ...
    private java.lang.String a(android.view.View view) {
        ...
        while (view != null) {
            java.lang.String strA = com.iab.omid.library.ironsrc.utils.h.a(view);
            if (strA != null) {
                return strA;
            }
            hashSet.add(view);
    ...
    private void a(com.iab.omid.library.ironsrc.internal.e eVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        com.iab.omid.library.ironsrc.walking.a.C0223a c0223a = this.b.get(view);
        if (c0223a != null) {
            c0223a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new com.iab.omid.library.ironsrc.walking.a.C0223a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public com.iab.omid.library.ironsrc.walking.a.C0223a c(android.view.View view) {
        com.iab.omid.library.ironsrc.walking.a.C0223a c0223a = this.b.get(view);
        if (c0223a != null) {
            this.b.remove(view);
        }
    ...
    public java.lang.String d(android.view.View view) {
        ...
        java.lang.String str = this.f2445a.get(view);
        if (str != null) {
            this.f2445a.remove(view);
        }
        return str;
    }
    ...
    public com.iab.omid.library.ironsrc.walking.c e(android.view.View view) {
        if (this.d.contains(view)) {
            return com.iab.omid.library.ironsrc.walking.c.PARENT_VIEW;
        }
        return this.i ? com.iab.omid.library.ironsrc.walking.c.OBSTRUCTION_VIEW : com.iab.omid.library.ironsrc.walking.c.UNDERLYING_VIEW;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f2445a.put(viewC, adSessionId);
                            a(aVar);
