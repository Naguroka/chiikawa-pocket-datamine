...
public class d implements com.iab.omid.library.bytedance2.processor.a {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final int[] f2400a = new int[2];

    private void a(android.view.ViewGroup viewGroup, org.json.JSONObject jSONObject, com.iab.omid.library.bytedance2.processor.a.InterfaceC0218a interfaceC0218a, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            interfaceC0218a.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    private void b(android.view.ViewGroup viewGroup, org.json.JSONObject jSONObject, com.iab.omid.library.bytedance2.processor.a.InterfaceC0218a interfaceC0218a, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                interfaceC0218a.a((android.view.View) it2.next(), this, jSONObject, z);
            }
        }
    }
    ...
    public org.json.JSONObject a(android.view.View view) {
        ...
        view.getLocationOnScreen(this.f2400a);
    ...
    public void a(android.view.View view, org.json.JSONObject jSONObject, com.iab.omid.library.bytedance2.processor.a.InterfaceC0218a interfaceC0218a, boolean z, boolean z2) {
        if (view instanceof android.view.ViewGroup) {
            ...
            if (z) {
                b(viewGroup, jSONObject, interfaceC0218a, z2);
            } else {
                a(viewGroup, jSONObject, interfaceC0218a, z2);
            }
        }
    }
}
