...
public class h {
    ...
    private static com.iab.omid.library.bytedance2.internal.h f2395a = new com.iab.omid.library.bytedance2.internal.h();

    class a implements java.lang.Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ android.webkit.WebView f2396a;
        ...
        public void run() {
            com.iab.omid.library.bytedance2.internal.h.this.c(this.f2396a, this.b);
        }
    }
    ...
    public static final com.iab.omid.library.bytedance2.internal.h a() {
        return f2395a;
    }
    ...
    public void a(android.webkit.WebView webView, java.lang.String str, com.iab.omid.library.bytedance2.adsession.ErrorType errorType, java.lang.String str2) {
    ...
    void a(android.webkit.WebView webView, java.lang.String str, java.lang.Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.bytedance2.utils.d.a("The WebView is null for ".concat(java.lang.String.valueOf(str)));
            return;
        }
    ...
    void a(android.webkit.WebView webView, java.lang.StringBuilder sb) {
        ...
        if (handler == null || android.os.Looper.myLooper() == handler.getLooper()) {
            ...
            handler.post(new com.iab.omid.library.bytedance2.internal.h.a(webView, string));
        }
    }
