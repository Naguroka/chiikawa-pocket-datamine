...
public class g {
    public static void a() {
        if (!com.iab.omid.library.bytedance2.Omid.isActive()) {
            throw new java.lang.IllegalStateException("Method called before OM SDK activation");
        }
    }

    public static void a(com.iab.omid.library.bytedance2.adsession.Owner owner, com.iab.omid.library.bytedance2.adsession.CreativeType creativeType, com.iab.omid.library.bytedance2.adsession.ImpressionType impressionType) {
        if (owner == com.iab.omid.library.bytedance2.adsession.Owner.NONE) {
            throw new java.lang.IllegalArgumentException("Impression owner is none");
        }
        if (creativeType == com.iab.omid.library.bytedance2.adsession.CreativeType.DEFINED_BY_JAVASCRIPT && owner == com.iab.omid.library.bytedance2.adsession.Owner.NATIVE) {
        ...
        if (impressionType == com.iab.omid.library.bytedance2.adsession.ImpressionType.DEFINED_BY_JAVASCRIPT && owner == com.iab.omid.library.bytedance2.adsession.Owner.NATIVE) {
            throw new java.lang.IllegalArgumentException("ImpressionType/CreativeType can only be defined as DEFINED_BY_JAVASCRIPT if Impression Owner is JavaScript");
        }
    }
