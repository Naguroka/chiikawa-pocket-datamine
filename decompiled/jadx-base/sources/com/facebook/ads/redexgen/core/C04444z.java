...
public class C04444z {
    ...
    public C04444z(int i, int i2) {
        this(i, i2, Integer.MIN_VALUE, null);
    }

    public C04444z(int i, int i2, int i3, android.view.animation.Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
    ...
    public final void A05(com.facebook.ads.redexgen.core.FL fl) {
        if (this.A04 >= 0) {
            int i = this.A04;
            this.A04 = -1;
            fl.A1S(i);
        ...
        if (this.A06) {
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    ...
                    com.facebook.ads.redexgen.core.AnonymousClass55 anonymousClass55 = fl.A08;
                    int i2 = this.A02;
                    int i3 = this.A03;
                    if (A08[1].length() != 25) {
                        anonymousClass55.A0B(i2, i3, this.A01);
                    } else {
