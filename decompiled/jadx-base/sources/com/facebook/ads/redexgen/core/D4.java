...
public final class D4 {
    public static java.lang.String[] A04 = {"2QTGoYMpfKLSzpVAlAXt3wO29bqk4RAA", "gIVLvkl7NjInzfAn9w", "LtzZXv6bjFNgAMVtXqfV0PMfXX50BMJx", "cWJguejgjTPrXLbmw", "RAr", "xZz", "IB4Qfid", "bOBzxUCB3cvUoI573SXQe51BlLqC0MhI"};
    ...
    public final void A01(byte[] bArr, int i, int i2) {
        ...
        if (length < readLength + i3) {
            ...
            byte[] bArrCopyOf = java.util.Arrays.copyOf(bArr2, (readLength2 + i3) * 2);
            if (A04[4].length() != 3) {
