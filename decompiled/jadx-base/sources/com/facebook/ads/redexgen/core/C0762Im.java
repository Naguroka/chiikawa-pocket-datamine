...
public final class C0762Im {
    public static com.facebook.ads.redexgen.core.C0762Im A01;
    ...
    public static java.lang.String A0U(int i, int i2, int i3) {
    ...
    static {
        ...
        A04 = new java.lang.String[]{A0U(22, 5, 111), A0U(1, 9, 77), A0U(10, 12, 27)};
    }

    public C0762Im(android.content.Context context) {
        this.A00 = context.getApplicationContext().getSharedPreferences(com.facebook.ads.internal.util.process.ProcessUtils.getProcessSpecificName(A0U(5514, 31, 77), context), 0);
    }
    ...
    private final float A01(java.lang.String str, float f) {
        ...
        if (string != null) {
            try {
                java.lang.String value = A0U(5627, 4, 100);
    ...
    public static int A0A(android.content.Context context) {
        return A0T(context).A2p(A0U(com.json.mediationsdk.utils.IronSourceConstants.RV_COLLECT_TOKENS_FAILED, 40, 117), 3);
    }
    ...
    public static long A0P(android.content.Context context) {
        return A0T(context).A2q(A0U(535, 34, 98), 67108864L);
    }

    public static long A0Q(android.content.Context context) {
    ...
    public static synchronized com.facebook.ads.redexgen.core.C0762Im A0T(android.content.Context context) {
        if (A01 == null) {
            A01 = new com.facebook.ads.redexgen.core.C0762Im(context);
        }
        return A01;
    }

    public static java.lang.String A0V(android.content.Context context) {
        return A0T(context).A2r(A0U(3330, 28, 81), A0U(5752, 3, 126));
    }

    public static java.lang.String A0W(android.content.Context context) {
        return A0T(context).A2r(A0U(4851, 25, 3), A0U(5752, 3, 126));
    }

    public static java.util.Set<java.lang.String> A0X(android.content.Context context) {
        return A0T(context).A0a(A0U(394, 44, 39), A03);
    }

    public static java.util.Set<java.lang.String> A0Y(android.content.Context context) {
    ...
    private java.util.Set<java.lang.String> A0a(java.lang.String str, java.lang.String[] strArr) {
        org.json.JSONArray jSONArray;
        java.lang.String jsonArrayString = A2r(str, null);
        try {
    ...
    public static void A0c(android.content.Context context) {
        A0T(context).A00.edit().clear().commit();
    }

    private void A0d(java.lang.String str, java.lang.String str2) throws org.json.JSONException {
    ...
    private void A0e(org.json.JSONObject jSONObject, java.lang.String str) throws org.json.JSONException {
        ...
        editorEdit.putString(A0U(5569, 21, 32), sharedPrefKey);
        editorEdit.apply();
    }
    ...
    public static boolean A0w(android.content.Context context) {
        return A0T(context).A2v(A0U(com.google.android.gms.nearby.messages.NearbyMessagesStatusCodes.BLUETOOTH_OFF, 28, 21), false);
    }
    ...
    public static boolean A10(android.content.Context context) {
        return A0T(context).A2v(A0U(com.json.mediationsdk.utils.IronSourceConstants.BN_RELOAD, 35, 38), true);
    }
    ...
    public static boolean A12(android.content.Context context) {
        return A0T(context).A2v(A0U(org.objectweb.asm.Opcodes.IINC, 25, 67), false);
    }
    ...
    public static boolean A16(android.content.Context context) {
        return android.os.Build.VERSION.SDK_INT >= 18 && A0T(context).A2v(A0U(2464, 25, 21), false);
    }
    ...
    public static boolean A1C(android.content.Context context) {
        return A0T(context).A2v(A0U(com.json.mediationsdk.utils.IronSourceConstants.BN_CALLBACK_RELOAD_SUCCESS, 29, 6), false);
    }
    ...
    public static boolean A1k(android.content.Context context) {
        return A0T(context).A2v(A0U(com.json.mediationsdk.utils.IronSourceConstants.NT_CALLBACK_LOAD_SUCCESS, 32, 26), true);
    }
    ...
    public static boolean A1y(android.content.Context context) {
        return android.os.Build.VERSION.SDK_INT >= 16 && A0T(context).A2v(A0U(438, 46, 25), false);
    }
    ...
    public static boolean A2B(android.content.Context context) {
        return A0T(context).A2v(A0U(com.json.mediationsdk.utils.IronSourceConstants.NT_AUCTION_RESPONSE_WATERFALL, 31, 101), false);
    }
    ...
    public static boolean A2Q(android.content.Context context) {
        return A0T(context).A2v(A0U(com.json.mediationsdk.logger.IronSourceError.ERROR_RV_SHOW_EXCEPTION, 31, 99), false);
    }
    ...
    public static boolean A2m(android.content.Context context, boolean z) {
        return A2o(context, z) && A0T(context).A2v(A0U(2489, 27, 32), false);
    }

    public static boolean A2n(android.content.Context context, boolean z) {
        return android.os.Build.VERSION.SDK_INT >= 21 && A2m(context, z) && A0T(context).A2v(A0U(2516, 35, 70), true);
    }

    public static boolean A2o(android.content.Context context, boolean z) {
        return z && android.os.Build.VERSION.SDK_INT >= 19 && A0T(context).A2v(A0U(2551, 24, 30), false);
    }

    public final int A2p(java.lang.String str, int i) {
    ...
    public final long A2q(java.lang.String str, long j) {
    ...
    public final java.lang.String A2r(java.lang.String str, java.lang.String str2) {
    ...
    public final void A2s(java.lang.String str) {
        this.A00.edit().remove(str).apply();
    }

    public final void A2t(java.lang.String str) throws org.json.JSONException {
        A0d(str, null);
    }

    public final void A2u(org.json.JSONObject jSONObject) throws org.json.JSONException {
        if (jSONObject == null) {
            return;
        }
        A0e(jSONObject, null);
    ...
    public final boolean A2v(java.lang.String str, boolean z) {
