...
public class c extends com.bykv.vk.openvk.preload.b.d<android.util.Pair<java.io.File, com.bykv.vk.openvk.preload.geckox.model.UpdatePackage>, android.util.Pair<java.lang.String, java.lang.Long>> {
    ...
    public final /* synthetic */ java.lang.Object a(com.bykv.vk.openvk.preload.b.b<android.util.Pair<java.lang.String, java.lang.Long>> bVar, android.util.Pair<java.io.File, com.bykv.vk.openvk.preload.geckox.model.UpdatePackage> pair) throws java.lang.Throwable {
        ...
        com.bykv.vk.openvk.preload.geckox.logger.GeckoLogger.d("gecko-debug-tag", "start active full single file, channel:", ((com.bykv.vk.openvk.preload.geckox.model.UpdatePackage) pair2.second).getChannel());
        java.io.File parentFile = ((java.io.File) pair2.first).getParentFile().getParentFile();
        ...
        if (!parentFile.renameTo(file)) {
            throw new java.lang.RuntimeException("active full single file failed: " + parentFile.getAbsolutePath());
        }
