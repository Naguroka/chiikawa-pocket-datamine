...
public final class MaterialContainerTransform extends androidx.transition.Transition {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                if (this.drawingViewId == view4.getId()) {
                    ...
                    viewFindAncestorById = com.google.android.material.transition.TransitionUtils.findAncestorById(view4, this.drawingViewId);
                    view = null;
                }
                android.graphics.RectF locationOnScreen = com.google.android.material.transition.TransitionUtils.getLocationOnScreen(viewFindAncestorById);
                ...
                final com.google.android.material.transition.MaterialContainerTransform.TransitionDrawable transitionDrawable = new com.google.android.material.transition.MaterialContainerTransform.TransitionDrawable(getPathMotion(), view2, rectF, shapeAppearanceModel, getElevationOrDefault(this.startElevation, view2), view3, rectF2, shapeAppearanceModel2, getElevationOrDefault(this.endElevation, view3), this.containerColor, this.startContainerColor, this.endContainerColor, this.scrimColor, zIsEntering, this.elevationShadowEnabled, com.google.android.material.transition.FadeModeEvaluators.get(this.fadeMode, zIsEntering), com.google.android.material.transition.FitModeEvaluators.get(this.fitMode, zIsEntering, rectF, rectF2), buildThresholdsGroup(zIsEntering), this.drawDebugEnabled);
    ...
    private void maybeApplyThemeValues(android.content.Context context, boolean z) {
        com.google.android.material.transition.TransitionUtils.maybeApplyThemeInterpolator(this, context, com.google.android.material.R.attr.motionEasingEmphasizedInterpolator, com.google.android.material.animation.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        com.google.android.material.transition.TransitionUtils.maybeApplyThemeDuration(this, context, z ? com.google.android.material.R.attr.motionDurationLong2 : com.google.android.material.R.attr.motionDurationMedium4);
    ...
    private static final class TransitionDrawable extends android.graphics.drawable.Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float fLerp = com.google.android.material.transition.TransitionUtils.lerp(0.0f, 1.0f, fFloatValue, fFloatValue2, f);
