...
public final class FadeProvider implements com.google.android.material.transition.platform.VisibilityAnimatorProvider {
    ...
    private static android.animation.Animator createFadeAnimator(final android.view.View view, final float f, final float f2, final float f3, final float f4, final float f5) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new android.animation.ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.platform.FadeProvider.1
        ...
        valueAnimatorOfFloat.addListener(new android.animation.AnimatorListenerAdapter() { // from class: com.google.android.material.transition.platform.FadeProvider.2
