...
class zzhd extends java.util.AbstractMap {
    private java.lang.Object[] zza;
    private int zzb;
    private boolean zzd;
    private volatile com.google.android.gms.internal.play_billing.zzhb zze;
    ...
    private final int zzl(java.lang.Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int iCompareTo = comparable.compareTo(((com.google.android.gms.internal.play_billing.zzgz) this.zza[i]).zza());
            if (iCompareTo > 0) {
                return -(i + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int iCompareTo2 = comparable.compareTo(((com.google.android.gms.internal.play_billing.zzgz) this.zza[i3]).zza());
            if (iCompareTo2 < 0) {
                i = i3 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final java.lang.Object zzm(int i) {
        zzo();
        java.lang.Object value = ((com.google.android.gms.internal.play_billing.zzgz) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new com.google.android.gms.internal.play_billing.zzgz(this, (java.lang.Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final java.util.Set entrySet() {
        if (this.zze == null) {
            this.zze = new com.google.android.gms.internal.play_billing.zzhb(this, null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof com.google.android.gms.internal.play_billing.zzhd)) {
            return super.equals(obj);
        }
        com.google.android.gms.internal.play_billing.zzhd zzhdVar = (com.google.android.gms.internal.play_billing.zzhd) obj;
        int size = size();
    ...
    public final java.lang.Object get(java.lang.Object obj) {
        ...
        return iZzl >= 0 ? ((com.google.android.gms.internal.play_billing.zzgz) this.zza[iZzl]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final java.lang.Object put(java.lang.Comparable comparable, java.lang.Object obj) {
        ...
        int iZzl = zzl(comparable);
        if (iZzl >= 0) {
            return ((com.google.android.gms.internal.play_billing.zzgz) this.zza[iZzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
        ...
        if (this.zzb == 16) {
            com.google.android.gms.internal.play_billing.zzgz zzgzVar = (com.google.android.gms.internal.play_billing.zzgz) this.zza[15];
            this.zzb = 15;
        ...
        this.zza[i] = new com.google.android.gms.internal.play_billing.zzgz(this, comparable, obj);
        this.zzb++;
        return null;
    }
    ...
    public final java.util.Map.Entry zzg(int i) {
        if (i < this.zzb) {
            return (com.google.android.gms.internal.play_billing.zzgz) this.zza[i];
        }
    ...
    /* synthetic */ zzhd(com.google.android.gms.internal.play_billing.zzhc zzhcVar) {
    }
}
