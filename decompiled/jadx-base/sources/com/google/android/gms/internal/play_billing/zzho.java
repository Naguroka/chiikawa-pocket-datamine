...
final class zzho {
    ...
    static {
        boolean z;
        boolean z2;
        com.google.android.gms.internal.play_billing.zzhn zzhnVar;
        ...
        com.google.android.gms.internal.play_billing.zzhn zzhlVar = null;
        if (unsafeZzg != null) {
            if (zZzv) {
                zzhlVar = new com.google.android.gms.internal.play_billing.zzhm(unsafeZzg);
            } else if (zZzv2) {
                zzhlVar = new com.google.android.gms.internal.play_billing.zzhl(unsafeZzg);
            }
        }
        zzf = zzhlVar;
        if (zzhlVar == null) {
            ...
            try {
                java.lang.Class<?> cls = zzhlVar.zza.getClass();
        ...
        zzg = z;
        com.google.android.gms.internal.play_billing.zzhn zzhnVar2 = zzf;
        if (zzhnVar2 == null) {
            z2 = false;
        } else {
            try {
                java.lang.Class<?> cls2 = zzhnVar2.zza.getClass();
    ...
    static /* bridge */ /* synthetic */ void zzh(java.lang.Throwable th) {
        java.util.logging.Logger.getLogger(com.google.android.gms.internal.play_billing.zzho.class.getName()).logp(java.util.logging.Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
