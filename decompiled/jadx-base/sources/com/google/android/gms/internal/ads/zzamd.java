...
public final class zzamd implements com.google.android.gms.internal.ads.zzamj {
    ...
    public zzamd(java.lang.String str, int i) {
        com.google.android.gms.internal.ads.zzdx zzdxVar = new com.google.android.gms.internal.ads.zzdx(new byte[16], 16);
        this.zza = zzdxVar;
    ...
    public final void zza(com.google.android.gms.internal.ads.zzdy zzdyVar) {
        ...
        while (zzdyVar.zzb() > 0) {
            ...
            if (i == 0) {
                while (true) {
                    if (zzdyVar.zzb() > 0) {
                        if (this.zzi) {
                            ...
                            zzdyVar2.zzN()[0] = -84;
                            zzdyVar2.zzN()[1] = iZzm == 65 ? (byte) 65 : (byte) 64;
                            this.zzh = 2;
                        } else {
                ...
                int iMin2 = java.lang.Math.min(zzdyVar.zzb(), 16 - this.zzh);
                zzdyVar.zzH(bArrZzN, this.zzh, iMin2);
                int i3 = this.zzh + iMin2;
                this.zzh = i3;
                if (i3 == 16) {
                    this.zza.zzl(0);
                    com.google.android.gms.internal.ads.zzabo zzaboVarZza = com.google.android.gms.internal.ads.zzabq.zza(this.zza);
                    com.google.android.gms.internal.ads.zzab zzabVar = this.zzk;
                    if (zzabVar == null || zzabVar.zzD != 2 || zzaboVarZza.zza != zzabVar.zzE || !androidx.media3.common.MimeTypes.AUDIO_AC4.equals(zzabVar.zzo)) {
