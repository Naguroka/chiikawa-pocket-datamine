...
final class zzck extends com.google.android.gms.common.api.internal.TaskApiCall<com.google.android.gms.internal.drive.zzaw, com.google.android.gms.drive.DriveFolder> {
    zzck(com.google.android.gms.internal.drive.zzch zzchVar) {
    }
    ...
    protected final /* synthetic */ void doExecute(com.google.android.gms.common.api.Api.AnyClient anyClient, com.google.android.gms.tasks.TaskCompletionSource<com.google.android.gms.drive.DriveFolder> taskCompletionSource) throws android.os.RemoteException {
        ...
        if (zzawVar.zzae() == null) {
            taskCompletionSource.setException(new com.google.android.gms.common.api.ApiException(new com.google.android.gms.common.api.Status(10, "Drive#SCOPE_FILE must be requested")));
        } else {
            taskCompletionSource.setResult(new com.google.android.gms.internal.drive.zzbs(zzawVar.zzae()));
        }
    }
}
