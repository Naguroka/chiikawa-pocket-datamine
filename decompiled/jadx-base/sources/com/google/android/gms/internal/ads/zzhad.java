...
class zzhad extends java.util.AbstractMap {
    private java.lang.Object[] zza;
    private int zzb;
    private boolean zzd;
    private volatile com.google.android.gms.internal.ads.zzhab zze;
    ...
    private final int zzl(java.lang.Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int iCompareTo = comparable.compareTo(((com.google.android.gms.internal.ads.zzgzz) this.zza[i]).zza());
            if (iCompareTo > 0) {
                return -(i + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int iCompareTo2 = comparable.compareTo(((com.google.android.gms.internal.ads.zzgzz) this.zza[i3]).zza());
            if (iCompareTo2 < 0) {
                i = i3 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final java.lang.Object zzm(int i) {
        zzo();
        java.lang.Object value = ((com.google.android.gms.internal.ads.zzgzz) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new com.google.android.gms.internal.ads.zzgzz(this, (java.lang.Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final java.util.Set entrySet() {
        if (this.zze == null) {
            this.zze = new com.google.android.gms.internal.ads.zzhab(this, null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof com.google.android.gms.internal.ads.zzhad)) {
            return super.equals(obj);
        }
        com.google.android.gms.internal.ads.zzhad zzhadVar = (com.google.android.gms.internal.ads.zzhad) obj;
        int size = size();
    ...
    public final java.lang.Object get(java.lang.Object obj) {
        ...
        return iZzl >= 0 ? ((com.google.android.gms.internal.ads.zzgzz) this.zza[iZzl]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final java.lang.Object put(java.lang.Comparable comparable, java.lang.Object obj) {
        ...
        int iZzl = zzl(comparable);
        if (iZzl >= 0) {
            return ((com.google.android.gms.internal.ads.zzgzz) this.zza[iZzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
        ...
        if (this.zzb == 16) {
            com.google.android.gms.internal.ads.zzgzz zzgzzVar = (com.google.android.gms.internal.ads.zzgzz) this.zza[15];
            this.zzb = 15;
        ...
        this.zza[i] = new com.google.android.gms.internal.ads.zzgzz(this, comparable, obj);
        this.zzb++;
        return null;
    }
    ...
    public final java.util.Map.Entry zzg(int i) {
        if (i < this.zzb) {
            return (com.google.android.gms.internal.ads.zzgzz) this.zza[i];
        }
    ...
    /* synthetic */ zzhad(com.google.android.gms.internal.ads.zzhac zzhacVar) {
    }
}
