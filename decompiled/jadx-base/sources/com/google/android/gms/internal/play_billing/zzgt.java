...
final class zzgt extends com.google.android.gms.internal.play_billing.zzdu implements java.util.RandomAccess {
    ...
    static {
        ...
        zza = objArr;
        zzb = new com.google.android.gms.internal.play_billing.zzgt(objArr, 0, false);
    }
    ...
    public final /* bridge */ /* synthetic */ com.google.android.gms.internal.play_billing.zzfn zzd(int i) {
        if (i >= this.zzd) {
            return new com.google.android.gms.internal.play_billing.zzgt(i == 0 ? zza : java.util.Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
    ...
    private zzgt(java.lang.Object[] objArr, int i, boolean z) {
        super(z);
        this.zzc = objArr;
        this.zzd = i;
    }
