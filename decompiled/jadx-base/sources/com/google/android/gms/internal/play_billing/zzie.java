...
public enum zzie implements com.google.android.gms.internal.play_billing.zzfk {
    ...
    NULL_DATA_WITH_PLAY_CANCELED_RESULT_CODE(org.objectweb.asm.Opcodes.I2B),
    NULL_DATA_WITH_PLAY_CANCELED_WITHOUT_COMPLETE_ACTION_RESULT_CODE(org.objectweb.asm.Opcodes.I2C),
    NULL_DATA_WITH_OTHER_RESULT_CODE_IN_PROXY_BILLING_ACTIVITY_RESULT(126),
    NULL_DATA_WITH_ON_CREATE_RUNTIME_EXCEPTION_RESULT_CODE(org.objectweb.asm.Opcodes.I2S),
    ...
    PBL_REASON_IN_DEVELOPMENT(org.objectweb.asm.Opcodes.LXOR),
    RUNTIME_EXCEPTION_WHEN_LAUNCHING_INTENT(org.objectweb.asm.Opcodes.IINC),
    NULL_INTENT_RETURNED_BY_PHONESKY(org.objectweb.asm.Opcodes.I2L),
    ERROR_IN_ACTIVITY_RESULT(134),
    MISSING_RESPONSE_CODE_IN_PHONESKY_BUNDLE(135),
    BILLING_API_VERSION_NOT_SET_IN_BUNDLE(136),
    RESPONSE_CODE_NOT_SET_IN_BUNDLE(org.objectweb.asm.Opcodes.L2F),
    ...
    INITIALIZE_REMOTE_EXCEPTION(org.objectweb.asm.Opcodes.D2I),
    PBL_REASON_IN_DEVELOPMENT2(org.objectweb.asm.Opcodes.D2L),
    PBL_REASON_IN_DEVELOPMENT3(org.objectweb.asm.Opcodes.D2F),
    INTENT_SENDER_EXCEPTION(org.objectweb.asm.Opcodes.LCMP),
    INCLUDE_SUSPENDED_SUBSCRIPTIONS_NOT_SUPPORTED(org.objectweb.asm.Opcodes.FCMPL);
    ...
    public static com.google.android.gms.internal.play_billing.zzie zzb(int i) {
        if (i == 90) {
    ...
    public final java.lang.String toString() {
        return java.lang.Integer.toString(this.zzbJ);
    }
