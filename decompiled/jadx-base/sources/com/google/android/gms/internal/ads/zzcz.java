...
public final class zzcz {
    ...
    private static int zzc(java.lang.String str, boolean z) {
        int i;
        com.google.android.gms.internal.ads.zzcw.zzd(!android.text.TextUtils.isEmpty(str));
        ...
        if (strReplace.startsWith("rgba")) {
            java.util.regex.Matcher matcher = (z ? zzc : zzb).matcher(strReplace);
            if (matcher.matches()) {
                if (z) {
                    java.lang.String strGroup = matcher.group(4);
                    strGroup.getClass();
                    i = (int) (java.lang.Float.parseFloat(strGroup) * 255.0f);
                } else {
                    java.lang.String strGroup2 = matcher.group(4);
                    strGroup2.getClass();
                    i = java.lang.Integer.parseInt(strGroup2, 10);
                }
                java.lang.String strGroup3 = matcher.group(1);
                strGroup3.getClass();
                int i3 = java.lang.Integer.parseInt(strGroup3, 10);
                java.lang.String strGroup4 = matcher.group(2);
                strGroup4.getClass();
                int i4 = java.lang.Integer.parseInt(strGroup4, 10);
                java.lang.String strGroup5 = matcher.group(3);
                strGroup5.getClass();
                return android.graphics.Color.argb(i, i3, i4, java.lang.Integer.parseInt(strGroup5, 10));
            }
        } else if (strReplace.startsWith("rgb")) {
            java.util.regex.Matcher matcher2 = zza.matcher(strReplace);
            if (matcher2.matches()) {
                java.lang.String strGroup6 = matcher2.group(1);
                strGroup6.getClass();
                int i5 = java.lang.Integer.parseInt(strGroup6, 10);
                java.lang.String strGroup7 = matcher2.group(2);
                strGroup7.getClass();
                int i6 = java.lang.Integer.parseInt(strGroup7, 10);
                java.lang.String strGroup8 = matcher2.group(3);
                strGroup8.getClass();
                return android.graphics.Color.rgb(i5, i6, java.lang.Integer.parseInt(strGroup8, 10));
            }
        } else {
            java.lang.Integer num = (java.lang.Integer) zzd.get(com.google.android.gms.internal.ads.zzftt.zza(strReplace));
            if (num != null) {
                return num.intValue();
            }
        }
