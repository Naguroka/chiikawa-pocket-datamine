...
public final class zzbw implements android.os.Parcelable.Creator<com.google.android.gms.location.SleepSegmentRequest> {
    ...
    public final /* bridge */ /* synthetic */ com.google.android.gms.location.SleepSegmentRequest createFromParcel(android.os.Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            if (fieldId == 1) {
                arrayListCreateTypedList = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createTypedList(parcel, header, com.google.android.gms.location.zzbx.CREATOR);
            } else if (fieldId != 2) {
        ...
        return new com.google.android.gms.location.SleepSegmentRequest(arrayListCreateTypedList, i);
    }
