...
abstract class Striped64 extends java.lang.Number {
    ...
    static final class Cell {
        ...
        static {
            try {
                sun.misc.Unsafe unsafe = com.google.common.cache.Striped64.getUnsafe();
                UNSAFE = unsafe;
                valueOffset = unsafe.objectFieldOffset(com.google.common.cache.Striped64.Cell.class.getDeclaredField("value"));
    ...
    static {
        try {
            ...
            UNSAFE = unsafe;
            baseOffset = unsafe.objectFieldOffset(com.google.common.cache.Striped64.class.getDeclaredField(androidx.media3.extractor.text.ttml.TtmlNode.RUBY_BASE));
            busyOffset = unsafe.objectFieldOffset(com.google.common.cache.Striped64.class.getDeclaredField("busy"));
        } catch (java.lang.Exception e) {
            throw new java.lang.Error(e);
        }
    }
    ...
    final void retryUpdate(long x, @javax.annotation.CheckForNull int[] hc, boolean wasUncontended) {
        ...
        while (true) {
            ...
            if (cellArr != null && (length = cellArr.length) > 0) {
                com.google.common.cache.Striped64.Cell cell = cellArr[(length - 1) & i];
                if (cell == null) {
                    if (this.busy == 0) {
                        com.google.common.cache.Striped64.Cell cell2 = new com.google.common.cache.Striped64.Cell(x);
                        if (this.busy == 0 && casBusy()) {
                            try {
                                com.google.common.cache.Striped64.Cell[] cellArr2 = this.cells;
                        ...
                        if (length >= NCPU || this.cells != cellArr) {
                            ...
                            try {
                                if (this.cells == cellArr) {
                                    com.google.common.cache.Striped64.Cell[] cellArr3 = new com.google.common.cache.Striped64.Cell[length << 1];
                ...
                try {
                    if (this.cells == cellArr) {
                        com.google.common.cache.Striped64.Cell[] cellArr4 = new com.google.common.cache.Striped64.Cell[2];
                        cellArr4[i & 1] = new com.google.common.cache.Striped64.Cell(x);
                        this.cells = cellArr4;
                        z = true;
                    } else {
                        z = false;
    ...
    public static sun.misc.Unsafe getUnsafe() {
        try {
            ...
            return (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new java.security.PrivilegedExceptionAction<sun.misc.Unsafe>() { // from class: com.google.common.cache.Striped64.1
