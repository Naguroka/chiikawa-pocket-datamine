...
abstract class BinaryWriter extends com.google.protobuf.ByteOutput implements com.google.protobuf.Writer {
    ...
    private final void writeInt32List_Internal(int i, com.google.protobuf.IntArrayList intArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeFixed32List_Internal(int i, com.google.protobuf.IntArrayList intArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeUInt64List_Internal(int i, com.google.protobuf.LongArrayList longArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeFixed64List_Internal(int i, com.google.protobuf.LongArrayList longArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeFloatList_Internal(int i, com.google.protobuf.FloatArrayList floatArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeDoubleList_Internal(int i, com.google.protobuf.DoubleArrayList doubleArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeBoolList_Internal(int i, com.google.protobuf.BooleanArrayList booleanArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeUInt32List_Internal(int i, com.google.protobuf.IntArrayList intArrayList, boolean z) throws java.io.IOException {
        if (z) {
    ...
    private final void writeSInt32List_Internal(int i, com.google.protobuf.IntArrayList intArrayList, boolean z) throws java.io.IOException {
        if (z) {
            requireSpace((intArrayList.size() * 5) + 10);
            int totalBytesWritten = getTotalBytesWritten();
            for (int size = intArrayList.size() - 1; size >= 0; size--) {
    ...
    private final void writeSInt64List_Internal(int i, com.google.protobuf.LongArrayList longArrayList, boolean z) throws java.io.IOException {
        if (z) {
            requireSpace((longArrayList.size() * 10) + 10);
            int totalBytesWritten = getTotalBytesWritten();
            for (int size = longArrayList.size() - 1; size >= 0; size--) {
    ...
    private static final class SafeHeapWriter extends com.google.protobuf.BinaryWriter {
        ...
        @Override // com.google.protobuf.Writer
        public void writeMessage(int i, java.lang.Object obj, com.google.protobuf.Schema schema) throws java.io.IOException {
            int totalBytesWritten = getTotalBytesWritten();
        ...
        @Override // com.google.protobuf.Writer
        public void writeGroup(int i, java.lang.Object obj, com.google.protobuf.Schema schema) throws java.io.IOException {
            writeTag(i, 4);
            schema.writeTo(obj, this);
            writeTag(i, 3);
        }
    ...
    private static final class UnsafeHeapWriter extends com.google.protobuf.BinaryWriter {
        ...
        @Override // com.google.protobuf.Writer
        public void writeBytes(int i, com.google.protobuf.ByteString byteString) {
            try {
                byteString.writeToReverse(this);
                requireSpace(10);
                writeVarint32(byteString.size());
        ...
        void writeString(java.lang.String str) {
            ...
            while (true) {
                ...
                long j3 = this.pos;
                this.pos = j3 - 1;
                com.google.protobuf.UnsafeUtil.putByte(bArr, j3, (byte) cCharAt2);
            }
            if (length == -1) {
                return;
            }
            while (length >= 0) {
                ...
                if (cCharAt3 < 128) {
                    ...
                    if (j4 > this.offsetMinusOne) {
                        byte[] bArr2 = this.buffer;
                        this.pos = j4 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr2, j4, (byte) cCharAt3);
                    } else if (cCharAt3 < 2048) {
                        j2 = this.pos;
                        if (j2 > this.offset) {
                            byte[] bArr3 = this.buffer;
                            this.pos = j2 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr3, j2, (byte) ((cCharAt3 & '?') | 128));
                            byte[] bArr4 = this.buffer;
                            long j5 = this.pos;
                            this.pos = j5 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr4, j5, (byte) ((cCharAt3 >>> 6) | 960));
                        } else if (cCharAt3 >= 55296 || 57343 < cCharAt3) {
                            j = this.pos;
                            if (j > this.offset + 1) {
                                byte[] bArr5 = this.buffer;
                                this.pos = j - 1;
                                com.google.protobuf.UnsafeUtil.putByte(bArr5, j, (byte) ((cCharAt3 & '?') | 128));
                                byte[] bArr6 = this.buffer;
                                long j6 = this.pos;
                                this.pos = j6 - 1;
                                com.google.protobuf.UnsafeUtil.putByte(bArr6, j6, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                                byte[] bArr7 = this.buffer;
                                long j7 = this.pos;
                                this.pos = j7 - 1;
                                com.google.protobuf.UnsafeUtil.putByte(bArr7, j7, (byte) ((cCharAt3 >>> '\f') | 480));
                            } else {
                                if (this.pos > this.offset + 2) {
                                    if (length != 0) {
                                        ...
                                        if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                            ...
                                            long j11 = this.pos;
                                            this.pos = j11 - 1;
                                            com.google.protobuf.UnsafeUtil.putByte(bArr11, j11, (byte) ((codePoint >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                        }
                                    }
                                    throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                                }
                            ...
                            if (this.pos > this.offset + 2) {
                                if (length != 0) {
                                    ...
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j12 = this.pos;
                                        this.pos = j12 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr12, j12, (byte) ((codePoint2 & 63) | 128));
                                        byte[] bArr13 = this.buffer;
                                        long j13 = this.pos;
                                        this.pos = j13 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr13, j13, (byte) (((codePoint2 >>> 6) & 63) | 128));
                                        byte[] bArr14 = this.buffer;
                                        long j14 = this.pos;
                                        this.pos = j14 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr14, j14, (byte) (((codePoint2 >>> 12) & 63) | 128));
                                        byte[] bArr15 = this.buffer;
                                        long j15 = this.pos;
                                        this.pos = j15 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr15, j15, (byte) ((codePoint2 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.offset + 1) {
                            ...
                            this.pos = j - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr16, j, (byte) ((cCharAt3 & '?') | 128));
                            byte[] bArr17 = this.buffer;
                            long j16 = this.pos;
                            this.pos = j16 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr17, j16, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            byte[] bArr18 = this.buffer;
                            long j17 = this.pos;
                            this.pos = j17 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr18, j17, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.offset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j18 = this.pos;
                                        this.pos = j18 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr19, j18, (byte) ((codePoint3 & 63) | 128));
                                        byte[] bArr110 = this.buffer;
                                        long j19 = this.pos;
                                        this.pos = j19 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr110, j19, (byte) (((codePoint3 >>> 6) & 63) | 128));
                                        byte[] bArr111 = this.buffer;
                                        long j110 = this.pos;
                                        this.pos = j110 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr111, j110, (byte) (((codePoint3 >>> 12) & 63) | 128));
                                        byte[] bArr112 = this.buffer;
                                        long j111 = this.pos;
                                        this.pos = j111 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr112, j111, (byte) ((codePoint3 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.offset + 1) {
                            ...
                            this.pos = j - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr113, j, (byte) ((cCharAt3 & '?') | 128));
                            byte[] bArr114 = this.buffer;
                            long j112 = this.pos;
                            this.pos = j112 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr114, j112, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            byte[] bArr115 = this.buffer;
                            long j113 = this.pos;
                            this.pos = j113 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr115, j113, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.offset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j114 = this.pos;
                                        this.pos = j114 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr116, j114, (byte) ((codePoint4 & 63) | 128));
                                        byte[] bArr117 = this.buffer;
                                        long j115 = this.pos;
                                        this.pos = j115 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr117, j115, (byte) (((codePoint4 >>> 6) & 63) | 128));
                                        byte[] bArr118 = this.buffer;
                                        long j116 = this.pos;
                                        this.pos = j116 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr118, j116, (byte) (((codePoint4 >>> 12) & 63) | 128));
                                        byte[] bArr119 = this.buffer;
                                        long j117 = this.pos;
                                        this.pos = j117 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr119, j117, (byte) ((codePoint4 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                    ...
                    if (j2 > this.offset) {
                        ...
                        this.pos = j2 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr20, j2, (byte) ((cCharAt3 & '?') | 128));
                        byte[] bArr21 = this.buffer;
                        long j20 = this.pos;
                        this.pos = j20 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr21, j20, (byte) ((cCharAt3 >>> 6) | 960));
                    } else if (cCharAt3 >= 55296) {
                        j = this.pos;
                        if (j > this.offset + 1) {
                            byte[] bArr1110 = this.buffer;
                            this.pos = j - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1110, j, (byte) ((cCharAt3 & '?') | 128));
                            byte[] bArr1111 = this.buffer;
                            long j118 = this.pos;
                            this.pos = j118 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1111, j118, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            byte[] bArr1112 = this.buffer;
                            long j119 = this.pos;
                            this.pos = j119 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1112, j119, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.offset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j1110 = this.pos;
                                        this.pos = j1110 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr1113, j1110, (byte) ((codePoint5 & 63) | 128));
                                        byte[] bArr1114 = this.buffer;
                                        long j1111 = this.pos;
                                        this.pos = j1111 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr1114, j1111, (byte) (((codePoint5 >>> 6) & 63) | 128));
                                        byte[] bArr1115 = this.buffer;
                                        long j1112 = this.pos;
                                        this.pos = j1112 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr1115, j1112, (byte) (((codePoint5 >>> 12) & 63) | 128));
                                        byte[] bArr1116 = this.buffer;
                                        long j1113 = this.pos;
                                        this.pos = j1113 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr1116, j1113, (byte) ((codePoint5 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.offset + 1) {
                            ...
                            this.pos = j - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1117, j, (byte) ((cCharAt3 & '?') | 128));
                            byte[] bArr1118 = this.buffer;
                            long j1114 = this.pos;
                            this.pos = j1114 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1118, j1114, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            byte[] bArr1119 = this.buffer;
                            long j1115 = this.pos;
                            this.pos = j1115 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(bArr1119, j1115, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.offset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j1116 = this.pos;
                                        this.pos = j1116 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr11110, j1116, (byte) ((codePoint6 & 63) | 128));
                                        byte[] bArr11111 = this.buffer;
                                        long j1117 = this.pos;
                                        this.pos = j1117 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr11111, j1117, (byte) (((codePoint6 >>> 6) & 63) | 128));
                                        byte[] bArr11112 = this.buffer;
                                        long j1118 = this.pos;
                                        this.pos = j1118 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr11112, j1118, (byte) (((codePoint6 >>> 12) & 63) | 128));
                                        byte[] bArr11113 = this.buffer;
                                        long j1119 = this.pos;
                                        this.pos = j1119 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(bArr11113, j1119, (byte) ((codePoint6 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                    ...
                    if (j > this.offset + 1) {
                        ...
                        this.pos = j - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr11114, j, (byte) ((cCharAt3 & '?') | 128));
                        byte[] bArr11115 = this.buffer;
                        long j11110 = this.pos;
                        this.pos = j11110 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr11115, j11110, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                        byte[] bArr11116 = this.buffer;
                        long j11111 = this.pos;
                        this.pos = j11111 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr11116, j11111, (byte) ((cCharAt3 >>> '\f') | 480));
                    } else {
                        if (this.pos > this.offset + 2) {
                            if (length != 0) {
                                cCharAt = str.charAt(length - 1);
                                if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                    ...
                                    this.pos = j11112 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr11117, j11112, (byte) ((codePoint7 & 63) | 128));
                                    byte[] bArr11118 = this.buffer;
                                    long j11113 = this.pos;
                                    this.pos = j11113 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr11118, j11113, (byte) (((codePoint7 >>> 6) & 63) | 128));
                                    byte[] bArr11119 = this.buffer;
                                    long j11114 = this.pos;
                                    this.pos = j11114 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr11119, j11114, (byte) (((codePoint7 >>> 12) & 63) | 128));
                                    byte[] bArr111110 = this.buffer;
                                    long j11115 = this.pos;
                                    this.pos = j11115 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr111110, j11115, (byte) ((codePoint7 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                }
                            }
                            throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                        }
                    ...
                    if (j > this.offset + 1) {
                        ...
                        this.pos = j - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr111111, j, (byte) ((cCharAt3 & '?') | 128));
                        byte[] bArr111112 = this.buffer;
                        long j11116 = this.pos;
                        this.pos = j11116 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr111112, j11116, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                        byte[] bArr111113 = this.buffer;
                        long j11117 = this.pos;
                        this.pos = j11117 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(bArr111113, j11117, (byte) ((cCharAt3 >>> '\f') | 480));
                    } else {
                        if (this.pos > this.offset + 2) {
                            if (length != 0) {
                                cCharAt = str.charAt(length - 1);
                                if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                    ...
                                    this.pos = j11118 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr111114, j11118, (byte) ((codePoint8 & 63) | 128));
                                    byte[] bArr111115 = this.buffer;
                                    long j11119 = this.pos;
                                    this.pos = j11119 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr111115, j11119, (byte) (((codePoint8 >>> 6) & 63) | 128));
                                    byte[] bArr111116 = this.buffer;
                                    long j111110 = this.pos;
                                    this.pos = j111110 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr111116, j111110, (byte) (((codePoint8 >>> 12) & 63) | 128));
                                    byte[] bArr111117 = this.buffer;
                                    long j111111 = this.pos;
                                    this.pos = j111111 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(bArr111117, j111111, (byte) ((codePoint8 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                }
                            }
                            throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                        }
    ...
    private static final class UnsafeDirectWriter extends com.google.protobuf.BinaryWriter {
        ...
        private void nextBuffer(com.google.protobuf.AllocatedBuffer allocatedBuffer) {
            ...
            this.buffers.addFirst(allocatedBuffer);
            this.buffer = byteBufferNioBuffer;
            long jAddressOffset = com.google.protobuf.UnsafeUtil.addressOffset(this.buffer);
        ...
        void writeString(java.lang.String str) {
            ...
            while (true) {
                ...
                long j3 = this.pos;
                this.pos = j3 - 1;
                com.google.protobuf.UnsafeUtil.putByte(j3, (byte) cCharAt2);
            }
            if (length == -1) {
                return;
            }
            while (length >= 0) {
                ...
                if (cCharAt3 < 128) {
                    ...
                    if (j4 >= this.bufferOffset) {
                        this.pos = j4 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j4, (byte) cCharAt3);
                    } else if (cCharAt3 < 2048) {
                        j2 = this.pos;
                        if (j2 > this.bufferOffset) {
                            this.pos = j2 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j2, (byte) ((cCharAt3 & '?') | 128));
                            long j5 = this.pos;
                            this.pos = j5 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j5, (byte) ((cCharAt3 >>> 6) | 960));
                        } else if (cCharAt3 >= 55296 || 57343 < cCharAt3) {
                            j = this.pos;
                            if (j > this.bufferOffset + 1) {
                                this.pos = j - 1;
                                com.google.protobuf.UnsafeUtil.putByte(j, (byte) ((cCharAt3 & '?') | 128));
                                long j6 = this.pos;
                                this.pos = j6 - 1;
                                com.google.protobuf.UnsafeUtil.putByte(j6, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                                long j7 = this.pos;
                                this.pos = j7 - 1;
                                com.google.protobuf.UnsafeUtil.putByte(j7, (byte) ((cCharAt3 >>> '\f') | 480));
                            } else {
                                if (this.pos > this.bufferOffset + 2) {
                                    if (length != 0) {
                                        ...
                                        if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                            ...
                                            long j11 = this.pos;
                                            this.pos = j11 - 1;
                                            com.google.protobuf.UnsafeUtil.putByte(j11, (byte) ((codePoint >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                        }
                                    }
                                    throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                                }
                            ...
                            if (this.pos > this.bufferOffset + 2) {
                                if (length != 0) {
                                    ...
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j12 = this.pos;
                                        this.pos = j12 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j12, (byte) ((codePoint2 & 63) | 128));
                                        long j13 = this.pos;
                                        this.pos = j13 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j13, (byte) (((codePoint2 >>> 6) & 63) | 128));
                                        long j14 = this.pos;
                                        this.pos = j14 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j14, (byte) (((codePoint2 >>> 12) & 63) | 128));
                                        long j15 = this.pos;
                                        this.pos = j15 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j15, (byte) ((codePoint2 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.bufferOffset + 1) {
                            ...
                            long j16 = this.pos;
                            this.pos = j16 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j16, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            long j17 = this.pos;
                            this.pos = j17 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j17, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.bufferOffset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j18 = this.pos;
                                        this.pos = j18 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j18, (byte) ((codePoint3 & 63) | 128));
                                        long j19 = this.pos;
                                        this.pos = j19 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j19, (byte) (((codePoint3 >>> 6) & 63) | 128));
                                        long j110 = this.pos;
                                        this.pos = j110 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j110, (byte) (((codePoint3 >>> 12) & 63) | 128));
                                        long j111 = this.pos;
                                        this.pos = j111 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j111, (byte) ((codePoint3 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.bufferOffset + 1) {
                            ...
                            long j112 = this.pos;
                            this.pos = j112 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j112, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            long j113 = this.pos;
                            this.pos = j113 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j113, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.bufferOffset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j114 = this.pos;
                                        this.pos = j114 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j114, (byte) ((codePoint4 & 63) | 128));
                                        long j115 = this.pos;
                                        this.pos = j115 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j115, (byte) (((codePoint4 >>> 6) & 63) | 128));
                                        long j116 = this.pos;
                                        this.pos = j116 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j116, (byte) (((codePoint4 >>> 12) & 63) | 128));
                                        long j117 = this.pos;
                                        this.pos = j117 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j117, (byte) ((codePoint4 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                    ...
                    if (j2 > this.bufferOffset) {
                        ...
                        long j20 = this.pos;
                        this.pos = j20 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j20, (byte) ((cCharAt3 >>> 6) | 960));
                    } else if (cCharAt3 >= 55296) {
                        j = this.pos;
                        if (j > this.bufferOffset + 1) {
                            this.pos = j - 1;
                            ...
                            long j118 = this.pos;
                            this.pos = j118 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j118, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            long j119 = this.pos;
                            this.pos = j119 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j119, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.bufferOffset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j1110 = this.pos;
                                        this.pos = j1110 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1110, (byte) ((codePoint5 & 63) | 128));
                                        long j1111 = this.pos;
                                        this.pos = j1111 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1111, (byte) (((codePoint5 >>> 6) & 63) | 128));
                                        long j1112 = this.pos;
                                        this.pos = j1112 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1112, (byte) (((codePoint5 >>> 12) & 63) | 128));
                                        long j1113 = this.pos;
                                        this.pos = j1113 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1113, (byte) ((codePoint5 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                        ...
                        if (j > this.bufferOffset + 1) {
                            ...
                            long j1114 = this.pos;
                            this.pos = j1114 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j1114, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                            long j1115 = this.pos;
                            this.pos = j1115 - 1;
                            com.google.protobuf.UnsafeUtil.putByte(j1115, (byte) ((cCharAt3 >>> '\f') | 480));
                        } else {
                            if (this.pos > this.bufferOffset + 2) {
                                if (length != 0) {
                                    cCharAt = str.charAt(length - 1);
                                    if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                        ...
                                        long j1116 = this.pos;
                                        this.pos = j1116 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1116, (byte) ((codePoint6 & 63) | 128));
                                        long j1117 = this.pos;
                                        this.pos = j1117 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1117, (byte) (((codePoint6 >>> 6) & 63) | 128));
                                        long j1118 = this.pos;
                                        this.pos = j1118 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1118, (byte) (((codePoint6 >>> 12) & 63) | 128));
                                        long j1119 = this.pos;
                                        this.pos = j1119 - 1;
                                        com.google.protobuf.UnsafeUtil.putByte(j1119, (byte) ((codePoint6 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                    }
                                }
                                throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                            }
                    ...
                    if (j > this.bufferOffset + 1) {
                        ...
                        long j11110 = this.pos;
                        this.pos = j11110 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j11110, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                        long j11111 = this.pos;
                        this.pos = j11111 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j11111, (byte) ((cCharAt3 >>> '\f') | 480));
                    } else {
                        if (this.pos > this.bufferOffset + 2) {
                            if (length != 0) {
                                cCharAt = str.charAt(length - 1);
                                if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                    ...
                                    long j11112 = this.pos;
                                    this.pos = j11112 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11112, (byte) ((codePoint7 & 63) | 128));
                                    long j11113 = this.pos;
                                    this.pos = j11113 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11113, (byte) (((codePoint7 >>> 6) & 63) | 128));
                                    long j11114 = this.pos;
                                    this.pos = j11114 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11114, (byte) (((codePoint7 >>> 12) & 63) | 128));
                                    long j11115 = this.pos;
                                    this.pos = j11115 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11115, (byte) ((codePoint7 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                }
                            }
                            throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                        }
                    ...
                    if (j > this.bufferOffset + 1) {
                        ...
                        long j11116 = this.pos;
                        this.pos = j11116 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j11116, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                        long j11117 = this.pos;
                        this.pos = j11117 - 1;
                        com.google.protobuf.UnsafeUtil.putByte(j11117, (byte) ((cCharAt3 >>> '\f') | 480));
                    } else {
                        if (this.pos > this.bufferOffset + 2) {
                            if (length != 0) {
                                cCharAt = str.charAt(length - 1);
                                if (java.lang.Character.isSurrogatePair(cCharAt, cCharAt3)) {
                                    ...
                                    long j11118 = this.pos;
                                    this.pos = j11118 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11118, (byte) ((codePoint8 & 63) | 128));
                                    long j11119 = this.pos;
                                    this.pos = j11119 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j11119, (byte) (((codePoint8 >>> 6) & 63) | 128));
                                    long j111110 = this.pos;
                                    this.pos = j111110 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j111110, (byte) (((codePoint8 >>> 12) & 63) | 128));
                                    long j111111 = this.pos;
                                    this.pos = j111111 - 1;
                                    com.google.protobuf.UnsafeUtil.putByte(j111111, (byte) ((codePoint8 >>> 18) | androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK));
                                }
                            }
                            throw new com.google.protobuf.Utf8.UnpairedSurrogateException(length - 1, length);
                        }
