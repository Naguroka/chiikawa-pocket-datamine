...
public final class TestingKt {
    public static final void withAnalyticsForTest(com.google.firebase.analytics.FirebaseAnalytics analytics, kotlin.jvm.functions.Function0<kotlin.Unit> block) {
        ...
        synchronized (com.google.firebase.analytics.AnalyticsKt.getLOCK()) {
            com.google.firebase.analytics.FirebaseAnalytics analytics2 = com.google.firebase.analytics.AnalyticsKt.getANALYTICS();
            com.google.firebase.analytics.AnalyticsKt.setANALYTICS(analytics);
            try {
                block.invoke();
                com.google.firebase.analytics.AnalyticsKt.setANALYTICS(analytics2);
