...
public class Table {
    ...
    com.google.flatbuffers.Utf8 utf8 = com.google.flatbuffers.Utf8.getDefault();
    ...
    protected static java.lang.String __string(int i, java.nio.ByteBuffer byteBuffer, com.google.flatbuffers.Utf8 utf8) {
    ...
    protected com.google.flatbuffers.Table __union(com.google.flatbuffers.Table table, int i) {
        return __union(table, i, this.bb);
    }

    protected static com.google.flatbuffers.Table __union(com.google.flatbuffers.Table table, int i, java.nio.ByteBuffer byteBuffer) {
    ...
    protected void sortTables(int[] iArr, final java.nio.ByteBuffer byteBuffer) {
        ...
        java.util.Arrays.sort(numArr, new java.util.Comparator<java.lang.Integer>() { // from class: com.google.flatbuffers.Table.1
            @Override // java.util.Comparator
            public int compare(java.lang.Integer num, java.lang.Integer num2) {
                return com.google.flatbuffers.Table.this.keysCompare(num, num2, byteBuffer);
            }
        });
