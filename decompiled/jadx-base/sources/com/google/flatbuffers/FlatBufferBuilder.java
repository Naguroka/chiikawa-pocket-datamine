...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory byteBufferFactory) {
        this(i, byteBufferFactory, null, com.google.flatbuffers.Utf8.getDefault());
    }

    public FlatBufferBuilder(int i, com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory byteBufferFactory, java.nio.ByteBuffer byteBuffer, com.google.flatbuffers.Utf8 utf8) {
        this.minalign = 1;
        this.vtable = null;
    ...
    public FlatBufferBuilder(int i) {
        this(i, com.google.flatbuffers.FlatBufferBuilder.HeapByteBufferFactory.INSTANCE, null, com.google.flatbuffers.Utf8.getDefault());
    }
    ...
    public FlatBufferBuilder(java.nio.ByteBuffer byteBuffer, com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory byteBufferFactory) {
        this(byteBuffer.capacity(), byteBufferFactory, byteBuffer, com.google.flatbuffers.Utf8.getDefault());
    }

    public FlatBufferBuilder(java.nio.ByteBuffer byteBuffer) {
        this(byteBuffer, new com.google.flatbuffers.FlatBufferBuilder.HeapByteBufferFactory());
    }

    public com.google.flatbuffers.FlatBufferBuilder init(java.nio.ByteBuffer byteBuffer, com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory byteBufferFactory) {
        this.bb_factory = byteBufferFactory;
        this.bb = byteBuffer;
        byteBuffer.clear();
        this.bb.order(java.nio.ByteOrder.LITTLE_ENDIAN);
    ...
    public static final class HeapByteBufferFactory extends com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory {
        public static final com.google.flatbuffers.FlatBufferBuilder.HeapByteBufferFactory INSTANCE = new com.google.flatbuffers.FlatBufferBuilder.HeapByteBufferFactory();
    ...
    public static boolean isFieldPresent(com.google.flatbuffers.Table table, int i) {
    ...
    static java.nio.ByteBuffer growByteBuffer(java.nio.ByteBuffer byteBuffer, com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory byteBufferFactory) {
    ...
    public <T extends com.google.flatbuffers.Table> int createSortedVectorOfTables(T t, int[] iArr) {
    ...
    public com.google.flatbuffers.FlatBufferBuilder forceDefaults(boolean z) {
    ...
    public java.io.InputStream sizedInputStream() {
        ...
        return new com.google.flatbuffers.FlatBufferBuilder.ByteBufferBackedInputStream(byteBufferDuplicate);
    }
