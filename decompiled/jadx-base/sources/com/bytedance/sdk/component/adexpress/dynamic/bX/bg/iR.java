...
public class iR implements android.view.View.OnTouchListener {
    ...
    private java.lang.ref.SoftReference<android.view.View> eo = new java.lang.ref.SoftReference<>(null);

    public iR(com.bytedance.sdk.component.adexpress.dynamic.bX.Kg kg, int i, final android.view.ViewGroup viewGroup) {
        this.zx = bX;
        this.eqN = kg;
        if (i > 0) {
            this.zx = i;
        ...
        if (viewGroup != null) {
            viewGroup.post(new java.lang.Runnable() { // from class: com.bytedance.sdk.component.adexpress.dynamic.bX.bg.iR.1
                @Override // java.lang.Runnable
                public void run() {
                    android.view.View viewFindViewById = viewGroup.findViewById(2097610746);
                    com.bytedance.sdk.component.adexpress.dynamic.bX.bg.iR.this.eo = new java.lang.ref.SoftReference(viewFindViewById);
                }
            });
        }
    }
    ...
    public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int iIL = com.bytedance.sdk.component.adexpress.eqN.Kg.IL(com.bytedance.sdk.component.adexpress.eqN.bg(), java.lang.Math.abs(rawX - this.bg));
            int i = bX;
            if (fAbs < i || fAbs2 < i) {
                if ((java.lang.System.currentTimeMillis() - this.iR < 200 || (fAbs < 3.0f && fAbs2 < 3.0f)) && (kg = this.eqN) != null) {
                    kg.bg();
                }
            } else if (rawX > this.bg && iIL > this.zx && (kg2 = this.eqN) != null) {
                kg2.bg();
            }
        }
        return true;
