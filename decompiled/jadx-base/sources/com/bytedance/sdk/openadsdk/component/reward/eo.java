...
public class eo {
    public static void bg(java.lang.String str, int i, java.lang.String str2, java.lang.String str3, java.lang.String str4) {
        try {
            ...
            if (tuvBg != null) {
                ...
                if (tuvBg.RiO() != null) {
                    if (!android.text.TextUtils.isEmpty(str2)) {
                        tuvBg.RiO().bg(str2);
                        tuvBg.RiO().IL("Test the downloaded app");
                    } else {
                        tuvBg.RiO().bg((java.lang.String) null);
                        tuvBg.RiO().IL("");
                    }
                    if (android.text.TextUtils.isEmpty(str2)) {
                        str2 = str4;
            ...
            new com.bytedance.sdk.openadsdk.AdSlot.Builder().build();
            com.bytedance.sdk.openadsdk.core.model.bg bgVar = new com.bytedance.sdk.openadsdk.core.model.bg();
            java.util.ArrayList arrayList = new java.util.ArrayList();
            arrayList.add(tuvBg);
            bgVar.bg(arrayList);
            new com.bytedance.sdk.openadsdk.component.reward.Ta(com.bytedance.sdk.openadsdk.core.VzQ.bg(), bgVar).bg(true);
        } catch (java.lang.Exception e) {
            com.bytedance.sdk.component.utils.PX.bg("PlayableVerityHelper", e.getMessage());
        }
    }
}
