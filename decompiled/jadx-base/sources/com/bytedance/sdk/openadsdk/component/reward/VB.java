...
public class VB {
    private static volatile com.bytedance.sdk.openadsdk.component.reward.VB bg;
    ...
    public void bg(java.lang.String str, com.bytedance.sdk.openadsdk.core.model.tuV tuv) {
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").bg(str, tuv);
            return;
        }
    ...
    public void bg() {
        ...
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").IL();
            return;
        }
        try {
            boolean z = com.bytedance.sdk.openadsdk.core.WR.iR("sp_reward_video");
            java.io.File file = new java.io.File(this.IL.getDataDir(), z ? "files" : "shared_prefs");
            if (file.exists() && file.isDirectory() && (fileArrListFiles2 = file.listFiles(new java.io.FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.VB.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (fileArrListFiles = cacheDir.listFiles(new java.io.FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.VB.2
                @Override // java.io.FileFilter
    ...
    public void bg(com.bytedance.sdk.openadsdk.AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.bg bgVar) {
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").bg(adSlot, bgVar);
            return;
        }
        if (bgVar == null || bgVar.WR() || adSlot == null || !android.text.TextUtils.isEmpty(adSlot.getBidAdm())) {
            return;
        }
        java.lang.String strBg = bgVar.bg();
        synchronized (bgVar) {
            if (!bgVar.WR()) {
                try {
                    this.bX.bg(adSlot, bgVar.PX().toString(), strBg);
                } catch (java.lang.Throwable unused) {
                    bgVar.eo();
                }
            }
    ...
    public static com.bytedance.sdk.openadsdk.component.reward.VB bg(android.content.Context context) {
        if (bg == null) {
            synchronized (com.bytedance.sdk.openadsdk.component.reward.VB.class) {
                if (bg == null) {
                    bg = new com.bytedance.sdk.openadsdk.component.reward.VB(context);
                }
            }
        }
        return bg;
    ...
    private VB(android.content.Context context) {
        ...
        this.bX = new com.bytedance.sdk.openadsdk.common.bg.IL("sp_reward_video");
    }

    public java.lang.String bg(com.bytedance.sdk.openadsdk.core.model.tuV tuv) {
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            return com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").bg(tuv);
        }
    ...
    public java.lang.String bg(java.lang.String str, java.lang.String str2, int i) {
        java.io.File fileBg;
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            return com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").bg(str, str2, i);
        }
        if (!android.text.TextUtils.isEmpty(str) && (fileBg = bg(str2, i)) != null && fileBg.exists() && fileBg.isFile() && fileBg.length() > 0) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.bg bg(java.lang.String str, boolean z) {
        ...
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg bgVarBg = com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video");
    ...
    public void bg(final boolean z, final com.bytedance.sdk.openadsdk.core.model.tuV tuv, final long j, java.lang.String str) {
        ...
        com.bytedance.sdk.openadsdk.yDt.bX.bg(str2, false, new com.bytedance.sdk.openadsdk.yDt.IL() { // from class: com.bytedance.sdk.openadsdk.component.reward.VB.3
    ...
    public void bg(final com.bytedance.sdk.openadsdk.core.model.tuV tuv, final com.bytedance.sdk.openadsdk.common.bg.InterfaceC0128bg<java.lang.Object> interfaceC0128bg) {
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").bg(tuv, interfaceC0128bg);
            return;
        }
        ...
        if (tuv == null || tuv.Dxa() == null || android.text.TextUtils.isEmpty(tuv.Dxa().VB())) {
            ...
            bgVarEqN.bg(new com.bytedance.sdk.component.iR.bg.bg() { // from class: com.bytedance.sdk.openadsdk.component.reward.VB.4
                ...
                public void bg(com.bytedance.sdk.component.iR.IL.bX bXVar, com.bytedance.sdk.component.iR.IL il) {
                    if (il.ldr() && il.zx() != null && il.zx().exists()) {
                        ...
                        com.bytedance.sdk.openadsdk.component.reward.VB.this.bg(true, tuv, il.bg(), il.IL());
                        return;
                    }
                    ...
                    com.bytedance.sdk.openadsdk.component.reward.VB.this.bg(false, tuv, il.bg(), il.IL());
                }
                ...
                public void bg(com.bytedance.sdk.component.iR.IL.bX bXVar, java.io.IOException iOException) {
                    ...
                    com.bytedance.sdk.openadsdk.component.reward.VB.this.bg(false, tuv, -2L, iOException.getMessage());
                }
            });
        }
    }
    ...
    public void bg(java.lang.String str) {
        if (com.bytedance.sdk.openadsdk.common.bg.bg()) {
            com.bytedance.sdk.openadsdk.common.bg.bg("sp_reward_video").IL(str);
        } else {
            this.bX.iR(str);
        }
    }
