...
public class bg extends com.bytedance.sdk.openadsdk.Ta.eo {
    public bg(android.content.Context context) {
        this(context, null);
    }

    public bg(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public bg(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
    ...
    protected void bg(android.content.Context context) {
        ...
        iRVar.setLayoutParams(new android.widget.LinearLayout.LayoutParams(-2, -2));
        ...
        android.widget.LinearLayout.LayoutParams layoutParams7 = new android.widget.LinearLayout.LayoutParams(-1, com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 32.0f));
