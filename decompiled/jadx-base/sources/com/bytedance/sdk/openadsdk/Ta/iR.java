...
public class iR extends com.bytedance.sdk.openadsdk.Ta.eo {
    public iR(android.content.Context context) {
        this(context, null);
    }

    public iR(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    protected void bg(android.content.Context context) {
        ...
        layoutParams3.leftMargin = iBX4;
        layoutParams3.setMarginStart(iBX4);
        ...
        layoutParams4.setMarginStart(iBX2);
        ...
        android.widget.RelativeLayout.LayoutParams layoutParams5 = new android.widget.RelativeLayout.LayoutParams(com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 70.0f), com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 36.0f));
        layoutParams5.addRule(21);
        layoutParams5.addRule(11);
        layoutParams5.addRule(15);
        layoutParams5.rightMargin = iBX4;
        layoutParams5.setMarginEnd(iBX4);
    ...
    protected com.bytedance.sdk.openadsdk.core.zx.Kg IL(android.content.Context context) {
        ...
        kgIL.setGravity(16);
        kgIL.setMaxWidth(com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 150.0f));
        kgIL.setTextColor(android.graphics.Color.parseColor("#B7B7B7"));
        kgIL.setTextSize(2, 15.0f);
