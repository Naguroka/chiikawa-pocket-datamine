...
public class ldr extends com.bytedance.sdk.openadsdk.Ta.eo {
    public ldr(android.content.Context context) {
        this(context, null);
    }

    public ldr(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    protected void bg(android.content.Context context) {
        ...
        int iBX2 = com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 5.0f);
        int iBX3 = com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 6.0f);
        int iBX4 = com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 16.0f);
        ...
        layoutParams2.setMargins(iBX2, iBX2, iBX2, iBX2);
        ...
        int iBX5 = com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 25.0f);
        ...
        layoutParams5.leftMargin = iBX3;
        layoutParams5.setMarginStart(iBX3);
        ...
        layoutParams6.leftMargin = iBX3;
        layoutParams6.setMarginStart(iBX3);
        ...
        int iBX6 = com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 4.0f);
        this.ldr.setPadding(iBX6, iBX6, iBX6, iBX6);
    ...
    protected com.bytedance.sdk.openadsdk.core.zx.Kg IL(android.content.Context context) {
        ...
        kgIL.setGravity(16);
        kgIL.setMaxWidth(com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 53.0f));
        kgIL.setTextColor(-1);
        kgIL.setTextSize(2, 10.0f);
        return kgIL;
    }
    ...
    protected com.bytedance.sdk.openadsdk.core.zx.Kg bX(android.content.Context context) {
        ...
        kgBX.setGravity(16);
        kgBX.setMaxWidth(com.bytedance.sdk.openadsdk.utils.ZQc.bX(context, 53.0f));
        kgBX.setTextColor(-1);
        kgBX.setTextSize(2, 8.0f);
        return kgBX;
    }
}
