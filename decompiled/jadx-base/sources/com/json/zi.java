...
@kotlin.Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001B\u0011\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0004¢\u0006\u0004\b\u0007\u0010\bJ\b\u0010\u0003\u001a\u00020\u0002H\u0016R\u0016\u0010\u0006\u001a\u0004\u0018\u00010\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u0005¨\u0006\t"}, d2 = {"Lcom/ironsource/zi;", "Lcom/ironsource/hv;", "", androidx.media3.exoplayer.upstream.CmcdData.Factory.OBJECT_TYPE_AUDIO_ONLY, "Lcom/ironsource/yl;", "Lcom/ironsource/yl;", "loadTaskConfig", "<init>", "(Lcom/ironsource/yl;)V", "mediationsdk_release"}, k = 1, mv = {1, 8, 0})
public final class zi implements com.json.hv {
    ...
    static final class a extends kotlin.jvm.internal.Lambda implements kotlin.jvm.functions.Function0<com.json.mediationsdk.logger.IronSourceError> {
        ...
        public static final com.ironsource.zi.a f3619a = new com.ironsource.zi.a();
        ...
        public final com.json.mediationsdk.logger.IronSourceError invoke() {
            return com.json.tb.f3430a.b("Load task config is null");
        }
    }

    public zi(com.json.yl ylVar) {
        this.loadTaskConfig = ylVar;
    }

    @Override // com.json.hv
    public void a() {
        a(this.loadTaskConfig != null, com.ironsource.zi.a.f3619a);
    }
}
