...
public final /* data */ class v4 {
    ...
    public v4(java.lang.String name, boolean z) {
    ...
    public static /* synthetic */ com.json.v4 a(com.json.v4 v4Var, java.lang.String str, boolean z, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            str = v4Var.name;
        }
        if ((i & 2) != 0) {
    ...
    public final com.json.v4 a(java.lang.String name, boolean bidder) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(name, "name");
        return new com.json.v4(name, bidder);
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        if (!(other instanceof com.json.v4)) {
            return false;
        }
        com.json.v4 v4Var = (com.json.v4) other;
        return kotlin.jvm.internal.Intrinsics.areEqual(this.name, v4Var.name) && this.bidder == v4Var.bidder;
    }
