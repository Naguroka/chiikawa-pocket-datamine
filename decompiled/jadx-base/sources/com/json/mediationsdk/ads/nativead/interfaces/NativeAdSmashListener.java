...
public interface NativeAdSmashListener {
    ...
    void onNativeAdInitFailed(com.json.mediationsdk.logger.IronSourceError error);

    void onNativeAdInitSuccess();

    void onNativeAdLoadFailed(com.json.mediationsdk.logger.IronSourceError error);

    void onNativeAdLoaded(com.json.mediationsdk.ads.nativead.AdapterNativeAdData adapterNativeAdData, com.json.mediationsdk.adunit.adapter.internal.nativead.AdapterNativeAdViewBinder nativeAdViewBinder);
