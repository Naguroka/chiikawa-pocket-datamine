...
public final class iq implements com.json.zc {
    ...
    private final java.util.Map<java.lang.String, com.json.iq> retainer;

    /* JADX INFO: renamed from: j, reason: from kotlin metadata */
    private com.unity3d.ironsourceads.rewarded.RewardedAdInfo adInfo;

    /* JADX INFO: renamed from: k, reason: from kotlin metadata */
    private com.json.jq listener;

    public iq(com.json.mj adInstance, com.json.x0 adNetworkShow, com.json.u4 auctionDataReporter, com.json.n3 analytics, com.json.in networkDestroyAPI, com.json.qu threadManager, com.json.vh sessionDepthService, com.ironsource.vh.a sessionDepthServiceEditor, java.util.Map<java.lang.String, com.json.iq> retainer) {
        ...
        this.adInfo = new com.unity3d.ironsourceads.rewarded.RewardedAdInfo(strF, strE);
        com.json.xc xcVar = new com.json.xc();
        this.adInstance.a(xcVar);
        xcVar.a(this);
    }

    public /* synthetic */ iq(com.json.mj mjVar, com.json.x0 x0Var, com.json.u4 u4Var, com.json.n3 n3Var, com.json.in inVar, com.json.qu quVar, com.json.vh vhVar, com.ironsource.vh.a aVar, java.util.Map map, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final void a(com.json.iq this$0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(com.json.iq this$0, com.json.mediationsdk.logger.IronSourceError error) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(error, "$error");
        com.json.jq jqVar = this$0.listener;
        if (jqVar != null) {
    ...
    private final void a(final com.json.mediationsdk.logger.IronSourceError error) {
        ...
        this.threadManager.a(new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.a(this.f$0, error);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(com.json.iq this$0) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.json.jq jqVar = this$0.listener;
        if (jqVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void c(com.json.iq this$0) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.json.jq jqVar = this$0.listener;
        if (jqVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void d(com.json.iq this$0) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.json.jq jqVar = this$0.listener;
        if (jqVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void e(com.json.iq this$0) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.json.jq jqVar = this$0.listener;
        if (jqVar != null) {
    ...
    public final void a() {
        com.json.qu.a(this.threadManager, new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.a(this.f$0);
            }
        }, 0L, 2, null);
    }
    ...
    public final void a(com.json.jq jqVar) {
        this.listener = jqVar;
    }
    ...
    public final com.json.jq getListener() {
    ...
    public void onAdInstanceDidClick() {
        ...
        this.threadManager.a(new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.b(this.f$0);
            }
        });
    }
    ...
    public void onAdInstanceDidDismiss() {
        ...
        this.threadManager.a(new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.c(this.f$0);
            }
        });
    }
    ...
    public void onAdInstanceDidReward(java.lang.String demandSourceId, int amount) {
        com.ironsource.j3.u uVar = new com.ironsource.j3.u("Virtual Item");
        com.ironsource.j3.t tVar = new com.ironsource.j3.t(1);
        com.ironsource.j3.q qVar = new com.ironsource.j3.q("DefaultRewardedVideo");
        java.lang.String transId = com.json.mediationsdk.utils.IronSourceUtils.getTransId(java.lang.System.currentTimeMillis(), this.adInstance.g());
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(transId, "getTransId(System.curren…illis(), adInstance.name)");
        com.ironsource.g3.a.INSTANCE.c(uVar, tVar, qVar, new com.ironsource.j3.y(transId)).a(this.analytics);
        this.threadManager.a(new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.d(this.f$0);
            }
        });
    }
    ...
    public void onAdInstanceDidShow() {
        ...
        this.threadManager.a(new java.lang.Runnable() { // from class: com.ironsource.iq$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                com.json.iq.e(this.f$0);
            }
        });
    }
}
