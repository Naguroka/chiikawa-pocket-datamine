...
public final class WebSocketProtocol {
    ...
    public final void validateCloseCode(int code) {
        java.lang.String strCloseCodeExceptionMessage = closeCodeExceptionMessage(code);
        if (strCloseCodeExceptionMessage == null) {
            return;
        }
        kotlin.jvm.internal.Intrinsics.checkNotNull(strCloseCodeExceptionMessage);
        throw new java.lang.IllegalArgumentException(strCloseCodeExceptionMessage.toString());
    }

    public final java.lang.String acceptHeader(java.lang.String key) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(key, "key");
        return okio.ByteString.INSTANCE.encodeUtf8(key + ACCEPT_MAGIC).sha1().base64();
    }
}
