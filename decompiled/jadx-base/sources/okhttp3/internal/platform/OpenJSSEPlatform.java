...
public final class OpenJSSEPlatform extends okhttp3.internal.platform.Platform {
    ...
    public /* synthetic */ OpenJSSEPlatform(kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
    ...
    public javax.net.ssl.SSLContext newSSLContext() throws java.security.NoSuchAlgorithmException {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sSLContext, "getInstance(\"TLSv1.3\", provider)");
        return sSLContext;
    }
    ...
    public void configureTlsExtensions(javax.net.ssl.SSLSocket sslSocket, java.lang.String hostname, java.util.List<okhttp3.Protocol> protocols) {
        ...
        if (sslSocket instanceof org.openjsse.javax.net.ssl.SSLSocket) {
            ...
            org.openjsse.javax.net.ssl.SSLParameters sSLParameters = sSLSocket.getSSLParameters();
    ...
    public java.lang.String getSelectedProtocol(javax.net.ssl.SSLSocket sslSocket) {
        ...
        if (sslSocket instanceof org.openjsse.javax.net.ssl.SSLSocket) {
            ...
            if (applicationProtocol == null ? true : kotlin.jvm.internal.Intrinsics.areEqual(applicationProtocol, "")) {
                return null;
            }
    ...
    /* JADX INFO: compiled from: OpenJSSEPlatform.kt */
    @kotlin.Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0003\u0010\u0005¨\u0006\b"}, d2 = {"Lokhttp3/internal/platform/OpenJSSEPlatform$Companion;", "", "()V", "isSupported", "", "()Z", "buildIfSupported", "Lokhttp3/internal/platform/OpenJSSEPlatform;", com.unity3d.services.core.network.core.OkHttp3Client.NETWORK_CLIENT_OKHTTP}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        public final okhttp3.internal.platform.OpenJSSEPlatform buildIfSupported() {
            ...
            if (isSupported()) {
                return new okhttp3.internal.platform.OpenJSSEPlatform(defaultConstructorMarker);
            }
            return null;
        }
    }
