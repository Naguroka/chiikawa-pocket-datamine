...
class NumbersKt__FloorDivModKt extends kotlin.NumbersKt__BigIntegersKt {
    ...
    private static final float mod(float f, float f2) {
        ...
        return !(java.lang.Math.signum(f3) == java.lang.Math.signum(f2)) ? f3 + f2 : f3;
    }
    ...
    private static final double mod(float f, double d) {
        ...
        return !(java.lang.Math.signum(d2) == java.lang.Math.signum(d)) ? d2 + d : d2;
    }
    ...
    private static final double mod(double d, float f) {
        ...
        return !(java.lang.Math.signum(d3) == java.lang.Math.signum(d2)) ? d3 + d2 : d3;
    }
