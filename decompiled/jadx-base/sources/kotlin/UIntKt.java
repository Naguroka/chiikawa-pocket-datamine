...
public final class UIntKt {
    private static final int toUInt(byte b) {
        return kotlin.UInt.m1397constructorimpl(b);
    }

    private static final int toUInt(short s) {
        return kotlin.UInt.m1397constructorimpl(s);
    }

    private static final int toUInt(int i) {
        return kotlin.UInt.m1397constructorimpl(i);
    }
    ...
    private static final int toUInt(float f) {
        return kotlin.UnsignedKt.doubleToUInt(f);
    }

    private static final int toUInt(double d) {
        return kotlin.UnsignedKt.doubleToUInt(d);
    }
}
