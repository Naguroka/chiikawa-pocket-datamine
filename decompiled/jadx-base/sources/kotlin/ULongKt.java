...
public final class ULongKt {
    private static final long toULong(byte b) {
        return kotlin.ULong.m1476constructorimpl(b);
    }

    private static final long toULong(short s) {
        return kotlin.ULong.m1476constructorimpl(s);
    }

    private static final long toULong(int i) {
        return kotlin.ULong.m1476constructorimpl(i);
    }

    private static final long toULong(long j) {
        return kotlin.ULong.m1476constructorimpl(j);
    }

    private static final long toULong(float f) {
        return kotlin.UnsignedKt.doubleToULong(f);
    }

    private static final long toULong(double d) {
        return kotlin.UnsignedKt.doubleToULong(d);
    }
}
