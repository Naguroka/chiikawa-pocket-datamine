...
class StandardKt__StandardKt {
    ...
    private static final <T, R> R run(T t, kotlin.jvm.functions.Function1<? super T, ? extends R> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        return block.invoke(t);
    }

    private static final <T, R> R with(T t, kotlin.jvm.functions.Function1<? super T, ? extends R> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        return block.invoke(t);
    }

    private static final <T> T apply(T t, kotlin.jvm.functions.Function1<? super T, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        block.invoke(t);
        return t;
    }

    private static final <T> T also(T t, kotlin.jvm.functions.Function1<? super T, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        block.invoke(t);
        return t;
    }

    private static final <T, R> R let(T t, kotlin.jvm.functions.Function1<? super T, ? extends R> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        return block.invoke(t);
    }

    private static final <T> T takeIf(T t, kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> predicate) {
    ...
    private static final <T> T takeUnless(T t, kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> predicate) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(predicate, "predicate");
        if (predicate.invoke(t).booleanValue()) {
            return null;
        }
    ...
    private static final void repeat(int i, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        for (int i2 = 0; i2 < i; i2++) {
            action.invoke(java.lang.Integer.valueOf(i2));
        }
    }
}
