...
public class CollectionsKt__CollectionsJVMKt {
    public static final <T> java.util.List<T> listOf(T t) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(listSingletonList, "singletonList(...)");
