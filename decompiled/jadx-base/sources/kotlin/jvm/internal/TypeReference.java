...
public final class TypeReference implements kotlin.reflect.KType {
    ...
    private final java.lang.String asString(boolean convertPrimitiveToWrapper) {
        ...
        java.lang.String str = name + (getArguments().isEmpty() ? "" : kotlin.collections.CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new kotlin.jvm.functions.Function1<kotlin.reflect.KTypeProjection, java.lang.CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        return kotlin.jvm.internal.Intrinsics.areEqual(strAsString, new java.lang.StringBuilder().append(str).append('?').toString()) ? str + '!' : "(" + str + ".." + strAsString + ')';
    }
    ...
    public final java.lang.String asString(kotlin.reflect.KTypeProjection kTypeProjection) {
        ...
        if (kTypeProjection.getVariance() == null) {
            return androidx.webkit.ProxyConfig.MATCH_ALL_SCHEMES;
        }
