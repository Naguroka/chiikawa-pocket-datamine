...
public final class DropWhileSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1(kotlin.sequences.DropWhileSequence<T> dropWhileSequence) {
            this.this$0 = dropWhileSequence;
            this.iterator = ((kotlin.sequences.DropWhileSequence) dropWhileSequence).sequence.iterator();
        }
        ...
        private final void drop() {
            while (this.iterator.hasNext()) {
                ...
                if (!((java.lang.Boolean) ((kotlin.sequences.DropWhileSequence) this.this$0).predicate.invoke(next)).booleanValue()) {
                    this.nextItem = next;
                    this.dropState = 1;
                    return;
                }
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.DropWhileSequence.AnonymousClass1(this);
    }
}
