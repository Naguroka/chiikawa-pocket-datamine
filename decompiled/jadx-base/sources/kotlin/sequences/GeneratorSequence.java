...
final class GeneratorSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1(kotlin.sequences.GeneratorSequence<T> generatorSequence) {
        ...
        private final void calcNext() {
            T t;
            if (this.nextState == -2) {
                t = (T) ((kotlin.sequences.GeneratorSequence) this.this$0).getInitialValue.invoke();
            } else {
                kotlin.jvm.functions.Function1 function1 = ((kotlin.sequences.GeneratorSequence) this.this$0).getNextValue;
                T t2 = this.nextItem;
    ...
    public java.util.Iterator<T> iterator() {
        return new kotlin.sequences.GeneratorSequence.AnonymousClass1(this);
    }
}
