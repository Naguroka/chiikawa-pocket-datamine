...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ kotlin.time.TimedValue m2786copyRFiDyg4$default(kotlin.time.TimedValue timedValue, java.lang.Object obj, long j, int i, java.lang.Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2788copyRFiDyg4(obj, j);
    }
    ...
    public final kotlin.time.TimedValue<T> m2788copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return kotlin.jvm.internal.Intrinsics.areEqual(this.value, timedValue.value) && kotlin.time.Duration.m2633equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + kotlin.time.Duration.m2656hashCodeimpl(this.duration);
    }

    public java.lang.String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((java.lang.Object) kotlin.time.Duration.m2677toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m2789getDurationUwyO8pc() {
        return this.duration;
    }
