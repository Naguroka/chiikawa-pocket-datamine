...
public final class DurationKt {
    ...
    public static final long toDuration(long j, kotlin.time.DurationUnit unit) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(unit, "unit");
        long jConvertDurationUnitOverflow = kotlin.time.DurationUnitKt.convertDurationUnitOverflow(MAX_NANOS, kotlin.time.DurationUnit.NANOSECONDS, unit);
        if (new kotlin.ranges.LongRange(-jConvertDurationUnitOverflow, jConvertDurationUnitOverflow).contains(j)) {
    ...
    public static final long toDuration(double d, kotlin.time.DurationUnit unit) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(unit, "unit");
        double dConvertDurationUnit = kotlin.time.DurationUnitKt.convertDurationUnit(d, unit, kotlin.time.DurationUnit.NANOSECONDS);
        ...
        long jRoundToLong = kotlin.math.MathKt.roundToLong(dConvertDurationUnit);
        if (new kotlin.ranges.LongRange(-4611686018426999999L, MAX_NANOS).contains(jRoundToLong)) {
    ...
    private static final long m2755timesmvk6XK0(int i, long j) {
        return kotlin.time.Duration.m2666timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2754timeskIfJnKk(double d, long j) {
        return kotlin.time.Duration.m2665timesUwyO8pc(j, d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:171:0x00a9 A[EDGE_INSN: B:171:0x00a9->B:49:0x00a9 BREAK  A[LOOP:1: B:36:0x006d->B:47:0x009b], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:47:0x009b A[LOOP:1: B:36:0x006d->B:47:0x009b, LOOP_END] */
    public static final long parseDuration(java.lang.String str, boolean z) {
        ...
        long jM2731getZEROUwyO8pc = kotlin.time.Duration.INSTANCE.m2731getZEROUwyO8pc();
        char cCharAt = str2.charAt(0);
        boolean z5 = true;
        int length2 = (cCharAt == '+' || cCharAt == '-') ? 1 : 0;
        boolean z6 = length2 > 0;
        boolean z7 = z6 && kotlin.text.StringsKt.startsWith$default((java.lang.CharSequence) str2, org.objectweb.asm.signature.SignatureVisitor.SUPER, false, 2, (java.lang.Object) null);
        if (length <= length2) {
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str2.charAt(i) != 'T') {
                    ...
                    while (true) {
                        ...
                        if (!new kotlin.ranges.CharRange(c2, c).contains(cCharAt2)) {
                            z3 = z7;
                            if (!kotlin.text.StringsKt.contains$default((java.lang.CharSequence) "+-.", cCharAt2, false, 2, (java.lang.Object) null)) {
                                z4 = false;
                            }
                            if (z4) {
                                break;
                    ...
                    java.lang.String strSubstring = str2.substring(i, i2);
                    ...
                    if (length3 < 0 || length3 > kotlin.text.StringsKt.getLastIndex(str4)) {
                        throw new java.lang.IllegalArgumentException("Missing unit for value " + strSubstring);
                    }
                    char cCharAt3 = str4.charAt(length3);
                    i = length3 + 1;
                    kotlin.time.DurationUnit durationUnitDurationUnitByIsoChar = kotlin.time.DurationUnitKt.durationUnitByIsoChar(cCharAt3, z8);
                    ...
                    int iIndexOf$default = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) str3, '.', 0, false, 6, (java.lang.Object) null);
                    if (durationUnitDurationUnitByIsoChar == kotlin.time.DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2664plusLRDsOJo = kotlin.time.Duration.m2664plusLRDsOJo(jM2731getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        kotlin.jvm.internal.Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        java.lang.String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2731getZEROUwyO8pc = kotlin.time.Duration.m2664plusLRDsOJo(jM2664plusLRDsOJo, toDuration(java.lang.Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2731getZEROUwyO8pc = kotlin.time.Duration.m2664plusLRDsOJo(jM2731getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z8 = z8;
            ...
            if (kotlin.text.StringsKt.regionMatches(str, length2, "Infinity", 0, java.lang.Math.max(length - length2, 8), true)) {
                jM2731getZEROUwyO8pc = kotlin.time.Duration.INSTANCE.m2729getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                if (z6 && str2.charAt(length2) == '(' && kotlin.text.StringsKt.last(str2) == ')') {
                    length2++;
                    length--;
                    if (length2 == length) {
                        throw new java.lang.IllegalArgumentException("No components");
                ...
                while (length2 < length) {
                    ...
                    int i3 = length2;
                    while (i3 < str.length()) {
                        char cCharAt4 = str2.charAt(i3);
                        if (!(new kotlin.ranges.CharRange('0', '9').contains(cCharAt4) || cCharAt4 == '.')) {
                            break;
                        }
                        i3++;
                    }
                    kotlin.jvm.internal.Intrinsics.checkNotNull(str2, "null cannot be cast to non-null type java.lang.String");
                    java.lang.String strSubstring4 = str2.substring(length2, i3);
                    kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strSubstring4, "substring(...)");
                    java.lang.String str6 = strSubstring4;
                    if (str6.length() == 0) {
                        throw new java.lang.IllegalArgumentException();
                    }
                    ...
                    int i4 = length4;
                    while (i4 < str.length()) {
                        if (!new kotlin.ranges.CharRange('a', 'z').contains(str2.charAt(i4))) {
                            break;
                        }
                        i4++;
                    }
                    kotlin.jvm.internal.Intrinsics.checkNotNull(str2, "null cannot be cast to non-null type java.lang.String");
                    java.lang.String strSubstring5 = str2.substring(length4, i4);
                    kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strSubstring5, "substring(...)");
                    length2 = length4 + strSubstring5.length();
                    kotlin.time.DurationUnit durationUnitDurationUnitByShortName = kotlin.time.DurationUnitKt.durationUnitByShortName(strSubstring5);
                    ...
                    int iIndexOf$default2 = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) str6, '.', 0, false, 6, (java.lang.Object) null);
                    if (iIndexOf$default2 > 0) {
                        kotlin.jvm.internal.Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        java.lang.String strSubstring6 = strSubstring4.substring(0, iIndexOf$default2);
                        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strSubstring6, "substring(...)");
                        long jM2664plusLRDsOJo2 = kotlin.time.Duration.m2664plusLRDsOJo(jM2731getZEROUwyO8pc, toDuration(java.lang.Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        kotlin.jvm.internal.Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        java.lang.String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strSubstring7, "substring(...)");
                        jM2731getZEROUwyO8pc = kotlin.time.Duration.m2664plusLRDsOJo(jM2664plusLRDsOJo2, toDuration(java.lang.Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new java.lang.IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2731getZEROUwyO8pc = kotlin.time.Duration.m2664plusLRDsOJo(jM2731getZEROUwyO8pc, toDuration(java.lang.Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? kotlin.time.Duration.m2681unaryMinusUwyO8pc(jM2731getZEROUwyO8pc) : jM2731getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return kotlin.time.Duration.m2628constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return kotlin.time.Duration.m2628constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return kotlin.time.Duration.m2628constructorimpl((j << 1) + ((long) i));
    }
