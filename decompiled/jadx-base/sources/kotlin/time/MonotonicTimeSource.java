...
public final class MonotonicTimeSource implements kotlin.time.TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ kotlin.time.ComparableTimeMark markNow() {
        return kotlin.time.TimeSource.Monotonic.ValueTimeMark.m2768boximpl(m2762markNowz9LOYto());
    }
    ...
    public long m2762markNowz9LOYto() {
        return kotlin.time.TimeSource.Monotonic.ValueTimeMark.m2771constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2761elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2760differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m2759adjustReading6QKq23U(long timeMark, long duration) {
        return kotlin.time.TimeSource.Monotonic.ValueTimeMark.m2771constructorimpl(kotlin.time.LongSaturatedMathKt.m2757saturatingAddNuflL3o(timeMark, kotlin.time.DurationUnit.NANOSECONDS, duration));
    }
}
