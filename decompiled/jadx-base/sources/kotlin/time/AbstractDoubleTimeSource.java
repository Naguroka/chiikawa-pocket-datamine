...
public abstract class AbstractDoubleTimeSource implements kotlin.time.TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements kotlin.time.ComparableTimeMark {
        ...
        public long mo2618elapsedNowUwyO8pc() {
            return kotlin.time.Duration.m2663minusLRDsOJo(kotlin.time.DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public kotlin.time.ComparableTimeMark mo2621plusLRDsOJo(long duration) {
            return new kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark(this.startedAt, this.timeSource, kotlin.time.Duration.m2664plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo2620minusUwyO8pc(kotlin.time.ComparableTimeMark other) {
            ...
            if (other instanceof kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark) {
                ...
                if (kotlin.jvm.internal.Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (kotlin.time.Duration.m2633equalsimpl0(this.offset, doubleTimeMark.offset) && kotlin.time.Duration.m2660isInfiniteimpl(this.offset)) {
                        return kotlin.time.Duration.INSTANCE.m2731getZEROUwyO8pc();
                    }
                    long jM2663minusLRDsOJo = kotlin.time.Duration.m2663minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = kotlin.time.DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return kotlin.time.Duration.m2633equalsimpl0(duration, kotlin.time.Duration.m2681unaryMinusUwyO8pc(jM2663minusLRDsOJo)) ? kotlin.time.Duration.INSTANCE.m2731getZEROUwyO8pc() : kotlin.time.Duration.m2664plusLRDsOJo(duration, jM2663minusLRDsOJo);
                }
            }
        ...
        public boolean equals(java.lang.Object other) {
            return (other instanceof kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark) && kotlin.jvm.internal.Intrinsics.areEqual(this.timeSource, ((kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark) other).timeSource) && kotlin.time.Duration.m2633equalsimpl0(mo2620minusUwyO8pc((kotlin.time.ComparableTimeMark) other), kotlin.time.Duration.INSTANCE.m2731getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return kotlin.time.Duration.m2656hashCodeimpl(kotlin.time.Duration.m2664plusLRDsOJo(kotlin.time.DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public java.lang.String toString() {
            return "DoubleTimeMark(" + this.startedAt + kotlin.time.DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((java.lang.Object) kotlin.time.Duration.m2677toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public kotlin.time.ComparableTimeMark markNow() {
        return new kotlin.time.AbstractDoubleTimeSource.DoubleTimeMark(read(), this, kotlin.time.Duration.INSTANCE.m2731getZEROUwyO8pc(), null);
    }
}
