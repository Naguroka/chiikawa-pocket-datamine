...
final class UIntProgressionIterator implements java.util.Iterator<kotlin.UInt>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        boolean z = true;
        if (i3 <= 0 ? java.lang.Integer.compare(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) < 0 : java.lang.Integer.compare(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = kotlin.UInt.m1397constructorimpl(i3);
        this.next = this.hasNext ? i : i2;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ kotlin.UInt next() {
        return kotlin.UInt.m1391boximpl(m2529nextpVg5ArA());
    }
    ...
    public int m2529nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = kotlin.UInt.m1397constructorimpl(this.step + i);
        }
        return i;
    }
}
