...
public class UIntProgression implements java.lang.Iterable<kotlin.UInt>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = kotlin.internal.UProgressionUtilKt.m2512getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public boolean isEmpty() {
        if (this.step > 0) {
            if (java.lang.Integer.compare(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) > 0) {
                return true;
            }
        } else if (java.lang.Integer.compare(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) < 0) {
            return true;
        }
        return false;
    }
    ...
    public java.lang.String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new java.lang.StringBuilder().append((java.lang.Object) kotlin.UInt.m1443toStringimpl(this.first)).append("..").append((java.lang.Object) kotlin.UInt.m1443toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new java.lang.StringBuilder().append((java.lang.Object) kotlin.UInt.m1443toStringimpl(this.first)).append(" downTo ").append((java.lang.Object) kotlin.UInt.m1443toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final kotlin.ranges.UIntProgression m2528fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
