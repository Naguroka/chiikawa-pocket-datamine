...
final class ULongProgressionIterator implements java.util.Iterator<kotlin.ULong>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        boolean z = true;
        if (j3 <= 0 ? java.lang.Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 : java.lang.Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = kotlin.ULong.m1476constructorimpl(j3);
        this.next = this.hasNext ? j : j2;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ kotlin.ULong next() {
        return kotlin.ULong.m1470boximpl(m2538nextsVKNKU());
    }
    ...
    public long m2538nextsVKNKU() {
        ...
        if (j == this.finalElement) {
            ...
            this.next = kotlin.ULong.m1476constructorimpl(this.step + j);
        }
        return j;
    }
}
