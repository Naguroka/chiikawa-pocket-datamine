...
public final /* data */ class KTypeProjection {
    ...
    public KTypeProjection(kotlin.reflect.KVariance kVariance, kotlin.reflect.KType kType) {
        ...
        if ((kVariance == null) == (kType == null)) {
            ...
            throw new java.lang.IllegalArgumentException((kVariance == null ? "Star projection must have no type specified." : "The projection variance " + kVariance + " requires type to be specified.").toString());
        }
    }
