...
public enum CharCategory {
    ...
    public static final kotlin.text.CharCategory.Companion INSTANCE = new kotlin.text.CharCategory.Companion(null);

    public static kotlin.enums.EnumEntries<kotlin.text.CharCategory> getEntries() {
        return $ENTRIES;
    }

    CharCategory(int i, java.lang.String str) {
        this.value = i;
        this.code = str;
    }
    ...
    public final boolean contains(char c) {
        return java.lang.Character.getType(c) == this.value;
    }
    ...
    public static final class Companion {
        ...
        public final kotlin.text.CharCategory valueOf(int category) {
            if (new kotlin.ranges.IntRange(0, 16).contains(category)) {
                return kotlin.text.CharCategory.getEntries().get(category);
            }
            if (new kotlin.ranges.IntRange(18, 30).contains(category)) {
                return kotlin.text.CharCategory.getEntries().get(category - 1);
            }
