...
final class ExceptionsCollector {
    ...
    public final void collect(java.lang.Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                java.lang.Throwable thInitCause = new java.nio.file.FileSystemException(java.lang.String.valueOf(this.path)).initCause(exception);
                kotlin.jvm.internal.Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = (java.nio.file.FileSystemException) thInitCause;
            }
