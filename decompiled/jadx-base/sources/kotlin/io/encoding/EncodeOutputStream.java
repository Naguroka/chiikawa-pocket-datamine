...
final class EncodeOutputStream extends java.io.OutputStream {
    ...
    public void write(byte[] source, int offset, int length) throws java.io.IOException {
        ...
        while (offset + 3 <= i) {
            int iMin = java.lang.Math.min((this.base64.getIsMimeScheme() ? this.lineLength : this.symbolBuffer.length) / 4, (i - offset) / 3);
    ...
    private final int copyIntoByteBuffer(byte[] source, int startIndex, int endIndex) {
        int iMin = java.lang.Math.min(3 - this.byteBufferLength, endIndex - startIndex);
        kotlin.collections.ArraysKt.copyInto(source, this.byteBuffer, this.byteBufferLength, startIndex, startIndex + iMin);
