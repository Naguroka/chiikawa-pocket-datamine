...
public final class InflaterSource implements okio.Source {
    ...
    public final long readOrInflate(okio.Buffer sink, long byteCount) throws java.io.IOException {
        ...
        try {
            ...
            int iMin = (int) java.lang.Math.min(byteCount, 8192 - segmentWritableSegment$okio.limit);
            refill();
    ...
    private final void releaseBytesAfterInflate() throws java.io.IOException {
