...
public final class PlaybackStateCompat implements android.os.Parcelable {
    ...
    public static android.support.v4.media.session.PlaybackStateCompat fromPlaybackState(java.lang.Object obj) {
        ...
        if (customActions != null) {
            ...
            while (it.hasNext()) {
                arrayList.add(android.support.v4.media.session.PlaybackStateCompat.CustomAction.fromCustomAction(it.next()));
            }
        }
        android.os.Bundle extras = android.support.v4.media.session.PlaybackStateCompat.Api22Impl.getExtras(playbackState);
    ...
    public java.lang.Object getPlaybackState() {
        if (this.mStateFwk == null) {
            android.media.session.PlaybackState.Builder builderCreateBuilder = android.support.v4.media.session.PlaybackStateCompat.Api21Impl.createBuilder();
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setState(builderCreateBuilder, this.mState, this.mPosition, this.mSpeed, this.mUpdateTime);
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setBufferedPosition(builderCreateBuilder, this.mBufferedPosition);
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setActions(builderCreateBuilder, this.mActions);
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setErrorMessage(builderCreateBuilder, this.mErrorMessage);
            java.util.Iterator<android.support.v4.media.session.PlaybackStateCompat.CustomAction> it = this.mCustomActions.iterator();
            while (it.hasNext()) {
                android.support.v4.media.session.PlaybackStateCompat.Api21Impl.addCustomAction(builderCreateBuilder, (android.media.session.PlaybackState.CustomAction) it.next().getCustomAction());
            }
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setActiveQueueItemId(builderCreateBuilder, this.mActiveItemId);
            android.support.v4.media.session.PlaybackStateCompat.Api22Impl.setExtras(builderCreateBuilder, this.mExtras);
            this.mStateFwk = android.support.v4.media.session.PlaybackStateCompat.Api21Impl.build(builderCreateBuilder);
        }
    ...
    public static final class CustomAction implements android.os.Parcelable {
        ...
        public java.lang.Object getCustomAction() {
            ...
            android.media.session.PlaybackState.CustomAction.Builder builderCreateCustomActionBuilder = android.support.v4.media.session.PlaybackStateCompat.Api21Impl.createCustomActionBuilder(this.mAction, this.mName, this.mIcon);
            android.support.v4.media.session.PlaybackStateCompat.Api21Impl.setExtras(builderCreateCustomActionBuilder, this.mExtras);
            return android.support.v4.media.session.PlaybackStateCompat.Api21Impl.build(builderCreateCustomActionBuilder);
        }
