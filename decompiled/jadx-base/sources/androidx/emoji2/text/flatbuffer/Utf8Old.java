...
public class Utf8Old extends androidx.emoji2.text.flatbuffer.Utf8 {
    ...
    static {
        final java.util.function.Supplier supplier = new java.util.function.Supplier() { // from class: androidx.emoji2.text.flatbuffer.Utf8Old$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final java.lang.Object get() {
                return androidx.emoji2.text.flatbuffer.Utf8Old.lambda$static$0();
            }
        };
        CACHE = new java.lang.ThreadLocal() { // from class: androidx.emoji2.text.flatbuffer.Utf8Old$$ExternalSyntheticThreadLocal1
