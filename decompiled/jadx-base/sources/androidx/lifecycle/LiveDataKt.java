...
public final class LiveDataKt {
    ...
    public static final <T> androidx.lifecycle.Observer<T> observe(androidx.lifecycle.LiveData<T> liveData, androidx.lifecycle.LifecycleOwner lifecycleOwner, final kotlin.jvm.functions.Function1<? super T, kotlin.Unit> function1) {
        androidx.lifecycle.Observer<T> observer = new androidx.lifecycle.Observer() { // from class: androidx.lifecycle.LiveDataKt$observe$wrappedObserver$1
