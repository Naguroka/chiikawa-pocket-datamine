...
public final class ViewModelLazy<VM extends androidx.lifecycle.ViewModel> implements kotlin.Lazy<VM> {
    ...
    public /* synthetic */ ViewModelLazy(kotlin.reflect.KClass kClass, kotlin.jvm.functions.Function0 function0, kotlin.jvm.functions.Function0 function1, androidx.lifecycle.ViewModelLazy.AnonymousClass1 anonymousClass1, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this(kClass, function0, function1, (i & 8) != 0 ? new kotlin.jvm.functions.Function0<androidx.lifecycle.viewmodel.CreationExtras.Empty>() { // from class: androidx.lifecycle.ViewModelLazy.1
