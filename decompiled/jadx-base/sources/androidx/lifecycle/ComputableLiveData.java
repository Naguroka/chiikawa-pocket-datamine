...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData(java.util.concurrent.Executor executor) {
        ...
        androidx.lifecycle.LiveData<T> liveData = new androidx.lifecycle.LiveData<T>(this) { // from class: androidx.lifecycle.ComputableLiveData$_liveData$1
            final /* synthetic */ androidx.lifecycle.ComputableLiveData<T> this$0;
        ...
        this.refreshRunnable = new java.lang.Runnable() { // from class: androidx.lifecycle.ComputableLiveData$$ExternalSyntheticLambda0
            ...
            public final void run() {
                androidx.lifecycle.ComputableLiveData.refreshRunnable$lambda$0(this.f$0);
            }
        };
        this.invalidationRunnable = new java.lang.Runnable() { // from class: androidx.lifecycle.ComputableLiveData$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                androidx.lifecycle.ComputableLiveData.invalidationRunnable$lambda$1(this.f$0);
            }
        };
    }
    ...
    public /* synthetic */ ComputableLiveData(java.util.concurrent.Executor executor, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(executor, "getIOThreadExecutor()");
        }
        this(executor);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final void refreshRunnable$lambda$0(androidx.lifecycle.ComputableLiveData this$0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void invalidationRunnable$lambda$1(androidx.lifecycle.ComputableLiveData this$0) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(this$0, "this$0");
