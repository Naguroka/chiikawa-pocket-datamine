...
public final class GravityCompat {
    ...
    static class Api17Impl {
        ...
        static void apply(int i, int i2, int i3, android.graphics.Rect rect, android.graphics.Rect rect2, int i4) {
            android.view.Gravity.apply(i, i2, i3, rect, rect2, i4);
        }

        static void apply(int i, int i2, int i3, android.graphics.Rect rect, int i4, int i5, android.graphics.Rect rect2, int i6) {
            android.view.Gravity.apply(i, i2, i3, rect, i4, i5, rect2, i6);
        }

        static void applyDisplay(int i, android.graphics.Rect rect, android.graphics.Rect rect2, int i2) {
