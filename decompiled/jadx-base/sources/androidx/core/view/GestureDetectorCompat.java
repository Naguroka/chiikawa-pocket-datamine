        ...
        public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
            ...
            if (i == 0) {
                if (this.mDoubleTapListener == null) {
                    ...
                    android.view.MotionEvent motionEvent3 = this.mCurrentDownEvent;
                ...
                if (this.mIsLongpressEnabled) {
                    ...
                    this.mHandler.sendEmptyMessageAtTime(2, this.mCurrentDownEvent.getDownTime() + ((long) TAP_TIMEOUT) + ((long) android.view.ViewConfiguration.getLongPressTimeout()));
                }
            ...
            if (i != 1) {
                ...
                if (this.mIsDoubleTapping) {
                    ...
                    if (this.mInLongPress) {
                        ...
                        if (java.lang.Math.abs(yVelocity2) > this.mMinimumFlingVelocity || java.lang.Math.abs(xVelocity2) > this.mMinimumFlingVelocity) {
