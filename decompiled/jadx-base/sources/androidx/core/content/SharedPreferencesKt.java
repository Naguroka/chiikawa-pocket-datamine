...
public final class SharedPreferencesKt {
    public static /* synthetic */ void edit$default(android.content.SharedPreferences sharedPreferences, boolean z, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            z = false;
        }
    ...
    public static final void edit(android.content.SharedPreferences sharedPreferences, boolean z, kotlin.jvm.functions.Function1<? super android.content.SharedPreferences.Editor, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sharedPreferences, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        android.content.SharedPreferences.Editor editor = sharedPreferences.edit();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(editor, "editor");
