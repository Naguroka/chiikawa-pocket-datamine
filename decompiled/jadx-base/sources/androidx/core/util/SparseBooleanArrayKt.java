...
public final class SparseBooleanArrayKt {
    ...
    public static final boolean getOrElse(android.util.SparseBooleanArray sparseBooleanArray, int i, kotlin.jvm.functions.Function0<java.lang.Boolean> defaultValue) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
    ...
    public static final void forEach(android.util.SparseBooleanArray sparseBooleanArray, kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Boolean, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        int size = sparseBooleanArray.size();
        for (int i = 0; i < size; i++) {
            action.invoke(java.lang.Integer.valueOf(sparseBooleanArray.keyAt(i)), java.lang.Boolean.valueOf(sparseBooleanArray.valueAt(i)));
        }
    }
