...
public final class SparseLongArrayKt {
    ...
    public static final long getOrElse(android.util.SparseLongArray sparseLongArray, int i, kotlin.jvm.functions.Function0<java.lang.Long> defaultValue) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
    ...
    public static final void forEach(android.util.SparseLongArray sparseLongArray, kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Long, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        int size = sparseLongArray.size();
        for (int i = 0; i < size; i++) {
            action.invoke(java.lang.Integer.valueOf(sparseLongArray.keyAt(i)), java.lang.Long.valueOf(sparseLongArray.valueAt(i)));
        }
    }
