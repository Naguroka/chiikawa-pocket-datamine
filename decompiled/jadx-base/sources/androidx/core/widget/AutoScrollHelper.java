...
public abstract class AutoScrollHelper implements android.view.View.OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (j3 < 0 || j < j3) {
                return androidx.core.widget.AutoScrollHelper.constrain((j - j2) / this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
            }
            float f = this.mStopValue;
            return (1.0f - f) + (f * androidx.core.widget.AutoScrollHelper.constrain((j - j3) / this.mEffectiveRampDown, 0.0f, 1.0f));
        }
