...
public class Flow extends androidx.constraintlayout.widget.VirtualLayout {
    ...
    public Flow(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }

    public Flow(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
