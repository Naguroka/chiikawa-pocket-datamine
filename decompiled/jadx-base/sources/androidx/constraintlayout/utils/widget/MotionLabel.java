...
public class MotionLabel extends android.view.View implements androidx.constraintlayout.motion.widget.FloatLayout {
    ...
    public MotionLabel(android.content.Context context) {
        super(context);
        ...
        this.mTextPanX = 0.0f;
        this.mTextPanY = 0.0f;
        this.paintCache = new android.graphics.Paint();
    ...
    public MotionLabel(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        this.mPaint = new android.text.TextPaint();
        this.mPath = new android.graphics.Path();
        this.mTextFillColor = 65535;
    ...
    public MotionLabel(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        if (attrs != null) {
            android.content.res.TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.MotionLabel);
    ...
    android.graphics.Bitmap blur(android.graphics.Bitmap bitmapOriginal, int factor) {
        java.lang.Long.valueOf(java.lang.System.nanoTime());
        int width = bitmapOriginal.getWidth() / 2;
        int height = bitmapOriginal.getHeight() / 2;
        android.graphics.Bitmap bitmapCreateScaledBitmap = android.graphics.Bitmap.createScaledBitmap(bitmapOriginal, width, height, true);
    ...
    private void setupTexture() {
        if (this.mTextBackground != null) {
            ...
            if (intrinsicWidth <= 0 && (intrinsicWidth = getWidth()) == 0) {
                intrinsicWidth = java.lang.Float.isNaN(this.mTextureWidth) ? 128 : (int) this.mTextureWidth;
            }
    ...
    public void setGravity(int gravity) {
        if ((gravity & androidx.core.view.GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) == 0) {
            gravity |= androidx.core.view.GravityCompat.START;
        }
        if ((gravity & 112) == 0) {
            gravity |= 48;
        }
        ...
        int i2 = gravity & androidx.core.view.GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (i2 != 3) {
            if (i2 != 5) {
                if (i2 != 8388611) {
                    if (i2 != 8388613) {
    ...
    private float getHorizontalOffset() {
        float f = java.lang.Float.isNaN(this.mBaseTextSize) ? 1.0f : this.mTextSize / this.mBaseTextSize;
        android.text.TextPaint textPaint = this.mPaint;
        java.lang.String str = this.mText;
        return (((((java.lang.Float.isNaN(this.mFloatWidth) ? getMeasuredWidth() : this.mFloatWidth) - getPaddingLeft()) - getPaddingRight()) - (f * textPaint.measureText(str, 0, str.length()))) * (this.mTextPanX + 1.0f)) / 2.0f;
    }

    private float getVerticalOffset() {
        float f = java.lang.Float.isNaN(this.mBaseTextSize) ? 1.0f : this.mTextSize / this.mBaseTextSize;
        android.graphics.Paint.FontMetrics fontMetrics = this.mPaint.getFontMetrics();
        return ((((((java.lang.Float.isNaN(this.mFloatHeight) ? getMeasuredHeight() : this.mFloatHeight) - getPaddingTop()) - getPaddingBottom()) - ((fontMetrics.descent - fontMetrics.ascent) * f)) * (1.0f - this.mTextPanY)) / 2.0f) - (f * fontMetrics.ascent);
    }

    private void setUpTheme(android.content.Context context, android.util.AttributeSet attrs) {
    ...
    void buildShape(float scale) {
        if (this.mUseOutline || scale != 1.0f) {
            ...
            if (scale != 1.0f) {
                android.util.Log.v(TAG, androidx.constraintlayout.motion.widget.Debug.getLoc() + " scale " + scale);
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        boolean zIsNaN = java.lang.Float.isNaN(this.mBaseTextSize);
    ...
    public void layout(float l, float t, float r, float b) {
        ...
        if (getMeasuredHeight() != i6 || getMeasuredWidth() != i3) {
            measure(android.view.View.MeasureSpec.makeMeasureSpec(i3, 1073741824), android.view.View.MeasureSpec.makeMeasureSpec(i6, 1073741824));
        ...
        if (this.mAutoSize) {
            ...
            if (this.mUseOutline || !java.lang.Float.isNaN(this.mBaseTextSize)) {
                buildShape(java.lang.Float.isNaN(this.mBaseTextSize) ? 1.0f : this.mTextSize / this.mBaseTextSize);
            }
        }
    }
    ...
    private void setTypefaceFromAttrs(java.lang.String familyName, int typefaceIndex, int styleIndex) {
        android.graphics.Typeface typefaceCreate;
        android.graphics.Typeface typefaceCreate2;
        if (familyName != null) {
            typefaceCreate = android.graphics.Typeface.create(familyName, styleIndex);
        ...
        if (styleIndex > 0) {
            if (typefaceCreate == null) {
                typefaceCreate2 = android.graphics.Typeface.defaultFromStyle(styleIndex);
            } else {
                typefaceCreate2 = android.graphics.Typeface.create(typefaceCreate, styleIndex);
            }
    ...
    public void setRoundPercent(float round) {
        ...
        if (round != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                android.view.ViewOutlineProvider viewOutlineProvider = new android.view.ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.MotionLabel.1
                    @Override // android.view.ViewOutlineProvider
                    public void getOutline(android.view.View view, android.graphics.Outline outline) {
                        int width = androidx.constraintlayout.utils.widget.MotionLabel.this.getWidth();
                        int height = androidx.constraintlayout.utils.widget.MotionLabel.this.getHeight();
                        outline.setRoundRect(0, 0, width, height, (java.lang.Math.min(width, height) * androidx.constraintlayout.utils.widget.MotionLabel.this.mRoundPercent) / 2.0f);
                    }
                };
    ...
    public void setRound(float round) {
        ...
        if (round != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                android.view.ViewOutlineProvider viewOutlineProvider = new android.view.ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.MotionLabel.2
                    @Override // android.view.ViewOutlineProvider
                    public void getOutline(android.view.View view, android.graphics.Outline outline) {
                        outline.setRoundRect(0, 0, androidx.constraintlayout.utils.widget.MotionLabel.this.getWidth(), androidx.constraintlayout.utils.widget.MotionLabel.this.getHeight(), androidx.constraintlayout.utils.widget.MotionLabel.this.mRound);
                    }
                };
                this.mViewOutlineProvider = viewOutlineProvider;
                setOutlineProvider(viewOutlineProvider);
    ...
    public void setTextSize(float size) {
        this.mTextSize = size;
        android.util.Log.v(TAG, androidx.constraintlayout.motion.widget.Debug.getLoc() + "  " + size + " / " + this.mBaseTextSize);
        android.text.TextPaint textPaint = this.mPaint;
    ...
    private void updateShaderMatrix() {
        float f = java.lang.Float.isNaN(this.mBackgroundPanX) ? 0.0f : this.mBackgroundPanX;
        float f2 = java.lang.Float.isNaN(this.mBackgroundPanY) ? 0.0f : this.mBackgroundPanY;
        ...
        float f5 = java.lang.Float.isNaN(this.mTextureWidth) ? this.mFloatWidth : this.mTextureWidth;
        float f6 = java.lang.Float.isNaN(this.mTextureHeight) ? this.mFloatHeight : this.mTextureHeight;
