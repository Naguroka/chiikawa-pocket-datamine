...
class TouchResponse {
    ...
    TouchResponse(android.content.Context context, androidx.constraintlayout.motion.widget.MotionLayout layout, org.xmlpull.v1.XmlPullParser parser) {
        ...
        fillFromAttributeList(context, android.util.Xml.asAttributeSet(parser));
    }

    public TouchResponse(androidx.constraintlayout.motion.widget.MotionLayout layout, androidx.constraintlayout.motion.widget.OnSwipe onSwipe) {
        this.mTouchAnchorSide = 0;
        this.mTouchSide = 0;
        this.mOnTouchUp = 0;
        this.mTouchAnchorId = -1;
    ...
    private void fillFromAttributeList(android.content.Context context, android.util.AttributeSet attrs) {
        android.content.res.TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, androidx.constraintlayout.widget.R.styleable.OnSwipe);
        fill(typedArrayObtainStyledAttributes);
        typedArrayObtainStyledAttributes.recycle();
    }

    private void fill(android.content.res.TypedArray a2) {
    ...
    void processTouchRotateEvent(android.view.MotionEvent event, androidx.constraintlayout.motion.widget.MotionLayout.MotionTracker velocityTracker, int currentState, androidx.constraintlayout.motion.widget.MotionScene motionScene) {
        float left;
        float f;
        int top;
        int bottom;
        ...
        if (action != 1) {
            ...
            if (i3 != -1) {
                android.view.View viewFindViewById = this.mMotionLayout.findViewById(i3);
                ...
                if (i4 != -1) {
                    android.view.View viewFindViewById2 = this.mMotionLayout.findViewById(this.mMotionLayout.getMotionController(i4).getAnimateRelativeTo());
                    if (viewFindViewById2 == null) {
                        android.util.Log.e(TAG, "could not find view to animate to");
                    } else {
                        this.mMotionLayout.getLocationOnScreen(this.mTempLoc);
            ...
            double dAtan2 = java.lang.Math.atan2(event.getRawY() - height, event.getRawX() - width);
            float fAtan2 = (float) (((dAtan2 - java.lang.Math.atan2(this.mLastTouchY - height, this.mLastTouchX - width)) * 180.0d) / 3.141592653589793d);
            if (fAtan2 > 330.0f) {
                fAtan2 -= 360.0f;
            ...
            if (java.lang.Math.abs(fAtan2) > 0.01d || this.mDragStarted) {
                ...
                if (i5 != -1) {
                    ...
                    fArr[1] = (float) java.lang.Math.toDegrees(fArr[1]);
                } else {
                    this.mAnchorDpDt[1] = 360.0f;
                }
                float fMax = java.lang.Math.max(java.lang.Math.min(progress + ((fAtan2 * this.mDragScale) / this.mAnchorDpDt[1]), 1.0f), 0.0f);
                ...
                if (fMax != progress2) {
                    ...
                    double d = xVelocity;
                    this.mMotionLayout.mLastVelocity = (float) java.lang.Math.toDegrees((float) ((java.lang.Math.hypot(yVelocity, d) * java.lang.Math.sin(java.lang.Math.atan2(yVelocity, d) - dAtan2)) / java.lang.Math.hypot(rawX, rawY)));
                } else {
        ...
        if (i6 != -1) {
            android.view.View viewFindViewById3 = this.mMotionLayout.findViewById(i6);
            this.mMotionLayout.getLocationOnScreen(this.mTempLoc);
            ...
            if (i7 != -1) {
                android.view.View viewFindViewById4 = this.mMotionLayout.findViewById(this.mMotionLayout.getMotionController(i7).getAnimateRelativeTo());
                this.mMotionLayout.getLocationOnScreen(this.mTempLoc);
            ...
            double degrees2 = java.lang.Math.toDegrees(java.lang.Math.atan2(rawY2, rawX2));
            ...
            if (i != -1) {
                ...
                fArr2[1] = (float) java.lang.Math.toDegrees(fArr2[1]);
            } else {
                this.mAnchorDpDt[1] = 360.0f;
            }
            degrees = ((float) (java.lang.Math.toDegrees(java.lang.Math.atan2(yVelocity2 + rawY2, xVelocity2 + rawX2)) - degrees2)) * 62.5f;
        ...
        double degrees3 = java.lang.Math.toDegrees(java.lang.Math.atan2(rawY3, rawX3));
        i = this.mTouchAnchorId;
        if (i != -1) {
            this.mMotionLayout.getAnchorDpDt(i, progress3, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
            float[] fArr3 = this.mAnchorDpDt;
            fArr3[1] = (float) java.lang.Math.toDegrees(fArr3[1]);
        } else {
            this.mAnchorDpDt[1] = 360.0f;
        }
        degrees = ((float) (java.lang.Math.toDegrees(java.lang.Math.atan2(yVelocity2 + rawY3, xVelocity2 + rawX3)) - degrees3)) * 62.5f;
        if (java.lang.Float.isNaN(degrees)) {
            f2 = (((degrees * 3.0f) * this.mDragScale) / this.mAnchorDpDt[1]) + progress3;
        } else {
            f2 = progress3;
    ...
    void processTouchEvent(android.view.MotionEvent event, androidx.constraintlayout.motion.widget.MotionLayout.MotionTracker velocityTracker, int currentState, androidx.constraintlayout.motion.widget.MotionScene motionScene) {
        int i;
        float f;
        ...
        if (action == 1) {
            ...
            float f3 = !java.lang.Float.isNaN(fAbs) ? (fAbs / 3.0f) + progress : progress;
        ...
        if (java.lang.Math.abs((this.mTouchDirectionX * rawX) + (this.mTouchDirectionY * rawY)) > this.mDragThreshold || this.mDragStarted) {
            ...
            if (java.lang.Math.abs(((f5 * fArr4[0]) + (this.mTouchDirectionY * fArr4[1])) * this.mDragScale) < 0.01d) {
            ...
            float fMax = java.lang.Math.max(java.lang.Math.min(progress2 + f, 1.0f), 0.0f);
    ...
    void scrollMove(float dx, float dy) {
        ...
        float f2 = this.mTouchDirectionX;
        float[] fArr = this.mAnchorDpDt;
        if (java.lang.Math.abs((f2 * fArr[0]) + (this.mTouchDirectionY * fArr[1])) < 0.01d) {
            float[] fArr2 = this.mAnchorDpDt;
            fArr2[0] = 0.01f;
            fArr2[1] = 0.01f;
        }
        ...
        float fMax = java.lang.Math.max(java.lang.Math.min(progress + f, 1.0f), 0.0f);
    ...
    void setupTouch() {
        ...
        if (i != -1) {
            ...
            if (viewFindViewById == null) {
                android.util.Log.e(TAG, "cannot find TouchAnchorId @id/" + androidx.constraintlayout.motion.widget.Debug.getName(this.mMotionLayout.getContext(), this.mTouchAnchorId));
            }
        } else {
            viewFindViewById = null;
        }
        if (viewFindViewById instanceof androidx.core.widget.NestedScrollView) {
            androidx.core.widget.NestedScrollView nestedScrollView = (androidx.core.widget.NestedScrollView) viewFindViewById;
            nestedScrollView.setOnTouchListener(new android.view.View.OnTouchListener(this) { // from class: androidx.constraintlayout.motion.widget.TouchResponse.1
                @Override // android.view.View.OnTouchListener
                public boolean onTouch(android.view.View view, android.view.MotionEvent motionEvent) {
                    return false;
                }
            });
            nestedScrollView.setOnScrollChangeListener(new androidx.core.widget.NestedScrollView.OnScrollChangeListener(this) { // from class: androidx.constraintlayout.motion.widget.TouchResponse.2
    ...
    android.graphics.RectF getTouchRegion(android.view.ViewGroup layout, android.graphics.RectF rect) {
        android.view.View viewFindViewById;
    ...
    android.graphics.RectF getLimitBoundsTo(android.view.ViewGroup layout, android.graphics.RectF rect) {
        android.view.View viewFindViewById;
    ...
    public java.lang.String toString() {
        return java.lang.Float.isNaN(this.mTouchDirectionX) ? androidx.constraintlayout.motion.widget.Key.ROTATION : this.mTouchDirectionX + " , " + this.mTouchDirectionY;
    }
