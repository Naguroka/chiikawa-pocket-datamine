...
class MotionPaths implements java.lang.Comparable<androidx.constraintlayout.motion.widget.MotionPaths> {
    ...
    void initCartesian(androidx.constraintlayout.motion.widget.KeyPosition c, androidx.constraintlayout.motion.widget.MotionPaths startTimePoint, androidx.constraintlayout.motion.widget.MotionPaths endTimePoint) {
        float f = c.mFramePosition / 100.0f;
        this.time = f;
        this.mDrawPath = c.mDrawPath;
        float f2 = java.lang.Float.isNaN(c.mPercentWidth) ? f : c.mPercentWidth;
        float f3 = java.lang.Float.isNaN(c.mPercentHeight) ? f : c.mPercentHeight;
        ...
        float f16 = java.lang.Float.isNaN(c.mPercentX) ? f : c.mPercentX;
        float f17 = java.lang.Float.isNaN(c.mAltPercentY) ? 0.0f : c.mAltPercentY;
        if (!java.lang.Float.isNaN(c.mPercentY)) {
            f = c.mPercentY;
        }
        float f18 = java.lang.Float.isNaN(c.mAltPercentX) ? 0.0f : c.mAltPercentX;
        this.mMode = 0;
        this.x = (int) (((startTimePoint.x + (f16 * f10)) + (f18 * f11)) - f13);
        this.y = (int) (((startTimePoint.y + (f10 * f17)) + (f11 * f)) - f15);
        this.mKeyFrameEasing = androidx.constraintlayout.core.motion.utils.Easing.getInterpolator(c.mTransitionEasing);
        this.mPathMotionArc = c.mPathMotionArc;
    }

    public MotionPaths(int parentWidth, int parentHeight, androidx.constraintlayout.motion.widget.KeyPosition c, androidx.constraintlayout.motion.widget.MotionPaths startTimePoint, androidx.constraintlayout.motion.widget.MotionPaths endTimePoint) {
        this.mDrawPath = 0;
        this.mPathRotate = Float.NaN;
        this.mProgress = Float.NaN;
        this.mPathMotionArc = androidx.constraintlayout.motion.widget.Key.UNSET;
        ...
        this.mTempValue = new double[18];
        this.mTempDelta = new double[18];
        if (startTimePoint.mAnimateRelativeTo != androidx.constraintlayout.motion.widget.Key.UNSET) {
    ...
    void initPolar(int parentWidth, int parentHeight, androidx.constraintlayout.motion.widget.KeyPosition c, androidx.constraintlayout.motion.widget.MotionPaths s, androidx.constraintlayout.motion.widget.MotionPaths e) {
        float fMin;
        float f;
        ...
        float f3 = java.lang.Float.isNaN(c.mPercentWidth) ? f2 : c.mPercentWidth;
        float f4 = java.lang.Float.isNaN(c.mPercentHeight) ? f2 : c.mPercentHeight;
        float f5 = e.width;
        float f6 = s.width;
        float f7 = e.height;
        float f8 = s.height;
        ...
        int i = c.mPositionType;
        if (i == 1) {
            float f9 = java.lang.Float.isNaN(c.mPercentX) ? f2 : c.mPercentX;
            float f10 = e.x;
            float f11 = s.x;
            ...
            if (java.lang.Float.isNaN(c.mPercentX)) {
                ...
                fMin = java.lang.Math.min(f4, f3) * c.mPercentX;
            }
            this.x = fMin;
            if (java.lang.Float.isNaN(c.mPercentY)) {
                float f16 = e.y;
            ...
            float f18 = java.lang.Float.isNaN(c.mPercentX) ? f2 : c.mPercentX;
            float f19 = e.x;
            float f20 = s.x;
    ...
    public void setupRelative(androidx.constraintlayout.motion.widget.MotionController mc, androidx.constraintlayout.motion.widget.MotionPaths relative) {
        ...
        this.x = (float) java.lang.Math.hypot(d2, d);
        if (java.lang.Float.isNaN(this.mRelativeAngle)) {
            this.y = (float) (java.lang.Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.y = (float) java.lang.Math.toRadians(this.mRelativeAngle);
        }
    }

    void initScreen(int parentWidth, int parentHeight, androidx.constraintlayout.motion.widget.KeyPosition c, androidx.constraintlayout.motion.widget.MotionPaths startTimePoint, androidx.constraintlayout.motion.widget.MotionPaths endTimePoint) {
        float f = c.mFramePosition / 100.0f;
        this.time = f;
        this.mDrawPath = c.mDrawPath;
        float f2 = java.lang.Float.isNaN(c.mPercentWidth) ? f : c.mPercentWidth;
    ...
    void initPath(androidx.constraintlayout.motion.widget.KeyPosition c, androidx.constraintlayout.motion.widget.MotionPaths startTimePoint, androidx.constraintlayout.motion.widget.MotionPaths endTimePoint) {
        float f = c.mFramePosition / 100.0f;
        this.time = f;
        this.mDrawPath = c.mDrawPath;
        float f2 = java.lang.Float.isNaN(c.mPercentWidth) ? f : c.mPercentWidth;
        ...
        float f18 = java.lang.Float.isNaN(c.mPercentY) ? 0.0f : c.mPercentY;
        this.mMode = 1;
    ...
    void different(androidx.constraintlayout.motion.widget.MotionPaths points, boolean[] mask, java.lang.String[] custom, boolean arcMode) {
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, int offset) {
        ...
        if (motionController != null) {
            ...
            double d2 = fSin;
            double d3 = fCos;
            fSin = (float) ((d + (java.lang.Math.sin(d3) * d2)) - ((double) (f / 2.0f)));
            fCos = (float) ((((double) f5) - (d2 * java.lang.Math.cos(d3))) - ((double) (f2 / 2.0f)));
        }
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController != null) {
            ...
            double d = f;
            double d2 = f2;
            float fSin = (float) ((((double) f13) + (java.lang.Math.sin(d2) * d)) - ((double) (f3 / 2.0f)));
            float fCos2 = (float) ((((double) f14) - (d * java.lang.Math.cos(d2))) - ((double) (f4 / 2.0f)));
            double d3 = f5;
            double d4 = f7;
            float fSin2 = (float) (((double) f15) + (java.lang.Math.sin(d2) * d3) + (java.lang.Math.cos(d2) * d4));
            fCos = (float) ((((double) f16) - (d3 * java.lang.Math.cos(d2))) + (java.lang.Math.sin(d2) * d4));
            f12 = fSin2;
            f = fSin;
            f2 = fCos2;
            f11 = 2.0f;
    ...
    void setView(float position, android.view.View view, int[] toUse, double[] data, double[] slope, double[] cycle, boolean mForceMeasure) {
        float f;
        boolean z;
        boolean z2;
        float f2;
        ...
        while (true) {
            ...
            if (java.lang.Double.isNaN(dArr2[i4]) && (cycle == null || cycle[i4] == 0.0d)) {
                f2 = f7;
            } else {
        ...
        if (motionController != null) {
            ...
            double d4 = f8;
            double d5 = f9;
            float fSin2 = (float) (((double) f17) + (java.lang.Math.sin(d3) * d4) + (java.lang.Math.cos(d3) * d2 * d5));
            float fCos2 = (float) ((((double) f18) - (d4 * java.lang.Math.cos(d3))) + (d2 * java.lang.Math.sin(d3) * d5));
            if (slope.length >= 2) {
                z = false;
                slope[0] = fSin2;
                z2 = true;
            ...
            if (!java.lang.Float.isNaN(f14)) {
                view.setRotation((float) (((double) f14) + java.lang.Math.toDegrees(java.lang.Math.atan2(fCos2, fSin2))));
            }
            f3 = fSin;
            f4 = fCos;
        } else {
            ...
            z2 = true;
            if (!java.lang.Float.isNaN(f14)) {
                view.setRotation((float) (((double) 0.0f) + ((double) f14) + java.lang.Math.toDegrees(java.lang.Math.atan2(f9 + (f11 / 2.0f), f8 + (f10 / 2.0f)))));
            }
        }
        if (view instanceof androidx.constraintlayout.motion.widget.FloatLayout) {
            ((androidx.constraintlayout.motion.widget.FloatLayout) view).layout(f3, f4, f5 + f3, f4 + f);
            return;
        }
        float f19 = f3 + 0.5f;
        int i5 = (int) f19;
    ...
    public int compareTo(androidx.constraintlayout.motion.widget.MotionPaths o) {
    ...
    public void configureRelativeTo(androidx.constraintlayout.motion.widget.MotionController toOrbit) {
