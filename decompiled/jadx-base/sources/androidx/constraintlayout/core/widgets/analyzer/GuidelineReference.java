...
class GuidelineReference extends androidx.constraintlayout.core.widgets.analyzer.WidgetRun {
    ...
    public GuidelineReference(androidx.constraintlayout.core.widgets.ConstraintWidget constraintWidget) {
    ...
    public void update(androidx.constraintlayout.core.widgets.analyzer.Dependency dependency) {
        if (this.start.readyToSolve && !this.start.resolved) {
            this.start.resolve((int) ((this.start.targets.get(0).value * ((androidx.constraintlayout.core.widgets.Guideline) this.widget).getRelativePercent()) + 0.5f));
        }
    }

    @Override // androidx.constraintlayout.core.widgets.analyzer.WidgetRun
    void apply() {
        androidx.constraintlayout.core.widgets.Guideline guideline = (androidx.constraintlayout.core.widgets.Guideline) this.widget;
    ...
    public void applyToWidget() {
        if (((androidx.constraintlayout.core.widgets.Guideline) this.widget).getOrientation() == 1) {
