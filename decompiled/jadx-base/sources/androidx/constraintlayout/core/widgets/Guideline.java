...
public class Guideline extends androidx.constraintlayout.core.widgets.ConstraintWidget {
    ...
    private androidx.constraintlayout.core.widgets.ConstraintAnchor mAnchor = this.mTop;
    ...
    public androidx.constraintlayout.core.widgets.ConstraintAnchor getAnchor(androidx.constraintlayout.core.widgets.ConstraintAnchor.Type type) {
        int i = androidx.constraintlayout.core.widgets.Guideline.AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type.ordinal()];
        if (i == 1 || i == 2) {
            if (this.mOrientation == 1) {
                return this.mAnchor;
            }
    ...
    public void addToSolver(androidx.constraintlayout.core.LinearSystem linearSystem, boolean z) {
        ...
        boolean z2 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
        if (this.mOrientation == 0) {
            ...
            z2 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
        }
