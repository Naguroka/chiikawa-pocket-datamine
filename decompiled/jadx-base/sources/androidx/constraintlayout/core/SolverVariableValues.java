...
public class SolverVariableValues implements androidx.constraintlayout.core.ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(androidx.constraintlayout.core.SolverVariable solverVariable, int i) {
        int[] iArr;
    ...
    private void removeFromHashMap(androidx.constraintlayout.core.SolverVariable solverVariable) {
        int[] iArr;
        int i;
        int i2 = solverVariable.id % this.HASH_SIZE;
        int i3 = this.keys[i2];
