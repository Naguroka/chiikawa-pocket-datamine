...
public class Oscillator {
    ...
    public double getValue(double d, double d2) {
        ...
        switch (this.mType) {
            ...
            case 2:
                dAbs = java.lang.Math.abs((((p * 4.0d) + 1.0d) % 4.0d) - 2.0d);
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                return java.lang.Math.cos(this.PI2 * (d2 + p));
            case 6:
                double dAbs2 = 1.0d - java.lang.Math.abs(((p * 4.0d) % 4.0d) - 2.0d);
                dAbs = dAbs2 * dAbs2;
                break;
            case 7:
                return this.mCustomCurve.getPos(p % 1.0d, 0);
            default:
                return java.lang.Math.sin(this.PI2 * p);
        }
        return 1.0d - dAbs;
    }
    ...
    public double getSlope(double d, double d2, double d3) {
        ...
        switch (this.mType) {
            case 1:
                return 0.0d;
            case 2:
                return dp * 4.0d * java.lang.Math.signum((((p * 4.0d) + 3.0d) % 4.0d) - 2.0d);
            case 3:
                return dp * 2.0d;
            case 4:
                return (-dp) * 2.0d;
            case 5:
                double d4 = this.PI2;
                return (-d4) * dp * java.lang.Math.sin(d4 * p);
            case 6:
            ...
            default:
                double d5 = this.PI2;
                return dp * d5 * java.lang.Math.cos(d5 * p);
        }
    }
}
