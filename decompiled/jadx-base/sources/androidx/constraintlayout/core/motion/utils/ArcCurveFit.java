...
public class ArcCurveFit extends androidx.constraintlayout.core.motion.utils.CurveFit {
    ...
    public void getPos(double d, double[] dArr) {
        if (!this.mExtrapolate) {
            ...
            androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr = this.mArcs;
            if (d > arcArr[arcArr.length - 1].mTime2) {
                androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr2 = this.mArcs;
            ...
            androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr3 = this.mArcs;
            if (d > arcArr3[arcArr3.length - 1].mTime2) {
                androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr4 = this.mArcs;
                double d4 = arcArr4[arcArr4.length - 1].mTime2;
                double d5 = d - d4;
                androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr5 = this.mArcs;
        ...
        int i = 0;
        while (true) {
            androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] arcArr6 = this.mArcs;
            if (i >= arcArr6.length) {
                return;
            }
    ...
    private static class Arc {
        ...
        private void buildTable(double d, double d2, double d3, double d4) {
            ...
            while (true) {
                ...
                double d10 = d7;
                double radians = java.lang.Math.toRadians((((double) i) * 90.0d) / ((double) (dArr.length - 1)));
                double dSin = java.lang.Math.sin(radians) * d5;
                double dCos = java.lang.Math.cos(radians) * d6;
                if (i > 0) {
                    dHypot = java.lang.Math.hypot(dSin - d8, dCos - d9) + d10;
                    ourPercent[i] = dHypot;
                } else {
                    dHypot = d10;
                }
            ...
            while (true) {
                ...
                int iBinarySearch = java.util.Arrays.binarySearch(ourPercent, length);
                if (iBinarySearch >= 0) {
