...
public class HyperSpline {
    ...
    public void setup(double[][] dArr) {
        ...
        while (true) {
            ...
            androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[][] cubicArr = this.mCurve;
        ...
        androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[] cubicArr2 = new androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[i];
    ...
    static androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[] calcNaturalCubic(int i, double[] dArr) {
        ...
        androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[] cubicArr = new androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic[i2];
        while (i3 < i2) {
            double d2 = dArr[i3];
            double d3 = dArr4[i3];
            int i9 = i3 + 1;
            double d4 = dArr[i9];
            double d5 = dArr4[i9];
            cubicArr[i3] = new androidx.constraintlayout.core.motion.utils.HyperSpline.Cubic((float) d2, d3, (((d4 - d2) * 3.0d) - (d3 * 2.0d)) - d5, ((d2 - d4) * 2.0d) + d3 + d5);
            i3 = i9;
        }
        return cubicArr;
    }
