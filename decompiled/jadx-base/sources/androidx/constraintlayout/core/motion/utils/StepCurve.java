...
public class StepCurve extends androidx.constraintlayout.core.motion.utils.Easing {
    ...
    StepCurve(java.lang.String str) {
        ...
        dArr[i] = java.lang.Double.parseDouble(str.substring(iIndexOf, str.indexOf(41, iIndexOf)).trim());
        this.mCurveFit = genSpline(java.util.Arrays.copyOf(dArr, i + 1));
    }
    ...
    private static androidx.constraintlayout.core.motion.utils.MonotonicCurveFit genSpline(double[] dArr) {
        ...
        java.lang.System.out.println(" 0 " + monotonicCurveFit.getPos(0.0d, 0));
        java.lang.System.out.println(" 1 " + monotonicCurveFit.getPos(1.0d, 0));
