...
public class MotionWidget implements androidx.constraintlayout.core.motion.utils.TypedValues {
    ...
    public MotionWidget() {
        this.widgetFrame = new androidx.constraintlayout.core.state.WidgetFrame();
        this.motion = new androidx.constraintlayout.core.motion.MotionWidget.Motion();
        this.propertySet = new androidx.constraintlayout.core.motion.MotionWidget.PropertySet();
    }
    ...
    public void setBounds(int i, int i2, int i3, int i4) {
        if (this.widgetFrame == null) {
            this.widgetFrame = new androidx.constraintlayout.core.state.WidgetFrame((androidx.constraintlayout.core.widgets.ConstraintWidget) null);
        }
    ...
    public void setInterpolatedValue(androidx.constraintlayout.core.motion.CustomAttribute customAttribute, float[] fArr) {
        this.widgetFrame.setCustomAttribute(customAttribute.mName, androidx.constraintlayout.core.motion.utils.TypedValues.Custom.TYPE_FLOAT, fArr[0]);
    }
}
