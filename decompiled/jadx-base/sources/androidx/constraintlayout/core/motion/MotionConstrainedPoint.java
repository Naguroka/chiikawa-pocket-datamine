...
class MotionConstrainedPoint implements java.lang.Comparable<androidx.constraintlayout.core.motion.MotionConstrainedPoint> {
    ...
    java.util.LinkedHashMap<java.lang.String, androidx.constraintlayout.core.motion.CustomVariable> mCustomVariable = new java.util.LinkedHashMap<>();
    int mMode = 0;
    ...
    void different(androidx.constraintlayout.core.motion.MotionConstrainedPoint motionConstrainedPoint, java.util.HashSet<java.lang.String> hashSet) {
    ...
    void different(androidx.constraintlayout.core.motion.MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, java.lang.String[] strArr) {
    ...
    int getCustomData(java.lang.String str, double[] dArr, int i) {
        androidx.constraintlayout.core.motion.CustomVariable customVariable = this.mCustomVariable.get(str);
    ...
    public int compareTo(androidx.constraintlayout.core.motion.MotionConstrainedPoint motionConstrainedPoint) {
    ...
    public void addValues(java.util.HashMap<java.lang.String, androidx.constraintlayout.core.motion.utils.SplineSet> map, int i) {
        for (java.lang.String str : map.keySet()) {
            androidx.constraintlayout.core.motion.utils.SplineSet splineSet = map.get(str);
            str.hashCode();
            byte b = -1;
            switch (str.hashCode()) {
                case -1249320806:
                ...
                default:
                    if (str.startsWith("CUSTOM")) {
                        ...
                        if (this.mCustomVariable.containsKey(str2)) {
                            androidx.constraintlayout.core.motion.CustomVariable customVariable = this.mCustomVariable.get(str2);
                            if (splineSet instanceof androidx.constraintlayout.core.motion.utils.SplineSet.CustomSpline) {
                                ...
                                androidx.constraintlayout.core.motion.utils.Utils.loge("MotionPaths", str + " ViewSpline not a CustomSet frame = " + i + ", value" + customVariable.getValueToInterpolate() + splineSet);
                            }
                        }
                    } else {
