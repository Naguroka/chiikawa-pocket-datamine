...
public class MotionPaths implements java.lang.Comparable<androidx.constraintlayout.core.motion.MotionPaths> {
    ...
    public MotionPaths() {
        ...
        this.customAttributes = new java.util.HashMap<>();
        this.mMode = 0;
    ...
    void initCartesian(androidx.constraintlayout.core.motion.key.MotionKeyPosition motionKeyPosition, androidx.constraintlayout.core.motion.MotionPaths motionPaths, androidx.constraintlayout.core.motion.MotionPaths motionPaths2) {
        ...
        float f2 = java.lang.Float.isNaN(motionKeyPosition.mPercentWidth) ? f : motionKeyPosition.mPercentWidth;
        float f3 = java.lang.Float.isNaN(motionKeyPosition.mPercentHeight) ? f : motionKeyPosition.mPercentHeight;
        ...
        float f16 = java.lang.Float.isNaN(motionKeyPosition.mPercentX) ? f : motionKeyPosition.mPercentX;
        float f17 = java.lang.Float.isNaN(motionKeyPosition.mAltPercentY) ? 0.0f : motionKeyPosition.mAltPercentY;
        if (!java.lang.Float.isNaN(motionKeyPosition.mPercentY)) {
            f = motionKeyPosition.mPercentY;
        }
        float f18 = java.lang.Float.isNaN(motionKeyPosition.mAltPercentX) ? 0.0f : motionKeyPosition.mAltPercentX;
        this.mMode = 0;
    ...
    void initPolar(int i, int i2, androidx.constraintlayout.core.motion.key.MotionKeyPosition motionKeyPosition, androidx.constraintlayout.core.motion.MotionPaths motionPaths, androidx.constraintlayout.core.motion.MotionPaths motionPaths2) {
        ...
        int i3 = motionKeyPosition.mPositionType;
        if (i3 == 1) {
            float f9 = java.lang.Float.isNaN(motionKeyPosition.mPercentX) ? f2 : motionKeyPosition.mPercentX;
            ...
            float f18 = java.lang.Float.isNaN(motionKeyPosition.mPercentX) ? f2 : motionKeyPosition.mPercentX;
    ...
    void initPath(androidx.constraintlayout.core.motion.key.MotionKeyPosition motionKeyPosition, androidx.constraintlayout.core.motion.MotionPaths motionPaths, androidx.constraintlayout.core.motion.MotionPaths motionPaths2) {
        ...
        float f18 = java.lang.Float.isNaN(motionKeyPosition.mPercentY) ? 0.0f : motionKeyPosition.mPercentY;
        this.mMode = 1;
    ...
    void different(androidx.constraintlayout.core.motion.MotionPaths motionPaths, boolean[] zArr, java.lang.String[] strArr, boolean z) {
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        ...
        if (motion != null) {
            ...
            double d3 = fSin;
            double d4 = fCos;
            fSin = (float) ((d2 + (java.lang.Math.sin(d4) * d3)) - ((double) (f / 2.0f)));
            fCos = (float) ((((double) f5) - (d3 * java.lang.Math.cos(d4))) - ((double) (f2 / 2.0f)));
        }
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motion != null) {
            ...
            double d2 = f;
            double d3 = f2;
            float fSin = (float) ((((double) f13) + (java.lang.Math.sin(d3) * d2)) - ((double) (f3 / 2.0f)));
            float fCos2 = (float) ((((double) f14) - (d2 * java.lang.Math.cos(d3))) - ((double) (f4 / 2.0f)));
            double d4 = f5;
            double d5 = f7;
            float fSin2 = (float) (((double) f15) + (java.lang.Math.sin(d3) * d4) + (java.lang.Math.cos(d3) * d5));
            fCos = (float) ((((double) f16) - (d4 * java.lang.Math.cos(d3))) + (java.lang.Math.sin(d3) * d5));
            f12 = fSin2;
            f = fSin;
            f2 = fCos2;
            f11 = 2.0f;
    ...
    void setView(float f, androidx.constraintlayout.core.motion.MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        float f2;
        float f3;
        float f4 = this.x;
        float f5 = this.y;
        ...
        if (motion != null) {
            ...
            double d2 = f4;
            double d3 = f5;
            float fSin = (float) ((((double) f16) + (java.lang.Math.sin(d3) * d2)) - ((double) (f6 / 2.0f)));
            f2 = f7;
            float fCos = (float) ((((double) f17) - (java.lang.Math.cos(d3) * d2)) - ((double) (f7 / 2.0f)));
            double d4 = f9;
            double d5 = f10;
            float fSin2 = (float) (((double) f18) + (java.lang.Math.sin(d3) * d4) + (java.lang.Math.cos(d3) * d2 * d5));
            float fCos2 = (float) ((((double) f19) - (d4 * java.lang.Math.cos(d3))) + (d2 * java.lang.Math.sin(d3) * d5));
            if (dArr2.length >= 2) {
                dArr2[0] = fSin2;
                dArr2[1] = fCos2;
            }
            if (!java.lang.Float.isNaN(f15)) {
                motionWidget.setRotationZ((float) (((double) f15) + java.lang.Math.toDegrees(java.lang.Math.atan2(fCos2, fSin2))));
            }
            f4 = fSin;
            f5 = fCos;
        } else {
            f2 = f7;
            if (!java.lang.Float.isNaN(f15)) {
                motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) f15) + java.lang.Math.toDegrees(java.lang.Math.atan2(f10 + (f12 / 2.0f), f9 + (f11 / 2.0f)))));
            }
        }
        float f20 = f4 + 0.5f;
        float f21 = f5 + 0.5f;
    ...
    int getCustomDataCount(java.lang.String str) {
        androidx.constraintlayout.core.motion.CustomVariable customVariable = this.customAttributes.get(str);
    ...
    public void applyParameters(androidx.constraintlayout.core.motion.MotionWidget motionWidget) {
        this.mKeyFrameEasing = androidx.constraintlayout.core.motion.utils.Easing.getInterpolator(motionWidget.motion.mTransitionEasing);
