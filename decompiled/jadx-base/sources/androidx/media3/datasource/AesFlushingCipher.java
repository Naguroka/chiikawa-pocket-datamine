...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            cipher.init(i, new javax.crypto.spec.SecretKeySpec(bArr, androidx.media3.common.util.Util.splitAtFirst(cipher.getAlgorithm(), "/")[0]), new javax.crypto.spec.IvParameterSpec(getInitializationVector(j, j3)));
            if (i2 != 0) {
