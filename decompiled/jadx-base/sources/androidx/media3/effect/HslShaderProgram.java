...
final class HslShaderProgram extends androidx.media3.effect.BaseGlShaderProgram {
    private static final java.lang.String FRAGMENT_SHADER_PATH = "shaders/fragment_shader_hsl_es2.glsl";
    ...
    public HslShaderProgram(android.content.Context context, androidx.media3.effect.HslAdjustment hslAdjustment, boolean z) throws androidx.media3.common.VideoFrameProcessingException {
        super(z, 1);
        androidx.media3.common.util.Assertions.checkArgument(!z, "HDR is not yet supported.");
        try {
