...
public final class PlaybackStats {
    public static final androidx.media3.exoplayer.analytics.PlaybackStats EMPTY = merge(new androidx.media3.exoplayer.analytics.PlaybackStats[0]);
    ...
    public final java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat> audioFormatHistory;
    public final int backgroundJoiningCount;
    public final int endedCount;
    public final int fatalErrorCount;
    public final java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException> fatalErrorHistory;
    ...
    public final java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException> nonFatalErrorHistory;
    public final int playbackCount;
    private final long[] playbackStateDurationsMs;
    public final java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndPlaybackState> playbackStateHistory;
    ...
    public final java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat> videoFormatHistory;

    public static final class EventTimeAndPlaybackState {
        public final androidx.media3.exoplayer.analytics.AnalyticsListener.EventTime eventTime;
        public final int playbackState;

        public EventTimeAndPlaybackState(androidx.media3.exoplayer.analytics.AnalyticsListener.EventTime eventTime, int i) {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndPlaybackState eventTimeAndPlaybackState = (androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndPlaybackState) obj;
    ...
    public static final class EventTimeAndFormat {
        ...
        public EventTimeAndFormat(androidx.media3.exoplayer.analytics.AnalyticsListener.EventTime eventTime, androidx.media3.common.Format format) {
            this.eventTime = eventTime;
            this.format = format;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat eventTimeAndFormat = (androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat) obj;
            if (!this.eventTime.equals(eventTimeAndFormat.eventTime)) {
                return false;
            }
            androidx.media3.common.Format format = this.format;
            androidx.media3.common.Format format2 = eventTimeAndFormat.format;
            if (format != null) {
    ...
    public static final class EventTimeAndException {
        ...
        public EventTimeAndException(androidx.media3.exoplayer.analytics.AnalyticsListener.EventTime eventTime, java.lang.Exception exc) {
            this.eventTime = eventTime;
            this.exception = exc;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException eventTimeAndException = (androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException) obj;
    ...
    public static androidx.media3.exoplayer.analytics.PlaybackStats merge(androidx.media3.exoplayer.analytics.PlaybackStats... playbackStatsArr) {
        int i;
        int i2 = 16;
        ...
        long jMin = androidx.media3.common.C.TIME_UNSET;
        int i6 = 0;
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        ...
        int i21 = 0;
        while (i3 < length) {
            androidx.media3.exoplayer.analytics.PlaybackStats playbackStats = playbackStatsArr[i3];
            ...
            if (jMax == androidx.media3.common.C.TIME_UNSET) {
                jMax = playbackStats.maxRebufferTimeMs;
            } else {
                long j16 = playbackStats.maxRebufferTimeMs;
                if (j16 != androidx.media3.common.C.TIME_UNSET) {
        ...
        return new androidx.media3.exoplayer.analytics.PlaybackStats(i4, jArr, java.util.Collections.emptyList(), java.util.Collections.emptyList(), jMin, i6, i7, i8, i9, j11, i10, i11, i12, i13, i14, jMax, i15, java.util.Collections.emptyList(), java.util.Collections.emptyList(), j, j2, j3, j4, j5, j6, i16, i17, i5, j12, i18, j13, j7, j8, j9, j10, i19, i20, i21, java.util.Collections.emptyList(), java.util.Collections.emptyList());
    }

    PlaybackStats(int i, long[] jArr, java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndPlaybackState> list, java.util.List<long[]> list2, long j, int i2, int i3, int i4, int i5, long j2, int i6, int i7, int i8, int i9, int i10, long j3, int i11, java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat> list3, java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndFormat> list4, long j4, long j5, long j6, long j7, long j8, long j9, int i12, int i13, int i14, long j10, int i15, long j11, long j12, long j13, long j14, long j15, int i16, int i17, int i18, java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException> list5, java.util.List<androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndException> list6) {
    ...
    public int getPlaybackStateAtTime(long j) {
        int i = 0;
        for (androidx.media3.exoplayer.analytics.PlaybackStats.EventTimeAndPlaybackState eventTimeAndPlaybackState : this.playbackStateHistory) {
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i == 0 ? androidx.media3.common.C.TIME_UNSET : this.totalValidJoinTimeMs / ((long) i);
    }
    ...
    public long getMeanPlayTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalPlayTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanPausedTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalPausedTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanRebufferTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalRebufferTimeMs() / ((long) this.foregroundPlaybackCount);
    }

    public long getMeanSingleRebufferTimeMs() {
        return this.totalRebufferCount == 0 ? androidx.media3.common.C.TIME_UNSET : (getPlaybackStateDurationMs(6) + getPlaybackStateDurationMs(7)) / ((long) this.totalRebufferCount);
    }
    ...
    public long getMeanSeekTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.foregroundPlaybackCount);
    }

    public long getMeanSingleSeekTimeMs() {
        return this.totalSeekCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.totalSeekCount);
    }
    ...
    public long getMeanWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalWaitTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanPlayAndWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalPlayAndWaitTimeMs() / ((long) this.foregroundPlaybackCount);
    }
    ...
    public long getMeanElapsedTimeMs() {
        return this.playbackCount == 0 ? androidx.media3.common.C.TIME_UNSET : getTotalElapsedTimeMs() / ((long) this.playbackCount);
    }
