...
public final class ExperimentalBandwidthMeter implements androidx.media3.exoplayer.upstream.BandwidthMeter, androidx.media3.datasource.TransferListener {
    ...
    private final androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator bandwidthEstimator;
    ...
    private final androidx.media3.exoplayer.upstream.TimeToFirstByteEstimator timeToFirstByteEstimator;
    ...
    public static final class Builder {
        ...
        private androidx.media3.exoplayer.upstream.TimeToFirstByteEstimator timeToFirstByteEstimator = new androidx.media3.exoplayer.upstream.experimental.PercentileTimeToFirstByteEstimator(20, 0.5f);
        private androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator bandwidthEstimator = new androidx.media3.exoplayer.upstream.experimental.SplitParallelSampleBandwidthEstimator.Builder().build();
        ...
        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setInitialBitrateEstimate(long j) {
        ...
        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setInitialBitrateEstimate(int i, long j) {
            this.initialBitrateEstimates.put(java.lang.Integer.valueOf(i), java.lang.Long.valueOf(j));
            return this;
        }

        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setInitialBitrateEstimate(java.lang.String str) {
            this.initialBitrateEstimates = getInitialBitrateEstimatesForCountry(com.google.common.base.Ascii.toUpperCase(str));
            return this;
        }

        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setTimeToFirstByteEstimator(androidx.media3.exoplayer.upstream.TimeToFirstByteEstimator timeToFirstByteEstimator) {
            this.timeToFirstByteEstimator = timeToFirstByteEstimator;
            return this;
        }

        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setBandwidthEstimator(androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator bandwidthEstimator) {
            this.bandwidthEstimator = bandwidthEstimator;
            return this;
        }

        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.Builder setResetOnNetworkTypeChange(boolean z) {
            this.resetOnNetworkTypeChange = z;
            return this;
        }

        public androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter build() {
            return new androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter(this.context, this.initialBitrateEstimates, this.timeToFirstByteEstimator, this.bandwidthEstimator, this.resetOnNetworkTypeChange);
        }

        private static java.util.Map<java.lang.Integer, java.lang.Long> getInitialBitrateEstimatesForCountry(java.lang.String str) {
            int[] initialBitrateCountryGroupAssignment = androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.getInitialBitrateCountryGroupAssignment(str);
            java.util.HashMap map = new java.util.HashMap(8);
            map.put(0, 1000000L);
            map.put(2, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(initialBitrateCountryGroupAssignment[0]));
            map.put(3, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_2G.get(initialBitrateCountryGroupAssignment[1]));
            map.put(4, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_3G.get(initialBitrateCountryGroupAssignment[2]));
            map.put(5, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_4G.get(initialBitrateCountryGroupAssignment[3]));
            map.put(10, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA.get(initialBitrateCountryGroupAssignment[4]));
            map.put(9, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA.get(initialBitrateCountryGroupAssignment[5]));
            map.put(7, androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(initialBitrateCountryGroupAssignment[0]));
            return map;
        }
    }

    private ExperimentalBandwidthMeter(android.content.Context context, java.util.Map<java.lang.Integer, java.lang.Long> map, androidx.media3.exoplayer.upstream.TimeToFirstByteEstimator timeToFirstByteEstimator, androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator bandwidthEstimator, boolean z) {
        ...
        networkTypeObserver.register(new androidx.media3.common.util.NetworkTypeObserver.Listener() { // from class: androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter$$ExternalSyntheticLambda0
    ...
    @Override // androidx.media3.exoplayer.upstream.BandwidthMeter
    public synchronized void addEventListener(android.os.Handler handler, androidx.media3.exoplayer.upstream.BandwidthMeter.EventListener eventListener) {
    ...
    @Override // androidx.media3.exoplayer.upstream.BandwidthMeter
    public synchronized void removeEventListener(androidx.media3.exoplayer.upstream.BandwidthMeter.EventListener eventListener) {
        this.bandwidthEstimator.removeEventListener(eventListener);
    }

    @Override // androidx.media3.datasource.TransferListener
    public synchronized void onTransferInitializing(androidx.media3.datasource.DataSource dataSource, androidx.media3.datasource.DataSpec dataSpec, boolean z) {
