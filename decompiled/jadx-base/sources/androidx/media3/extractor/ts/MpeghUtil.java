...
final class MpeghUtil {
    ...
    public static boolean isSyncWord(int i) {
        return (i & androidx.core.view.ViewCompat.MEASURED_SIZE_MASK) == MHAS_SYNC_WORD;
    }
    ...
    private static int getOutputFrameLength(int i) throws androidx.media3.common.ParserException {
        if (i == 0) {
            return 768;
        }
        if (i == 1) {
        ...
        throw androidx.media3.common.ParserException.createForUnsupportedContainerFeature("Unsupported coreSbrFrameLengthIndex " + i);
    }

    private static int getSbrRatioIndex(int i) throws androidx.media3.common.ParserException {
        if (i == 0 || i == 1) {
            return 0;
        }
        int i2 = 2;
    ...
    private static double getResamplingRatio(int i) throws androidx.media3.common.ParserException {
        switch (i) {
            case 14700:
            ...
            case 96000:
                return 1.0d;
            default:
                throw androidx.media3.common.ParserException.createForUnsupportedContainerFeature("Unsupported sampling rate " + i);
        }
    }
    ...
    public static androidx.media3.extractor.ts.MpeghUtil.Mpegh3daConfig parseMpegh3daConfig(androidx.media3.common.util.ParsableBitArray parsableBitArray) throws androidx.media3.common.ParserException {
        ...
        return new androidx.media3.extractor.ts.MpeghUtil.Mpegh3daConfig(bits, (int) (((double) samplingFrequency) * resamplingRatio), (int) (((double) outputFrameLength) * resamplingRatio), bArr3);
    }

    private static int getSamplingFrequency(int i) throws androidx.media3.common.ParserException {
        switch (i) {
            case 0:
                return 96000;
            case 1:
            ...
            case 14:
            default:
                throw androidx.media3.common.ParserException.createForUnsupportedContainerFeature("Unsupported sampling rate index " + i);
            case 15:
                return 57600;
            case 16:
                return 51200;
    ...
    private static void skipMpegh3daFlexibleSpeakerConfig(androidx.media3.common.util.ParsableBitArray parsableBitArray, int i) {
        int bits;
    ...
    private static void skipMpegh3daDecoderConfig(androidx.media3.common.util.ParsableBitArray parsableBitArray, int i, int i2) {
        int bits;
        ...
        for (int i3 = 0; i3 < escapedIntValue; i3++) {
            ...
            if (bits2 == 0) {
                ...
                int iFloor = ((int) java.lang.Math.floor(java.lang.Math.log(i - 1) / java.lang.Math.log(2.0d))) + 1;
    ...
    private static int readEscapedIntValue(androidx.media3.common.util.ParsableBitArray parsableBitArray, int i, int i2, int i3) {
        androidx.media3.common.util.Assertions.checkArgument(java.lang.Math.max(java.lang.Math.max(i, i2), i3) <= 31);
        int i4 = (1 << i) - 1;
        int i5 = (1 << i2) - 1;
        com.google.common.math.IntMath.checkedAdd(com.google.common.math.IntMath.checkedAdd(i4, i5), 1 << i3);
    ...
    private static long readEscapedLongValue(androidx.media3.common.util.ParsableBitArray parsableBitArray, int i, int i2, int i3) {
        androidx.media3.common.util.Assertions.checkArgument(java.lang.Math.max(java.lang.Math.max(i, i2), i3) <= 63);
        long j = (1 << i) - 1;
        long j2 = (1 << i2) - 1;
        com.google.common.math.LongMath.checkedAdd(com.google.common.math.LongMath.checkedAdd(j, j2), 1 << i3);
        if (parsableBitArray.bitsLeft() < i) {
            return -1L;
        }
