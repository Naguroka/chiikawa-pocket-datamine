...
public final class Ac3Util {
    ...
    private static final int[] SAMPLE_RATE_BY_FSCOD = {androidx.media3.extractor.OpusUtil.SAMPLE_RATE, 44100, 32000};
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, org.objectweb.asm.Opcodes.IF_ICMPNE, 192, 224, 256, 320, androidx.media3.exoplayer.RendererCapabilities.DECODER_SUPPORT_MASK, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, org.objectweb.asm.Opcodes.FRETURN, 208, 243, 278, 348, com.bytedance.sdk.openadsdk.TTAdConstant.DOWNLOAD_URL_AND_PACKAGE_NAME, 487, 557, 696, 835, 975, com.json.mediationsdk.utils.IronSourceConstants.RV_CALLBACK_AD_CLICKED, 1253, 1393};
    ...
    public static androidx.media3.common.Format parseAc3AnnexFFormat(androidx.media3.common.util.ParsableByteArray parsableByteArray, java.lang.String str, java.lang.String str2, androidx.media3.common.DrmInitData drmInitData) {
        ...
        return new androidx.media3.common.Format.Builder().setId(str).setSampleMimeType(androidx.media3.common.MimeTypes.AUDIO_AC3).setChannelCount(i2).setSampleRate(i).setDrmInitData(drmInitData).setLanguage(str2).setAverageBitrate(i3).setPeakBitrate(i3).build();
    }
    ...
    public static androidx.media3.common.Format parseEAc3AnnexFFormat(androidx.media3.common.util.ParsableByteArray parsableByteArray, java.lang.String str, java.lang.String str2, androidx.media3.common.DrmInitData drmInitData) {
        ...
        parsableBitArray.byteAlign();
        parsableByteArray.setPosition(parsableBitArray.getBytePosition());
        return new androidx.media3.common.Format.Builder().setId(str).setSampleMimeType(str3).setChannelCount(i2).setSampleRate(i).setDrmInitData(drmInitData).setLanguage(str2).setPeakBitrate(bits).build();
    }
    ...
    public static androidx.media3.extractor.Ac3Util.SyncFrameInfo parseAc3SyncframeInfo(androidx.media3.common.util.ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            str = (parsableBitArray.readBit() && parsableBitArray.readBits(i10) == 1 && parsableBitArray.readBits(8) == 1) ? androidx.media3.common.MimeTypes.AUDIO_E_AC3_JOC : androidx.media3.common.MimeTypes.AUDIO_E_AC3;
            i2 = i13;
            i3 = i15;
            i5 = bits2;
            i6 = i8;
            ...
            java.lang.String str2 = bits8 == 3 ? null : androidx.media3.common.MimeTypes.AUDIO_AC3;
        ...
        return new androidx.media3.extractor.Ac3Util.SyncFrameInfo(str, i2, i, i6, i5, i3, i4);
    }
    ...
    public static int parseAc3SyncframeSize(byte[] bArr) {
        ...
        byte b = bArr[4];
        return getAc3SyncframeSize((b & 192) >> 6, b & okio.Utf8.REPLACEMENT_BYTE);
    }
