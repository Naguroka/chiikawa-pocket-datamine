...
public final class SmtaAtomUtil {
    ...
    public static androidx.media3.common.Metadata parseSmta(androidx.media3.common.util.ParsableByteArray parsableByteArray, int i) {
        ...
        while (parsableByteArray.getPosition() < i) {
            ...
            if (parsableByteArray.readInt() == 1935766900) {
                ...
                return new androidx.media3.common.Metadata(new androidx.media3.extractor.metadata.mp4.SmtaMetadataEntry(captureFrameRate, i4));
            }
    ...
    private static int getCaptureFrameRate(int i, androidx.media3.common.util.ParsableByteArray parsableByteArray, int i2) {
        if (i == 12) {
            return androidx.media3.extractor.ts.PsExtractor.VIDEO_STREAM_MASK;
        }
        if (i == 13) {
            return 120;
        }
