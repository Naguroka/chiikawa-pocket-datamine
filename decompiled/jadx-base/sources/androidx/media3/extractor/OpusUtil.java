...
public class OpusUtil {
    ...
    public static int parseOggPacketAudioSampleCount(java.nio.ByteBuffer byteBuffer) {
    ...
    public static int parseOggPacketForPreAudioSampleByteCount(java.nio.ByteBuffer byteBuffer) {
    ...
    public static int parsePacketAudioSampleCount(java.nio.ByteBuffer byteBuffer) {
