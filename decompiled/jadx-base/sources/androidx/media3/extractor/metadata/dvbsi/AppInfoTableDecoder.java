    ...
    private static androidx.media3.common.Metadata parseAit(androidx.media3.common.util.ParsableBitArray parsableBitArray) {
        ...
        while (true) {
                ...
                if (bits2 == 2) {
                    ...
                    if (bits4 == 3) {
                        while (parsableBitArray.getBytePosition() < bytePosition3) {
                            bytesAsString = parsableBitArray.readBytesAsString(parsableBitArray.readBits(8), com.google.common.base.Charsets.US_ASCII);
                    ...
                    bytesAsString2 = parsableBitArray.readBytesAsString(bits3, com.google.common.base.Charsets.US_ASCII);
                }
            ...
            if (bytesAsString != null && bytesAsString2 != null) {
                arrayList.add(new androidx.media3.extractor.metadata.dvbsi.AppInfoTable(bits, bytesAsString + bytesAsString2));
            }
        }
