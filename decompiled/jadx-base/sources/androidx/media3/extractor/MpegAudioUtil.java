...
public final class MpegAudioUtil {
    ...
    private static final int[] SAMPLING_RATE_V1 = {44100, androidx.media3.extractor.OpusUtil.SAMPLE_RATE, 32000};
    ...
    public static final class Header {
        ...
        public boolean setForHeaderData(int i) {
            ...
            if (i3 == 3) {
                ...
                if (i2 == 3) {
                    int i10 = i3 == 2 ? androidx.media3.extractor.MpegAudioUtil.BITRATE_V1_L2[i4 - 1] : androidx.media3.extractor.MpegAudioUtil.BITRATE_V1_L3[i4 - 1];
                    this.bitrate = i10;
                    this.frameSize = ((i10 * org.objectweb.asm.Opcodes.D2F) / this.sampleRate) + i7;
                } else {
                    int i11 = androidx.media3.extractor.MpegAudioUtil.BITRATE_V2[i4 - 1];
                    this.bitrate = i11;
                    if (i3 == 1) {
                        i9 = 72;
                    }
