...
public final class Cea708Decoder extends androidx.media3.extractor.text.cea.CeaDecoder {
            ...
            if (i == 2 || i == 3) {
                if (z) {
                    if (i == 3) {
                        ...
                        int i4 = unsignedByte2 & okio.Utf8.REPLACEMENT_BYTE;
                        if (i4 == 0) {
                            i4 = 64;
                        }
    ...
    private void processCurrentPacket() {
        ...
        while (this.captionChannelPacketData.bitsLeft() > 0) {
            ...
            if (bits == 7) {
                ...
                if (bits < 7) {
                    androidx.media3.common.util.Log.w(TAG, "Invalid extended service number: " + bits);
                }
            }
            if (bits2 == 0) {
                if (bits == 0) {
                ...
                androidx.media3.common.util.Log.w(TAG, "serviceNumber is non-zero (" + bits + ") when blockSize is 0");
                break;
            }
                    ...
                    if (bits3 == 16) {
                        ...
                        if (bits4 <= 31) {
                            ...
                            if (bits4 <= 127) {
                                ...
                                androidx.media3.common.util.Log.w(TAG, "Invalid extended command: " + bits4);
                            }
                            z = true;
                        }
                    } else if (bits3 <= 31) {
                        ...
                        if (bits3 <= 127) {
                            ...
                            androidx.media3.common.util.Log.w(TAG, "Invalid base command: " + bits3);
                        }
                        z = true;
                    }
                }
        ...
        switch (i) {
            ...
            case 139:
                for (int i5 = 1; i5 <= 8; i5++) {
                    if (this.captionChannelPacketData.readBit()) {
                        androidx.media3.extractor.text.cea.Cea708Decoder.CueInfoBuilder cueInfoBuilder = this.cueInfoBuilders[8 - i5];
    ...
    private java.util.List<androidx.media3.common.text.Cue> getDisplayCues() {
        androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo cea708CueInfoBuild;
    ...
    private static final class CueInfoBuilder {
        ...
        public androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo build() {
            ...
            return new androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo(spannableStringBuilder, alignment2, f4, 0, i, f3, i2, -3.4028235E38f, this.windowFillColor != COLOR_SOLID_BLACK, this.windowFillColor, this.priority);
        }
    ...
    static final class Cea708CueInfo {
        private static final java.util.Comparator<androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo> LEAST_IMPORTANT_FIRST = new java.util.Comparator() { // from class: androidx.media3.extractor.text.cea.Cea708Decoder$Cea708CueInfo$$ExternalSyntheticLambda0
            ...
            public final int compare(java.lang.Object obj, java.lang.Object obj2) {
                return java.lang.Integer.compare(((androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo) obj2).priority, ((androidx.media3.extractor.text.cea.Cea708Decoder.Cea708CueInfo) obj).priority);
            }
        };
