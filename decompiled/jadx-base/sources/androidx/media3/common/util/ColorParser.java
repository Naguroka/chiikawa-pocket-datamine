...
public final class ColorParser {
    ...
    private static int parseColorInternal(java.lang.String str, boolean z) {
        ...
        if (strReplace.startsWith(RGBA)) {
            ...
            if (matcher.matches()) {
                if (z) {
                    i = (int) (java.lang.Float.parseFloat((java.lang.String) androidx.media3.common.util.Assertions.checkNotNull(matcher.group(4))) * 255.0f);
                } else {
                    i = java.lang.Integer.parseInt((java.lang.String) androidx.media3.common.util.Assertions.checkNotNull(matcher.group(4)), 10);
                }
                return android.graphics.Color.argb(i, java.lang.Integer.parseInt((java.lang.String) androidx.media3.common.util.Assertions.checkNotNull(matcher.group(1)), 10), java.lang.Integer.parseInt((java.lang.String) androidx.media3.common.util.Assertions.checkNotNull(matcher.group(2)), 10), java.lang.Integer.parseInt((java.lang.String) androidx.media3.common.util.Assertions.checkNotNull(matcher.group(3)), 10));
            }
            ...
            java.lang.Integer num = COLOR_MAP.get(com.google.common.base.Ascii.toLowerCase(strReplace));
            if (num != null) {
                return num.intValue();
            }
        }
