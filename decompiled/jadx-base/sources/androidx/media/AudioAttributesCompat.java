...
public class AudioAttributesCompat implements androidx.versionedparcelable.VersionedParcelable {
    ...
    public static androidx.media.AudioAttributesCompat wrap(java.lang.Object obj) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            return new androidx.media.AudioAttributesCompat(new androidx.media.AudioAttributesImplApi26((android.media.AudioAttributes) obj));
        }
        return new androidx.media.AudioAttributesCompat(new androidx.media.AudioAttributesImplApi21((android.media.AudioAttributes) obj));
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            if (androidx.media.AudioAttributesCompat.sForceLegacyBehavior) {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplBase.Builder();
            } else if (android.os.Build.VERSION.SDK_INT >= 26) {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplApi26.Builder();
            } else {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplApi21.Builder();
            }
        }

        public Builder(androidx.media.AudioAttributesCompat audioAttributesCompat) {
            if (androidx.media.AudioAttributesCompat.sForceLegacyBehavior) {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplBase.Builder(audioAttributesCompat);
            } else if (android.os.Build.VERSION.SDK_INT >= 26) {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplApi26.Builder(audioAttributesCompat.unwrap());
            } else {
                this.mBuilderImpl = new androidx.media.AudioAttributesImplApi21.Builder(audioAttributesCompat.unwrap());
            }
        }

        public androidx.media.AudioAttributesCompat build() {
            return new androidx.media.AudioAttributesCompat(this.mBuilderImpl.build());
        }
