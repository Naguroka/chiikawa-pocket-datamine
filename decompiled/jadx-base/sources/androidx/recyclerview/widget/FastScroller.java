...
class FastScroller extends androidx.recyclerview.widget.RecyclerView.ItemDecoration implements androidx.recyclerview.widget.RecyclerView.OnItemTouchListener {
    ...
    FastScroller(androidx.recyclerview.widget.RecyclerView recyclerView, android.graphics.drawable.StateListDrawable stateListDrawable, android.graphics.drawable.Drawable drawable, android.graphics.drawable.StateListDrawable stateListDrawable2, android.graphics.drawable.Drawable drawable2, int i, int i2, int i3) {
        ...
        valueAnimatorOfFloat.addListener(new androidx.recyclerview.widget.FastScroller.AnimatorListener());
        valueAnimatorOfFloat.addUpdateListener(new androidx.recyclerview.widget.FastScroller.AnimatorUpdater());
    ...
    private class AnimatorUpdater implements android.animation.ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(android.animation.ValueAnimator valueAnimator) {
            ...
            androidx.recyclerview.widget.FastScroller.this.mVerticalThumbDrawable.setAlpha(iFloatValue);
            androidx.recyclerview.widget.FastScroller.this.mVerticalTrackDrawable.setAlpha(iFloatValue);
            androidx.recyclerview.widget.FastScroller.this.requestRedraw();
        }
    }
}
