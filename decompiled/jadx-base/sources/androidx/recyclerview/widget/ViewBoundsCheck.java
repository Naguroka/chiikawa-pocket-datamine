...
class ViewBoundsCheck {
    ...
    androidx.recyclerview.widget.ViewBoundsCheck.BoundFlags mBoundFlags = new androidx.recyclerview.widget.ViewBoundsCheck.BoundFlags();
    final androidx.recyclerview.widget.ViewBoundsCheck.Callback mCallback;

    interface Callback {
        android.view.View getChildAt(int i);

        int getChildEnd(android.view.View view);

        int getChildStart(android.view.View view);
    ...
    android.view.View findOneViewWithinBoundFlags(int i, int i2, int i3, int i4) {
        int parentStart = this.mCallback.getParentStart();
        int parentEnd = this.mCallback.getParentEnd();
        int i5 = i2 > i ? 1 : -1;
        android.view.View view = null;
        while (i != i2) {
            android.view.View childAt = this.mCallback.getChildAt(i);
    ...
    boolean isViewWithinBoundFlags(android.view.View view, int i) {
