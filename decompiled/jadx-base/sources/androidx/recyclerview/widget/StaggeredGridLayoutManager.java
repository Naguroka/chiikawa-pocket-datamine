...
public class StaggeredGridLayoutManager extends androidx.recyclerview.widget.RecyclerView.LayoutManager implements androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    android.view.View hasGapsToFix() {
        ...
        while (childCount != i) {
            ...
            if (!layoutParams.mFullSpan && (i2 = childCount + i3) != i) {
                ...
                if (z) {
                    if ((layoutParams.mSpan.mIndex - ((androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams) childAt2.getLayoutParams()).mSpan.mIndex < 0) != (b < 0)) {
                        return childAt;
                    }
                } else {
                    continue;
    ...
    public void onInitializeAccessibilityEvent(android.view.accessibility.AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            android.view.View viewFindFirstVisibleItemClosestToStart = findFirstVisibleItemClosestToStart(false);
            android.view.View viewFindFirstVisibleItemClosestToEnd = findFirstVisibleItemClosestToEnd(false);
    ...
    int findFirstVisibleItemPositionInt() {
        android.view.View viewFindFirstVisibleItemClosestToEnd = this.mShouldReverseLayout ? findFirstVisibleItemClosestToEnd(true) : findFirstVisibleItemClosestToStart(true);
    ...
    private int fill(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.LayoutState layoutState, androidx.recyclerview.widget.RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager.Span span2 = nextSpan;
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                if (r3 != 0 && layoutParams.mFullSpan) {
                    androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromEnd = createFullSpanItemFromEnd(maxEnd2);
                ...
                if (r3 != 0 && layoutParams.mFullSpan) {
                    androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromStart = createFullSpanItemFromStart(minStart);
    ...
    private void recycle(androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.LayoutState layoutState) {
        ...
        if (layoutState.mLayoutDirection == -1) {
            ...
            if (maxStart < 0) {
                ...
                iMin2 = layoutState.mEndLine - java.lang.Math.min(maxStart, layoutState.mAvailable);
            }
    ...
    public android.view.View onFocusSearchFailed(android.view.View view, int i, androidx.recyclerview.widget.RecyclerView.Recycler recycler, androidx.recyclerview.widget.RecyclerView.State state) {
        ...
        androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams layoutParams = (androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams) viewFindContainingItemView.getLayoutParams();
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i2 = this.mSpanCount - 1; i2 >= 0; i2--) {
                android.view.View focusableViewAfter2 = this.mSpans[i2].getFocusableViewAfter(firstChildPosition, iConvertFocusDirectionToLayoutDirection);
            ...
            for (int i3 = 0; i3 < this.mSpanCount; i3++) {
                android.view.View focusableViewAfter3 = this.mSpans[i3].getFocusableViewAfter(firstChildPosition, iConvertFocusDirectionToLayoutDirection);
        ...
        if (!z) {
            ...
            android.view.View viewFindViewByPosition = findViewByPosition(iFindLastPartiallyVisibleItemPosition3);
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i4 = this.mSpanCount - 1; i4 >= 0; i4--) {
                if (i4 != span.mIndex) {
                    ...
                    android.view.View viewFindViewByPosition2 = findViewByPosition(iFindLastPartiallyVisibleItemPosition2);
            ...
            for (int i5 = 0; i5 < this.mSpanCount; i5++) {
                ...
                android.view.View viewFindViewByPosition3 = findViewByPosition(iFindLastPartiallyVisibleItemPosition);
    ...
    class Span {
        ...
        void popEnd() {
            ...
            android.view.View viewRemove = this.mViews.remove(size - 1);
            androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams layoutParams = getLayoutParams(viewRemove);
            layoutParams.mSpan = null;
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize -= androidx.recyclerview.widget.StaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedMeasurement(viewRemove);
            }
            if (size == 1) {
                this.mCachedStart = Integer.MIN_VALUE;
            }
        ...
        void popStart() {
            android.view.View viewRemove = this.mViews.remove(0);
            androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams layoutParams = getLayoutParams(viewRemove);
            layoutParams.mSpan = null;
            if (this.mViews.size() == 0) {
                this.mCachedEnd = Integer.MIN_VALUE;
