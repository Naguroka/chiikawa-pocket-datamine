...
public class SortedList<T> {
    ...
    public SortedList(java.lang.Class<T> cls, androidx.recyclerview.widget.SortedList.Callback<T> callback, int i) {
        this.mTClass = cls;
        this.mData = (T[]) ((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) cls, i));
    ...
    public void addAll(java.util.Collection<T> collection) {
        addAll(collection.toArray((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, collection.size())), true);
    }
    ...
    public void replaceAll(java.util.Collection<T> collection) {
        replaceAll(collection.toArray((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, collection.size())), true);
    }
    ...
    private void replaceAllInternal(T[] tArr) {
        boolean z = !(this.mCallback instanceof androidx.recyclerview.widget.SortedList.BatchedCallback);
        if (z) {
            beginBatchedUpdates();
        }
        ...
        int iSortAndDedup = sortAndDedup(tArr);
        this.mData = (T[]) ((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, iSortAndDedup));
        while (true) {
            ...
            if (iCompare < 0) {
                ...
                if (!this.mCallback.areContentsTheSame(t, t2)) {
                    androidx.recyclerview.widget.SortedList.Callback callback = this.mCallback;
    ...
    private void merge(T[] tArr, int i) {
        ...
        this.mData = (T[]) ((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, i3 + i + 10));
        this.mNewDataStart = 0;
        while (true) {
    ...
    public void beginBatchedUpdates() {
        throwIfInMutationOperation();
        if (this.mCallback instanceof androidx.recyclerview.widget.SortedList.BatchedCallback) {
            return;
        }
    ...
    public void endBatchedUpdates() {
        ...
        androidx.recyclerview.widget.SortedList.Callback callback2 = this.mCallback;
        androidx.recyclerview.widget.SortedList.BatchedCallback batchedCallback = this.mBatchedCallback;
    ...
    private void addToData(int i, T t) {
        ...
        T[] tArr = this.mData;
        if (i2 == tArr.length) {
            T[] tArr2 = (T[]) ((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, tArr.length + 10));
    ...
    private T[] copyArray(T[] tArr) {
        T[] tArr2 = (T[]) ((java.lang.Object[]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) this.mTClass, tArr.length));
    ...
    public static abstract class Callback<T2> implements java.util.Comparator<T2>, androidx.recyclerview.widget.ListUpdateCallback {
        ...
        public java.lang.Object getChangePayload(T2 t2, T2 t3) {
            return null;
        }
    ...
    public static class BatchedCallback<T2> extends androidx.recyclerview.widget.SortedList.Callback<T2> {
        ...
        public BatchedCallback(androidx.recyclerview.widget.SortedList.Callback<T2> callback) {
            ...
            this.mBatchingListUpdateCallback = new androidx.recyclerview.widget.BatchingListUpdateCallback(callback);
        }
