...
public class DiffUtil {
    ...
    public static androidx.recyclerview.widget.DiffUtil.DiffResult calculateDiff(androidx.recyclerview.widget.DiffUtil.Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            androidx.recyclerview.widget.DiffUtil.Snake snakeMidPoint = midPoint(range, callback, centeredArray, centeredArray2);
    ...
    private static androidx.recyclerview.widget.DiffUtil.Snake midPoint(androidx.recyclerview.widget.DiffUtil.Range range, androidx.recyclerview.widget.DiffUtil.Callback callback, androidx.recyclerview.widget.DiffUtil.CenteredArray centeredArray, androidx.recyclerview.widget.DiffUtil.CenteredArray centeredArray2) {
        if (range.oldSize() >= 1 && range.newSize() >= 1) {
            ...
            for (int i = 0; i < iOldSize; i++) {
                androidx.recyclerview.widget.DiffUtil.Snake snakeForward = forward(range, callback, centeredArray, centeredArray2, i);
                if (snakeForward != null) {
                    return snakeForward;
                }
                androidx.recyclerview.widget.DiffUtil.Snake snakeBackward = backward(range, callback, centeredArray, centeredArray2, i);
    ...
    public static class DiffResult {
        ...
        private void findMatchingAddition(int i) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                androidx.recyclerview.widget.DiffUtil.Diagonal diagonal = this.mDiagonals.get(i2);
        ...
        private static androidx.recyclerview.widget.DiffUtil.PostponedUpdate getPostponedUpdate(java.util.Collection<androidx.recyclerview.widget.DiffUtil.PostponedUpdate> collection, int i, boolean z) {
            ...
            while (it.hasNext()) {
                androidx.recyclerview.widget.DiffUtil.PostponedUpdate next2 = it.next();
                if (z) {
                    next2.currentPos--;
                } else {
                    next2.currentPos++;
