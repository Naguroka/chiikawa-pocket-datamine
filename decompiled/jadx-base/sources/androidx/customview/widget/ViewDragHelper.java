...
public class ViewDragHelper {
    ...
    public static androidx.customview.widget.ViewDragHelper create(android.view.ViewGroup viewGroup, float f, androidx.customview.widget.ViewDragHelper.Callback callback) {
        androidx.customview.widget.ViewDragHelper viewDragHelperCreate = create(viewGroup, callback);
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        if (iAbs2 > 0) {
            ...
            iAbs = (int) (((java.lang.Math.abs(i) / i3) + 1.0f) * 256.0f);
        }
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                for (int i4 = 0; i4 < pointerCount; i4++) {
                    ...
                    if (isValidPointerForActionMove(pointerId2)) {
                        ...
                        android.view.View viewFindTopChildUnder2 = findTopChildUnder((int) x2, (int) y2);
            ...
            android.view.View viewFindTopChildUnder3 = findTopChildUnder((int) x3, (int) y3);
    ...
    public void processTouchEvent(android.view.MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            android.view.View viewFindTopChildUnder = findTopChildUnder((int) x, (int) y);
            saveInitialMotion(x, y, pointerId);
            tryCaptureViewForDrag(viewFindTopChildUnder, pointerId);
        ...
        if (actionMasked == 2) {
            ...
            while (i2 < pointerCount) {
                ...
                if (isValidPointerForActionMove(pointerId2)) {
                    ...
                    reportNewEdgeDrags(f, f2, pointerId2);
                    if (this.mDragState != 1) {
                        android.view.View viewFindTopChildUnder2 = findTopChildUnder((int) x3, (int) y3);
        ...
        if (this.mDragState == 1 && pointerId4 == this.mActivePointerId) {
            ...
            while (true) {
                ...
                if (pointerId5 != this.mActivePointerId) {
                    android.view.View viewFindTopChildUnder3 = findTopChildUnder((int) motionEvent.getX(i2), (int) motionEvent.getY(i2));
    ...
    private boolean checkTouchSlop(android.view.View view, float f, float f2) {
        ...
        if (z) {
            return java.lang.Math.abs(f) > ((float) this.mTouchSlop);
        }
        return z2 && java.lang.Math.abs(f2) > ((float) this.mTouchSlop);
    }
