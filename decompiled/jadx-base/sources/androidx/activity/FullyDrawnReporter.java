...
public final class FullyDrawnReporter {
    ...
    public FullyDrawnReporter(java.util.concurrent.Executor executor, kotlin.jvm.functions.Function0<kotlin.Unit> reportFullyDrawn) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(executor, "executor");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(reportFullyDrawn, "reportFullyDrawn");
        this.executor = executor;
        this.reportFullyDrawn = reportFullyDrawn;
        this.lock = new java.lang.Object();
        this.onReportCallbacks = new java.util.ArrayList();
        this.reportRunnable = new java.lang.Runnable() { // from class: androidx.activity.FullyDrawnReporter$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                androidx.activity.FullyDrawnReporter.reportRunnable$lambda$2(this.f$0);
            }
        };
    }
    ...
    public static final void reportRunnable$lambda$2(androidx.activity.FullyDrawnReporter this$0) {
    ...
    public final void removeReporter() {
        synchronized (this.lock) {
            if (!this.reportedFullyDrawn) {
                ...
                if (!(i > 0)) {
                    throw new java.lang.IllegalStateException("removeReporter() called when all reporters have already been removed.".toString());
                }
    ...
    public final void fullyDrawnReported() {
        synchronized (this.lock) {
            ...
            java.util.Iterator<T> it = this.onReportCallbacks.iterator();
            while (it.hasNext()) {
