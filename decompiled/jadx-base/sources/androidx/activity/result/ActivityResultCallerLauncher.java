...
public final class ActivityResultCallerLauncher<I, O> extends androidx.activity.result.ActivityResultLauncher<kotlin.Unit> {
    ...
    private final kotlin.Lazy resultContract;
    ...
    public ActivityResultCallerLauncher(androidx.activity.result.ActivityResultLauncher<I> launcher, androidx.activity.result.contract.ActivityResultContract<I, O> callerContract, I i) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(launcher, "launcher");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(callerContract, "callerContract");
        this.launcher = launcher;
        this.callerContract = callerContract;
        this.callerInput = i;
        this.resultContract = kotlin.LazyKt.lazy(new kotlin.jvm.functions.Function0<androidx.activity.result.ActivityResultCallerLauncher$resultContract$2.AnonymousClass1>(this) { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
            final /* synthetic */ androidx.activity.result.ActivityResultCallerLauncher<I, O> this$0;
            ...
            public final androidx.activity.result.ActivityResultCallerLauncher$resultContract$2.AnonymousClass1 invoke() {
                final androidx.activity.result.ActivityResultCallerLauncher<I, O> activityResultCallerLauncher = this.this$0;
                return new androidx.activity.result.contract.ActivityResultContract<kotlin.Unit, O>() { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2.1
                    @Override // androidx.activity.result.contract.ActivityResultContract
                    public android.content.Intent createIntent(android.content.Context context, kotlin.Unit input) {
                    ...
                    @Override // androidx.activity.result.contract.ActivityResultContract
                    public O parseResult(int resultCode, android.content.Intent intent) {
    ...
    public final androidx.activity.result.contract.ActivityResultContract<kotlin.Unit, O> getResultContract() {
        return (androidx.activity.result.contract.ActivityResultContract) this.resultContract.getValue();
    }

    @Override // androidx.activity.result.ActivityResultLauncher
    public void launch(kotlin.Unit input, androidx.core.app.ActivityOptionsCompat options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(input, "input");
