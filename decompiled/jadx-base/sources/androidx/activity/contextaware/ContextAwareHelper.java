...
public final class ContextAwareHelper {
    ...
    public final void dispatchOnContextAvailable(android.content.Context context) {
        ...
        java.util.Iterator<androidx.activity.contextaware.OnContextAvailableListener> it = this.listeners.iterator();
        while (it.hasNext()) {
