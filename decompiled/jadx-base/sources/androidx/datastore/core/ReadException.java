...
public final class ReadException<T> extends androidx.datastore.core.State<T> {
    private final java.lang.Throwable readException;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReadException(java.lang.Throwable readException, int i) {
        super(i, null);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(readException, "readException");
