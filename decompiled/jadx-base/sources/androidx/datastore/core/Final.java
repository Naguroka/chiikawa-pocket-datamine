...
public final class Final<T> extends androidx.datastore.core.State<T> {
    private final java.lang.Throwable finalException;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Final(java.lang.Throwable finalException) {
        super(Integer.MAX_VALUE, null);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(finalException, "finalException");
