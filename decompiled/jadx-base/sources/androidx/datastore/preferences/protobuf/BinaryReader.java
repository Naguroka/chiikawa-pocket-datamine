...
abstract class BinaryReader implements androidx.datastore.preferences.protobuf.Reader {
    ...
    private static final class SafeHeapReader extends androidx.datastore.preferences.protobuf.BinaryReader {
        ...
        public int getFieldNumber() throws java.io.IOException {
            ...
            return androidx.datastore.preferences.protobuf.WireFormat.getTagFieldNumber(varint32);
        }
        ...
        public java.lang.String readStringInternal(boolean requireUtf8) throws java.io.IOException {
            ...
            if (requireUtf8) {
                ...
                int i = this.pos;
                if (!androidx.datastore.preferences.protobuf.Utf8.isValidUtf8(bArr, i, i + varint32)) {
                    throw androidx.datastore.preferences.protobuf.InvalidProtocolBufferException.invalidUtf8();
                }
            }
            java.lang.String str = new java.lang.String(this.buffer, this.pos, varint32, androidx.datastore.preferences.protobuf.Internal.UTF_8);
            this.pos += varint32;
            return str;
        }
        ...
        public androidx.datastore.preferences.protobuf.ByteString readBytes() throws java.io.IOException {
            ...
            if (this.bufferIsImmutable) {
                byteStringCopyFrom = androidx.datastore.preferences.protobuf.ByteString.wrap(this.buffer, this.pos, varint32);
            } else {
                byteStringCopyFrom = androidx.datastore.preferences.protobuf.ByteString.copyFrom(this.buffer, this.pos, varint32);
            }
            this.pos += varint32;
