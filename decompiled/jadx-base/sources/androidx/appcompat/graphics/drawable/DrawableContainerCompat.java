...
public class DrawableContainerCompat extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    public android.graphics.drawable.Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            androidx.appcompat.graphics.drawable.DrawableContainerCompat.DrawableContainerState drawableContainerStateCloneConstantState = cloneConstantState();
    ...
    static abstract class DrawableContainerState extends android.graphics.drawable.Drawable.ConstantState {
        ...
        DrawableContainerState(androidx.appcompat.graphics.drawable.DrawableContainerCompat.DrawableContainerState drawableContainerState, androidx.appcompat.graphics.drawable.DrawableContainerCompat drawableContainerCompat, android.content.res.Resources resources) {
            ...
            int iResolveDensity = androidx.appcompat.graphics.drawable.DrawableContainerCompat.resolveDensity(resources, drawableContainerState != null ? drawableContainerState.mDensity : 0);
        ...
        final boolean setLayoutDirection(int i, int i2) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                if (drawableArr[i4] != null) {
                    boolean layoutDirection = androidx.core.graphics.drawable.DrawableCompat.setLayoutDirection(drawableArr[i4], i);
                    if (i4 == i2) {
                        z = layoutDirection;
                    }
                }
        ...
        final void updateDensity(android.content.res.Resources resources) {
            if (resources != null) {
                ...
                int iResolveDensity = androidx.appcompat.graphics.drawable.DrawableContainerCompat.resolveDensity(resources, this.mDensity);
                int i = this.mDensity;
                this.mDensity = iResolveDensity;
    ...
    static int resolveDensity(android.content.res.Resources resources, int i) {
        ...
        return i == 0 ? org.objectweb.asm.Opcodes.IF_ICMPNE : i;
    }
