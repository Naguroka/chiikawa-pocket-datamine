...
public class WindowCallbackWrapper implements android.view.Window.Callback {
    ...
    public boolean onSearchRequested(android.view.SearchEvent searchEvent) {
        return androidx.appcompat.view.WindowCallbackWrapper.Api23Impl.onSearchRequested(this.mWrapped, searchEvent);
    }
    ...
    public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback, int i) {
        return androidx.appcompat.view.WindowCallbackWrapper.Api23Impl.onWindowStartingActionMode(this.mWrapped, callback, i);
    }
    ...
    public void onProvideKeyboardShortcuts(java.util.List<android.view.KeyboardShortcutGroup> list, android.view.Menu menu, int i) {
        androidx.appcompat.view.WindowCallbackWrapper.Api24Impl.onProvideKeyboardShortcuts(this.mWrapped, list, menu, i);
    }

    @Override // android.view.Window.Callback
    public void onPointerCaptureChanged(boolean z) {
        androidx.appcompat.view.WindowCallbackWrapper.Api26Impl.onPointerCaptureChanged(this.mWrapped, z);
    }
    ...
    static class Api23Impl {
        ...
        static boolean onSearchRequested(android.view.Window.Callback callback, android.view.SearchEvent searchEvent) {
            return callback.onSearchRequested(searchEvent);
        }

        static android.view.ActionMode onWindowStartingActionMode(android.view.Window.Callback callback, android.view.ActionMode.Callback callback2, int i) {
    ...
    static class Api24Impl {
        ...
        static void onProvideKeyboardShortcuts(android.view.Window.Callback callback, java.util.List<android.view.KeyboardShortcutGroup> list, android.view.Menu menu, int i) {
    ...
    static class Api26Impl {
        ...
        static void onPointerCaptureChanged(android.view.Window.Callback callback, boolean z) {
