    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (true) {
            ...
            while (i19 < childCount) {
                boolean z7 = z6;
                androidx.appcompat.widget.ActionMenuView.LayoutParams layoutParams2 = (androidx.appcompat.widget.ActionMenuView.LayoutParams) getChildAt(i19).getLayoutParams();
                int i20 = iMax;
            ...
            while (i22 < childCount) {
                android.view.View childAt2 = getChildAt(i22);
        ...
        if (i7 <= 0 || j == 0 || (i7 >= i11 - 1 && !z8 && iMax2 <= 1)) {
            ...
            if (z8) {
                ...
                if ((j & ((long) (1 << i26))) != 0 && !((androidx.appcompat.widget.ActionMenuView.LayoutParams) getChildAt(i26).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            ...
            for (int i28 = i4; i28 < childCount; i28++) {
                if ((j & ((long) (1 << i28))) != 0) {
                    android.view.View childAt3 = getChildAt(i28);
        ...
        if (z2) {
            for (int i29 = i4; i29 < childCount; i29++) {
                android.view.View childAt4 = getChildAt(i29);
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(android.view.View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i9) + layoutParams5.extraPixels, 1073741824), childMeasureSpec);
                }
            }
        }
