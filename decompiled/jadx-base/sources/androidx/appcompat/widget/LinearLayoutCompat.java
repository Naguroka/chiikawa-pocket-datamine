...
public class LinearLayoutCompat extends android.view.ViewGroup {
    ...
    public LinearLayoutCompat(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
        ...
        androidx.core.view.ViewCompat.saveAttributeDataForStyleable(this, context, androidx.appcompat.R.styleable.LinearLayoutCompat, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i, 0);
                ...
                if (virtualChildAt == null) {
                    ...
                    if (virtualChildAt.getVisibility() == 8) {
                        ...
                        if (layoutParams.weight > 0.0f) {
                            ...
                            iMax4 = java.lang.Math.max(i12, i29);
                            iMax3 = i14;
                        } else {
                            if (!z3) {
                                i29 = measuredWidth;
                            ...
                            if (f4 > 0.0f) {
                                ...
                                if (layoutParams3.height == 0) {
                                    ...
                                    if (i34 == 1073741824) {
                                        ...
                                        virtualChildAt3.measure(childMeasureSpec, android.view.View.MeasureSpec.makeMeasureSpec(i40, 1073741824));
                                    }
                    ...
                    if (z4 && i34 != 1073741824) {
                        for (int i44 = 0; i44 < i3; i44++) {
                            ...
                            if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((androidx.appcompat.widget.LinearLayoutCompat.LayoutParams) virtualChildAt4.getLayoutParams()).weight > 0.0f) {
                                virtualChildAt4.measure(android.view.View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredWidth(), 1073741824), android.view.View.MeasureSpec.makeMeasureSpec(i31, 1073741824));
                            }
                        }
                    }
                    iCombineMeasuredStates = i30;
    ...
    void measureHorizontal(int i, int i2) {
        ...
        int i27 = iArr2[1];
        int iMax7 = (i27 == -1 && iArr2[0] == -1 && iArr2[2] == -1 && iArr2[3] == -1) ? i23 : java.lang.Math.max(i23, java.lang.Math.max(iArr2[3], java.lang.Math.max(iArr2[0], java.lang.Math.max(i27, iArr2[2]))) + java.lang.Math.max(iArr[3], java.lang.Math.max(iArr[0], java.lang.Math.max(iArr[1], iArr[2]))));
            ...
            while (childrenSkipCount3 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    if (z6) {
                        ...
                        int i28 = this.mTotalLength;
                        this.mTotalLength = java.lang.Math.max(i28, i28 + iMax3 + layoutParams2.leftMargin + layoutParams2.rightMargin + getNextLocationOffset(virtualChildAt2));
                    }
                    childrenSkipCount3++;
                    iMax7 = iMax7;
                }
        ...
        if (z7 || (i30 != 0 && f > 0.0f)) {
            ...
            while (i32 < virtualChildCount) {
                android.view.View virtualChildAt3 = getVirtualChildAt(i32);
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f4 > 0.0f) {
                        ...
                        if (layoutParams3.width == 0) {
                            ...
                            if (mode == 1073741824) {
                                ...
                                virtualChildAt3.measure(android.view.View.MeasureSpec.makeMeasureSpec(i33, 1073741824), childMeasureSpec);
                            }
                    ...
                    if (z6) {
                        ...
                        int i35 = this.mTotalLength;
                        this.mTotalLength = java.lang.Math.max(i35, virtualChildAt3.getMeasuredWidth() + i35 + layoutParams3.leftMargin + layoutParams3.rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
                    ...
                    int iMax9 = java.lang.Math.max(i31, i36);
                    if (z9) {
                        i5 = -1;
                        ...
                        if (z11 && (baseline = virtualChildAt3.getBaseline()) != i5) {
                            ...
                            iArr2[i37] = java.lang.Math.max(iArr2[i37], baseline);
                            iArr[i37] = java.lang.Math.max(iArr[i37], measuredHeight2 - baseline);
                        }
                        z9 = z13;
                        i31 = iMax9;
                        f = f;
                    ...
                    if (z11) {
                        ...
                        iArr2[i38] = java.lang.Math.max(iArr2[i38], baseline);
                        iArr[i38] = java.lang.Math.max(iArr[i38], measuredHeight2 - baseline);
                    }
                    z9 = z13;
                    i31 = iMax9;
                    f = f;
            ...
            int i39 = iArr2[1];
            iMax = (i39 == -1 && iArr2[0] == -1 && iArr2[2] == -1 && iArr2[3] == -1) ? iMax8 : java.lang.Math.max(iMax8, java.lang.Math.max(iArr2[3], java.lang.Math.max(iArr2[0], java.lang.Math.max(i39, iArr2[2]))) + java.lang.Math.max(iArr[3], java.lang.Math.max(iArr[0], java.lang.Math.max(iArr[1], iArr[2]))));
            iMax2 = i31;
            i26 = iCombineMeasuredStates2;
        } else {
            iMax2 = java.lang.Math.max(i24, i25);
            if (z10 && mode != 1073741824) {
                for (int i40 = 0; i40 < virtualChildCount; i40++) {
                    android.view.View virtualChildAt4 = getVirtualChildAt(i40);
                    if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((androidx.appcompat.widget.LinearLayoutCompat.LayoutParams) virtualChildAt4.getLayoutParams()).weight > 0.0f) {
                        virtualChildAt4.measure(android.view.View.MeasureSpec.makeMeasureSpec(iMax3, 1073741824), android.view.View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredHeight(), 1073741824));
                    }
                }
            }
            i3 = virtualChildCount;
        ...
        setMeasuredDimension(iResolveSizeAndState | (i26 & androidx.core.view.ViewCompat.MEASURED_STATE_MASK), android.view.View.resolveSizeAndState(java.lang.Math.max(iMax2 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i2, i26 << 16));
        if (z8) {
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        int i11 = i10 & 112;
        int i12 = i10 & androidx.core.view.GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (i11 == 16) {
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int absoluteGravity = androidx.core.view.GravityCompat.getAbsoluteGravity(8388615 & i10, androidx.core.view.ViewCompat.getLayoutDirection(this));
        boolean z3 = true;
        if (absoluteGravity == 1) {
