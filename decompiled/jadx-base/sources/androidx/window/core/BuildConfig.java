...
public final class BuildConfig {
    public static final androidx.window.core.BuildConfig INSTANCE = new androidx.window.core.BuildConfig();
    private static final androidx.window.core.SpecificationComputer.VerificationMode verificationMode = androidx.window.core.SpecificationComputer.VerificationMode.QUIET;
