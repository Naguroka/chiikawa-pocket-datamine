...
public interface EmbeddingInterfaceCompat {
    ...
    public interface EmbeddingCallbackInterface {
        void onSplitInfoChanged(java.util.List<androidx.window.embedding.SplitInfo> splitInfo);
    }

    void setEmbeddingCallback(androidx.window.embedding.EmbeddingInterfaceCompat.EmbeddingCallbackInterface embeddingCallback);
