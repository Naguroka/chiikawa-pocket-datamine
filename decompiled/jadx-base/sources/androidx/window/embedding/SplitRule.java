...
public class SplitRule extends androidx.window.embedding.EmbeddingRule {
    ...
    public /* synthetic */ SplitRule(int i, int i2, float f, int i3, int i4, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final boolean checkParentMetrics(android.view.WindowMetrics parentMetrics) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(parentMetrics, "parentMetrics");
    ...
    public static final class Api30Impl {
        ...
        public final android.graphics.Rect getBounds(android.view.WindowMetrics windowMetrics) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(windowMetrics, "windowMetrics");
            android.graphics.Rect bounds = windowMetrics.getBounds();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(bounds, "windowMetrics.bounds");
            return bounds;
        }
    }
