...
public final class ActivityStack {
    ...
    public ActivityStack(java.util.List<? extends android.app.Activity> activities, boolean z) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(activities, "activities");
        this.activities = activities;
        this.isEmpty = z;
    }

    public /* synthetic */ ActivityStack(java.util.List list, boolean z, int i, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return (kotlin.jvm.internal.Intrinsics.areEqual(this.activities, activityStack.activities) || this.isEmpty == activityStack.isEmpty) ? false : true;
    }
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("ActivityStack{");
        sb.append(kotlin.jvm.internal.Intrinsics.stringPlus("activities=", getActivities$window_release()));
