...
public final class SplitPairRule extends androidx.window.embedding.SplitRule {
    ...
    public /* synthetic */ SplitPairRule(java.util.Set set, boolean z, boolean z2, boolean z3, int i, int i2, float f, int i3, int i4, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SplitPairRule(java.util.Set<androidx.window.embedding.SplitPairFilter> filters, boolean z, boolean z2, boolean z3, int i, int i2, float f, int i3) {
        super(i, i2, f, i3);
    ...
    public final androidx.window.embedding.SplitPairRule plus$window_release(androidx.window.embedding.SplitPairFilter filter) {
        ...
        return new androidx.window.embedding.SplitPairRule(kotlin.collections.CollectionsKt.toSet(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        return kotlin.jvm.internal.Intrinsics.areEqual(this.filters, splitPairRule.filters) && this.finishPrimaryWithSecondary == splitPairRule.finishPrimaryWithSecondary && this.finishSecondaryWithPrimary == splitPairRule.finishSecondaryWithPrimary && this.clearTop == splitPairRule.clearTop;
    }
