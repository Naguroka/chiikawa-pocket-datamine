...
public class PagerTabStrip extends androidx.viewpager.widget.PagerTitleStrip {
    ...
    public PagerTabStrip(android.content.Context context, android.util.AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new android.view.View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.1
            @Override // android.view.View.OnClickListener
            public void onClick(android.view.View view) {
                androidx.viewpager.widget.PagerTabStrip.this.mPager.setCurrentItem(androidx.viewpager.widget.PagerTabStrip.this.mPager.getCurrentItem() - 1);
            }
        });
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new android.view.View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.2
            @Override // android.view.View.OnClickListener
            public void onClick(android.view.View view) {
                androidx.viewpager.widget.PagerTabStrip.this.mPager.setCurrentItem(androidx.viewpager.widget.PagerTabStrip.this.mPager.getCurrentItem() + 1);
            }
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        this.mTabPaint.setColor((this.mTabAlpha << 24) | (this.mIndicatorColor & androidx.core.view.ViewCompat.MEASURED_SIZE_MASK));
        float f = height;
        canvas.drawRect(left, i, right, f, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor((this.mIndicatorColor & androidx.core.view.ViewCompat.MEASURED_SIZE_MASK) | androidx.core.view.ViewCompat.MEASURED_STATE_MASK);
