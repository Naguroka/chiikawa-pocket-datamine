...
public final class LocalAtomics_commonKt {
    public static final int getValue(java.util.concurrent.atomic.AtomicInteger atomicInteger) {
        return atomicInteger.get();
    }

    public static final void setValue(java.util.concurrent.atomic.AtomicInteger atomicInteger, int i) {
        atomicInteger.set(i);
    }
}
