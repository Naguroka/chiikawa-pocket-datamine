...
public abstract class Segment<S extends kotlinx.coroutines.internal.Segment<S>> extends kotlinx.coroutines.internal.ConcurrentLinkedListNode<S> implements kotlinx.coroutines.NotCompleted {
    private static final java.util.concurrent.atomic.AtomicIntegerFieldUpdater cleanedAndPointers$FU = java.util.concurrent.atomic.AtomicIntegerFieldUpdater.newUpdater(kotlinx.coroutines.internal.Segment.class, "cleanedAndPointers");
    ...
    public final boolean tryIncPointers$kotlinx_coroutines_core() {
        int i;
        java.util.concurrent.atomic.AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = cleanedAndPointers$FU;
        do {
