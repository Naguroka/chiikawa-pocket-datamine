...
public abstract class ConcurrentLinkedListNode<N extends kotlinx.coroutines.internal.ConcurrentLinkedListNode<N>> {
    ...
    public final N nextOrIfClosed(kotlin.jvm.functions.Function0 onClosedAction) {
        ...
        if (nextOrClosed == kotlinx.coroutines.internal.ConcurrentLinkedListKt.CLOSED) {
    ...
    public final boolean trySetNext(N value) {
        return kotlin.UByte$$ExternalSyntheticBackport0.m(_next$FU, this, (java.lang.Object) null, value);
    }
    ...
    public final boolean markAsClosed() {
        return kotlin.UByte$$ExternalSyntheticBackport0.m(_next$FU, this, (java.lang.Object) null, kotlinx.coroutines.internal.ConcurrentLinkedListKt.CLOSED);
    }
    ...
    public final void remove() {
        ...
        while (true) {
            kotlinx.coroutines.internal.ConcurrentLinkedListNode aliveSegmentLeft = getAliveSegmentLeft();
            kotlinx.coroutines.internal.ConcurrentLinkedListNode aliveSegmentRight = getAliveSegmentRight();
            ...
            } while (!kotlin.UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, aliveSegmentRight, obj, ((kotlinx.coroutines.internal.ConcurrentLinkedListNode) obj) == null ? null : aliveSegmentLeft));
