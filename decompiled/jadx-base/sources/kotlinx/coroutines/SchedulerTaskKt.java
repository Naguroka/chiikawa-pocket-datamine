...
public final class SchedulerTaskKt {
    public static /* synthetic */ void getTaskContext$annotations(kotlinx.coroutines.scheduling.Task task) {
    }

    public static final kotlinx.coroutines.scheduling.TaskContext getTaskContext(kotlinx.coroutines.scheduling.Task task) {
        return task.taskContext;
    }

    public static final void afterTask(kotlinx.coroutines.scheduling.TaskContext taskContext) {
