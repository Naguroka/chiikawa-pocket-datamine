...
public abstract class EventLoop extends kotlinx.coroutines.CoroutineDispatcher {
    ...
    protected long getNextTime() {
        kotlin.collections.ArrayDeque<kotlinx.coroutines.DispatchedTask<?>> arrayDeque = this.unconfinedQueue;
        return (arrayDeque == null || arrayDeque.isEmpty()) ? Long.MAX_VALUE : 0L;
    }

    public final boolean processUnconfinedEvent() {
        kotlinx.coroutines.DispatchedTask<?> dispatchedTaskRemoveFirstOrNull;
        kotlin.collections.ArrayDeque<kotlinx.coroutines.DispatchedTask<?>> arrayDeque = this.unconfinedQueue;
