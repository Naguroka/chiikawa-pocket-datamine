...
public final class TickerChannelsKt {
    ...
    static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        ...
        AnonymousClass1(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass1> continuation) {
            super(continuation);
        }
    ...
    static final class C18441 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        long J$0;
        long J$1;
        java.lang.Object L$0;
        int label;
        ...
        C18441(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.TickerChannelsKt.C18441> continuation) {
            super(continuation);
        }
    ...
    static final class AnonymousClass3 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.channels.ProducerScope<? super kotlin.Unit>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
        ...
        AnonymousClass3(kotlinx.coroutines.channels.TickerMode tickerMode, long j, long j2, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass3> continuation) {
        ...
        public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
            kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass3 anonymousClass3 = new kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass3(this.$mode, this.$delayMillis, this.$initialDelayMillis, continuation);
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object obj) {
            ...
            if (i == 0) {
                ...
                int i2 = kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass3.WhenMappings.$EnumSwitchMapping$0[this.$mode.ordinal()];
                if (i2 == 1) {
                    this.label = 1;
                    if (kotlinx.coroutines.channels.TickerChannelsKt.fixedPeriodTicker(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i2 == 2) {
                    this.label = 2;
                    if (kotlinx.coroutines.channels.TickerChannelsKt.fixedDelayTicker(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            } else {
    ...
    public static final kotlinx.coroutines.channels.ReceiveChannel<kotlin.Unit> ticker(long j, long j2, kotlin.coroutines.CoroutineContext coroutineContext, kotlinx.coroutines.channels.TickerMode tickerMode) {
        ...
        return kotlinx.coroutines.channels.ProduceKt.produce(kotlinx.coroutines.GlobalScope.INSTANCE, kotlinx.coroutines.Dispatchers.getUnconfined().plus(coroutineContext), 0, new kotlinx.coroutines.channels.TickerChannelsKt.AnonymousClass3(tickerMode, j, j2, null));
    }
