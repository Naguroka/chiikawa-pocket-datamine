...
public interface SendChannel<E> {
    ...
    java.lang.Object mo2805trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        @kotlin.Deprecated(level = kotlin.DeprecationLevel.ERROR, message = "Deprecated in the favour of 'trySend' method", replaceWith = @kotlin.ReplaceWith(expression = "trySend(element).isSuccess", imports = {}))
        public static <E> boolean offer(kotlinx.coroutines.channels.SendChannel<? super E> sendChannel, E e) throws java.lang.Throwable {
            java.lang.Object objMo2805trySendJP2dKIU = sendChannel.mo2805trySendJP2dKIU(e);
            if (kotlinx.coroutines.channels.ChannelResult.m2825isSuccessimpl(objMo2805trySendJP2dKIU)) {
                return true;
            }
            java.lang.Throwable thM2819exceptionOrNullimpl = kotlinx.coroutines.channels.ChannelResult.m2819exceptionOrNullimpl(objMo2805trySendJP2dKIU);
