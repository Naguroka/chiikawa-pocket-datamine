...
public final class DebugStringsKt {
    ...
    public static final java.lang.String toDebugString(kotlin.coroutines.Continuation<?> continuation) {
        ...
        try {
            ...
            objM1301constructorimpl = kotlin.Result.m1301constructorimpl(continuation + '@' + getHexAddress(continuation));
        ...
        if (kotlin.Result.m1304exceptionOrNullimpl(objM1301constructorimpl) != null) {
            objM1301constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (java.lang.String) objM1301constructorimpl;
    }
