...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {org.objectweb.asm.Opcodes.D2I}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
