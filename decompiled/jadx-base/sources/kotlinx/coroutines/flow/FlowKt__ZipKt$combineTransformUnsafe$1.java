...
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2<kotlinx.coroutines.flow.FlowCollector<? super R>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        if (i == 0) {
            ...
            kotlin.jvm.functions.Function0 function0NullArrayFactory$FlowKt__ZipKt = kotlinx.coroutines.flow.FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
            kotlin.jvm.internal.Intrinsics.needClassReification();
            this.label = 1;
            if (kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1.AnonymousClass1(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final java.lang.Object invokeSuspend$$forInline(java.lang.Object obj) {
        ...
        kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1.AnonymousClass1(this.$transform, null), this);
