    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        try {
            if (i == 0) {
                ...
                ((kotlinx.coroutines.flow.internal.SafeCollector) flowCollector).releaseIntercepted();
                return kotlin.Unit.INSTANCE;
            }
            if (booleanRef.element) {
                kotlinx.coroutines.flow.internal.SafeCollector safeCollector2 = new kotlinx.coroutines.flow.internal.SafeCollector(r2, anonymousClass1.getContext());
