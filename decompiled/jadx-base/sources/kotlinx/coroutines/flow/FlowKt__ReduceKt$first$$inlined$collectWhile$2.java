...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {org.objectweb.asm.Opcodes.D2I}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
    ...
    public java.lang.Object emit(T t, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        if (i == 0) {
            ...
            flowKt__ReduceKt$first$$inlined$collectWhile$2 = (kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2) anonymousClass1.L$0;
            kotlin.ResultKt.throwOnFailure(objInvoke);
        }
