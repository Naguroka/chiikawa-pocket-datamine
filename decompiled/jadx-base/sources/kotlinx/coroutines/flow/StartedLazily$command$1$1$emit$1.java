...
final class StartedLazily$command$1$1$emit$1 extends kotlin.coroutines.jvm.internal.ContinuationImpl {
    ...
    final /* synthetic */ kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C02701<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    StartedLazily$command$1$1$emit$1(kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C02701<? super T> c02701, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.StartedLazily$command$1$1$emit$1> continuation) {
        super(continuation);
        this.this$0 = c02701;
    }
