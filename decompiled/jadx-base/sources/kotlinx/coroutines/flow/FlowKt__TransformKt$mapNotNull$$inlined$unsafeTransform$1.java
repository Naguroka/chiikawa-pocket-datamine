...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements kotlinx.coroutines.flow.Flow<R> {
    ...
    public static final class AnonymousClass2<T> implements kotlinx.coroutines.flow.FlowCollector {
        ...
        public final java.lang.Object emit(T t, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
            ...
            if (i != 0) {
                if (i == 1) {
                    flowCollector2 = (kotlinx.coroutines.flow.FlowCollector) anonymousClass1.L$0;
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        java.lang.Object objCollect = this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2(flowCollector, this.$transform$inlined$1), continuation);
