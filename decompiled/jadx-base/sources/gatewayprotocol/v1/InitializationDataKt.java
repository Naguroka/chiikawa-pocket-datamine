...
public final class InitializationDataKt {
    public static final gatewayprotocol.v1.InitializationDataKt INSTANCE = new gatewayprotocol.v1.InitializationDataKt();
    ...
    public static final class Dsl {
        ...
        public static final gatewayprotocol.v1.InitializationDataKt.Dsl.Companion INSTANCE = new gatewayprotocol.v1.InitializationDataKt.Dsl.Companion(null);
        private final gatewayprotocol.v1.InitializationDataOuterClass.InitializationData.Builder _builder;

        public /* synthetic */ Dsl(gatewayprotocol.v1.InitializationDataOuterClass.InitializationData.Builder builder, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
            this(builder);
        }

        private Dsl(gatewayprotocol.v1.InitializationDataOuterClass.InitializationData.Builder builder) {
        ...
        public static final class Companion {
            ...
            public final /* synthetic */ gatewayprotocol.v1.InitializationDataKt.Dsl _create(gatewayprotocol.v1.InitializationDataOuterClass.InitializationData.Builder builder) {
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(builder, "builder");
                return new gatewayprotocol.v1.InitializationDataKt.Dsl(builder, null);
            }
        }

        public final /* synthetic */ gatewayprotocol.v1.InitializationDataOuterClass.InitializationData _build() {
            gatewayprotocol.v1.InitializationDataOuterClass.InitializationData initializationDataBuild = this._builder.build();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(initializationDataBuild, "_builder.build()");
        ...
        public final gatewayprotocol.v1.InitializationRequestOuterClass.InitializationRequest getInitializationRequestOrNull(gatewayprotocol.v1.InitializationDataKt.Dsl dsl) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dsl, "<this>");
            return gatewayprotocol.v1.InitializationDataKtKt.getInitializationRequestOrNull(dsl._builder);
        }
        ...
        public final gatewayprotocol.v1.UniversalRequestOuterClass.UniversalRequest.SharedData getSharedDataOrNull(gatewayprotocol.v1.InitializationDataKt.Dsl dsl) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dsl, "<this>");
            return gatewayprotocol.v1.InitializationDataKtKt.getSharedDataOrNull(dsl._builder);
        }
    }
