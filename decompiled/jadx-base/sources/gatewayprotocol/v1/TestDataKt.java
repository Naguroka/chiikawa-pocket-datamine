...
public final class TestDataKt {
    public static final gatewayprotocol.v1.TestDataKt INSTANCE = new gatewayprotocol.v1.TestDataKt();
    ...
    public static final class Dsl {
        ...
        public static final gatewayprotocol.v1.TestDataKt.Dsl.Companion INSTANCE = new gatewayprotocol.v1.TestDataKt.Dsl.Companion(null);
        private final gatewayprotocol.v1.TestDataOuterClass.TestData.Builder _builder;

        public /* synthetic */ Dsl(gatewayprotocol.v1.TestDataOuterClass.TestData.Builder builder, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
            this(builder);
        }

        private Dsl(gatewayprotocol.v1.TestDataOuterClass.TestData.Builder builder) {
        ...
        public static final class Companion {
            ...
            public final /* synthetic */ gatewayprotocol.v1.TestDataKt.Dsl _create(gatewayprotocol.v1.TestDataOuterClass.TestData.Builder builder) {
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(builder, "builder");
                return new gatewayprotocol.v1.TestDataKt.Dsl(builder, null);
            }
        }

        public final /* synthetic */ gatewayprotocol.v1.TestDataOuterClass.TestData _build() {
            gatewayprotocol.v1.TestDataOuterClass.TestData testDataBuild = this._builder.build();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(testDataBuild, "_builder.build()");
            return testDataBuild;
        }

        public final java.lang.String getForceCampaignId() {
            java.lang.String forceCampaignId = this._builder.getForceCampaignId();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(forceCampaignId, "_builder.getForceCampaignId()");
            return forceCampaignId;
        }

        public final void setForceCampaignId(java.lang.String value) {
        ...
        public final java.lang.String getForceCountry() {
            java.lang.String forceCountry = this._builder.getForceCountry();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(forceCountry, "_builder.getForceCountry()");
            return forceCountry;
        }

        public final void setForceCountry(java.lang.String value) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
        ...
        public final java.lang.String getForceCountrySubdivision() {
            java.lang.String forceCountrySubdivision = this._builder.getForceCountrySubdivision();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(forceCountrySubdivision, "_builder.getForceCountrySubdivision()");
            return forceCountrySubdivision;
        }

        public final void setForceCountrySubdivision(java.lang.String value) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
