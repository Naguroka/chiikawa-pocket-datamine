...
public final class LimitedSessionTokenKtKt {
    ...
    public static final gatewayprotocol.v1.UniversalRequestOuterClass.LimitedSessionToken m1269initializelimitedSessionToken(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.LimitedSessionTokenKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.LimitedSessionTokenKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.UniversalRequestOuterClass.LimitedSessionToken copy(gatewayprotocol.v1.UniversalRequestOuterClass.LimitedSessionToken limitedSessionToken, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.LimitedSessionTokenKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.LimitedSessionTokenKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
