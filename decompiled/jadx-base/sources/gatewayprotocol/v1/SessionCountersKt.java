...
public final class SessionCountersKt {
    public static final gatewayprotocol.v1.SessionCountersKt INSTANCE = new gatewayprotocol.v1.SessionCountersKt();
    ...
    public static final class Dsl {
        ...
        public static final gatewayprotocol.v1.SessionCountersKt.Dsl.Companion INSTANCE = new gatewayprotocol.v1.SessionCountersKt.Dsl.Companion(null);
        private final gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.Builder _builder;

        public /* synthetic */ Dsl(gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.Builder builder, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
            this(builder);
        }

        private Dsl(gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.Builder builder) {
        ...
        public static final class Companion {
            ...
            public final /* synthetic */ gatewayprotocol.v1.SessionCountersKt.Dsl _create(gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.Builder builder) {
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(builder, "builder");
                return new gatewayprotocol.v1.SessionCountersKt.Dsl(builder, null);
            }
        }

        public final /* synthetic */ gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters _build() {
            gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters sessionCountersBuild = this._builder.build();
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sessionCountersBuild, "_builder.build()");
