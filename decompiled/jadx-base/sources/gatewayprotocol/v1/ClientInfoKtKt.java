...
public final class ClientInfoKtKt {
    ...
    public static final gatewayprotocol.v1.ClientInfoOuterClass.ClientInfo m1249initializeclientInfo(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.ClientInfoKt.Dsl, kotlin.Unit> block) {
    ...
    public static final gatewayprotocol.v1.ClientInfoOuterClass.ClientInfo copy(gatewayprotocol.v1.ClientInfoOuterClass.ClientInfo clientInfo, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.ClientInfoKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.ClientInfoKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
