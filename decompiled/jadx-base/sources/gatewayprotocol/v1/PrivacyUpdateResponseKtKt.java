...
public final class PrivacyUpdateResponseKtKt {
    ...
    public static final gatewayprotocol.v1.PrivacyUpdateResponseOuterClass.PrivacyUpdateResponse m1278initializeprivacyUpdateResponse(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.PrivacyUpdateResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.PrivacyUpdateResponseOuterClass.PrivacyUpdateResponse.Builder builderNewBuilder = gatewayprotocol.v1.PrivacyUpdateResponseOuterClass.PrivacyUpdateResponse.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.PrivacyUpdateResponseKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.PrivacyUpdateResponseOuterClass.PrivacyUpdateResponse copy(gatewayprotocol.v1.PrivacyUpdateResponseOuterClass.PrivacyUpdateResponse privacyUpdateResponse, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.PrivacyUpdateResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.PrivacyUpdateResponseKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
