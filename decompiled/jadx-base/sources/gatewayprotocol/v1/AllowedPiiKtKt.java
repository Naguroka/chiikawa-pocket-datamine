...
public final class AllowedPiiKtKt {
    ...
    public static final gatewayprotocol.v1.AllowedPiiOuterClass.AllowedPii m1245initializeallowedPii(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AllowedPiiKt.Dsl, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        gatewayprotocol.v1.AllowedPiiKt.Dsl.Companion companion = gatewayprotocol.v1.AllowedPiiKt.Dsl.INSTANCE;
        gatewayprotocol.v1.AllowedPiiOuterClass.AllowedPii.Builder builderNewBuilder = gatewayprotocol.v1.AllowedPiiOuterClass.AllowedPii.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.AllowedPiiKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.AllowedPiiOuterClass.AllowedPii copy(gatewayprotocol.v1.AllowedPiiOuterClass.AllowedPii allowedPii, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AllowedPiiKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AllowedPiiKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
