...
public final class InitializationRequestKtKt {
    ...
    public static final gatewayprotocol.v1.InitializationRequestOuterClass.InitializationRequest m1267initializeinitializationRequest(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.InitializationRequestKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.InitializationRequestKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.InitializationRequestOuterClass.InitializationRequest copy(gatewayprotocol.v1.InitializationRequestOuterClass.InitializationRequest initializationRequest, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.InitializationRequestKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.InitializationRequestKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
