...
public final class TransactionEventRequestKtKt {
    ...
    public static final gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequest m1290initializetransactionEventRequest(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.TransactionEventRequestKt.Dsl, kotlin.Unit> block) {
    ...
    public static final gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequest copy(gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequest transactionEventRequest, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.TransactionEventRequestKt.Dsl, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(transactionEventRequest, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        gatewayprotocol.v1.TransactionEventRequestKt.Dsl.Companion companion = gatewayprotocol.v1.TransactionEventRequestKt.Dsl.INSTANCE;
        gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequest.Builder builder = transactionEventRequest.toBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builder, "this.toBuilder()");
        gatewayprotocol.v1.TransactionEventRequestKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }

    public static final gatewayprotocol.v1.StaticDeviceInfoOuterClass.StaticDeviceInfo getStaticDeviceInfoOrNull(gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequestOrBuilder transactionEventRequestOrBuilder) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(transactionEventRequestOrBuilder, "<this>");
    ...
    public static final gatewayprotocol.v1.DynamicDeviceInfoOuterClass.DynamicDeviceInfo getDynamicDeviceInfoOrNull(gatewayprotocol.v1.TransactionEventRequestOuterClass.TransactionEventRequestOrBuilder transactionEventRequestOrBuilder) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(transactionEventRequestOrBuilder, "<this>");
