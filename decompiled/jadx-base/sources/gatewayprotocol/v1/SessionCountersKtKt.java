...
public final class SessionCountersKtKt {
    ...
    public static final gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters m1282initializesessionCounters(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.SessionCountersKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.Builder builderNewBuilder = gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.SessionCountersKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters copy(gatewayprotocol.v1.SessionCountersOuterClass.SessionCounters sessionCounters, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.SessionCountersKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.SessionCountersKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
