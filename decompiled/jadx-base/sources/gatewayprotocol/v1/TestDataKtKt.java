...
public final class TestDataKtKt {
    ...
    public static final gatewayprotocol.v1.TestDataOuterClass.TestData m1286initializetestData(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.TestDataKt.Dsl, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        gatewayprotocol.v1.TestDataKt.Dsl.Companion companion = gatewayprotocol.v1.TestDataKt.Dsl.INSTANCE;
        gatewayprotocol.v1.TestDataOuterClass.TestData.Builder builderNewBuilder = gatewayprotocol.v1.TestDataOuterClass.TestData.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.TestDataKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.TestDataOuterClass.TestData copy(gatewayprotocol.v1.TestDataOuterClass.TestData testData, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.TestDataKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.TestDataKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
