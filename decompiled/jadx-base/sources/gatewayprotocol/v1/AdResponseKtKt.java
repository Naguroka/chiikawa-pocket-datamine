...
public final class AdResponseKtKt {
    ...
    public static final gatewayprotocol.v1.AdResponseOuterClass.AdResponse m1244initializeadResponse(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AdResponseKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.AdResponseOuterClass.AdResponse copy(gatewayprotocol.v1.AdResponseOuterClass.AdResponse adResponse, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AdResponseKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
