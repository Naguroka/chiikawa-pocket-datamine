...
public final class AdOperationsConfigurationKtKt {
    ...
    public static final gatewayprotocol.v1.NativeConfigurationOuterClass.AdOperationsConfiguration m1240initializeadOperationsConfiguration(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdOperationsConfigurationKt.Dsl, kotlin.Unit> block) {
    ...
    public static final gatewayprotocol.v1.NativeConfigurationOuterClass.AdOperationsConfiguration copy(gatewayprotocol.v1.NativeConfigurationOuterClass.AdOperationsConfiguration adOperationsConfiguration, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdOperationsConfigurationKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AdOperationsConfigurationKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
