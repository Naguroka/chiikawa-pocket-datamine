...
public final class AdPlayerConfigResponseKtKt {
    ...
    public static final gatewayprotocol.v1.AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse m1242initializeadPlayerConfigResponse(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdPlayerConfigResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse.Builder builderNewBuilder = gatewayprotocol.v1.AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.AdPlayerConfigResponseKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse copy(gatewayprotocol.v1.AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse adPlayerConfigResponse, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.AdPlayerConfigResponseKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.AdPlayerConfigResponseKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
