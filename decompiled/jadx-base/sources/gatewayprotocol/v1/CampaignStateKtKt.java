...
public final class CampaignStateKtKt {
    ...
    public static final gatewayprotocol.v1.CampaignStateOuterClass.CampaignState m1248initializecampaignState(kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.CampaignStateKt.Dsl, kotlin.Unit> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        gatewayprotocol.v1.CampaignStateKt.Dsl.Companion companion = gatewayprotocol.v1.CampaignStateKt.Dsl.INSTANCE;
        gatewayprotocol.v1.CampaignStateOuterClass.CampaignState.Builder builderNewBuilder = gatewayprotocol.v1.CampaignStateOuterClass.CampaignState.newBuilder();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(builderNewBuilder, "newBuilder()");
        gatewayprotocol.v1.CampaignStateKt.Dsl dsl_create = companion._create(builderNewBuilder);
    ...
    public static final gatewayprotocol.v1.CampaignStateOuterClass.CampaignState copy(gatewayprotocol.v1.CampaignStateOuterClass.CampaignState campaignState, kotlin.jvm.functions.Function1<? super gatewayprotocol.v1.CampaignStateKt.Dsl, kotlin.Unit> block) {
        ...
        gatewayprotocol.v1.CampaignStateKt.Dsl dsl_create = companion._create(builder);
        block.invoke(dsl_create);
        return dsl_create._build();
    }
}
